...
| laravel-authentication | skills/laravel-authentication/SKILL.md | Authentication & authorization: 14 files covering Sanctum, Passport, OAuth2, OIDC, JWT, Policies, Gates, Roles, Permissions, Multi-tenant, SSO, Enterprise IAM, Zero-trust |
