...
1. Hub-and-spoke database
2. No data compression before transfer
3. Cross-region cache eviction
...
## Anti-Pattern 1: Hub-and-spoke database

### Category
Design / Architecture

### Description
Hub-and-spoke database. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No data compression before transfer

### Category
Design / Architecture

### Description
No data compression before transfer. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Cross-region cache eviction

### Category
Design / Architecture

### Description
Cross-region cache eviction. This pattern violates best practices and introduces technical debt that compounds over time.
