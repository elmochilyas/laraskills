# Skill: Analyze and Optimize Route53 Routing Costs

## Purpose

Analyze current infrastructure costs related to Route53 Routing Costs and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Route53 Routing Costs in a production Laravel application
- When optimizing or hardening Route53 Routing Costs for operational use
...
1. Inventory current Route53 Routing Costs resources, configurations, and usage patterns
...
- Configure and Implement Route53 Routing Costs
- Monitor and Maintain Route53 Routing Costs
...
# Skill: Implement Route53 Routing Costs Cost Controls

## Purpose

Establish governance and automated controls to maintain Route53 Routing Costs cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Route53 Routing Costs
