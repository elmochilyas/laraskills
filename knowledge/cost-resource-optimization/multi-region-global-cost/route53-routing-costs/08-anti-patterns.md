...
1. Traffic Flow for simple setups
2. Geolocation for performance
3. Low TTL on stable records
4. Health checking every instance
...
## Anti-Pattern 1: Traffic Flow for simple setups

### Category
Design / Architecture

### Description
Traffic Flow for simple setups. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Geolocation for performance

### Category
Design / Architecture

### Description
Geolocation for performance. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Low TTL on stable records

### Category
Design / Architecture

### Description
Low TTL on stable records. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Health checking every instance

### Category
Design / Architecture

### Description
Health checking every instance. This pattern violates best practices and introduces technical debt that compounds over time.
