...
1. Full database replication for all tables
2. No aggregation before transfer
3. CloudFront after multi-region
4. Compression as afterthought
...
## Anti-Pattern 1: Full database replication for all tables

### Category
Design / Architecture

### Description
Full database replication for all tables. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No aggregation before transfer

### Category
Design / Architecture

### Description
No aggregation before transfer. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: CloudFront after multi-region

### Category
Design / Architecture

### Description
CloudFront after multi-region. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Compression as afterthought

### Category
Design / Architecture

### Description
Compression as afterthought. This pattern violates best practices and introduces technical debt that compounds over time.
