# Skill: Analyze and Optimize Global Load Balancing

## Purpose

Analyze current infrastructure costs related to Global Load Balancing and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Global Load Balancing in a production Laravel application
- When optimizing or hardening Global Load Balancing for operational use
...
1. Inventory current Global Load Balancing resources, configurations, and usage patterns
...
- Configure and Implement Global Load Balancing
- Monitor and Maintain Global Load Balancing
...
# Skill: Implement Global Load Balancing Cost Controls

## Purpose

Establish governance and automated controls to maintain Global Load Balancing cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Global Load Balancing
