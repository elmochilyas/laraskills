...
1. Multi-region without monitoring
2. Identical capacity in all regions
3. No Route53 health checks
4. Forgetting CloudFront
...
## Anti-Pattern 1: Multi-region without monitoring

### Category
Design / Architecture

### Description
Multi-region without monitoring. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Identical capacity in all regions

### Category
Design / Architecture

### Description
Identical capacity in all regions. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No Route53 health checks

### Category
Design / Architecture

### Description
No Route53 health checks. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Forgetting CloudFront

### Category
Design / Architecture

### Description
Forgetting CloudFront. This pattern violates best practices and introduces technical debt that compounds over time.
