...
1. 3+ regions for small app
2. No cost comparison across regions
3. Choosing region by AWS certification lab
4. Hoping compliance doesn't apply
...
## Anti-Pattern 1: 3+ regions for small app

### Category
Design / Architecture

### Description
3+ regions for small app. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No cost comparison across regions

### Category
Design / Architecture

### Description
No cost comparison across regions. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Choosing region by AWS certification lab

### Category
Design / Architecture

### Description
Choosing region by AWS certification lab. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Hoping compliance doesn't apply

### Category
Design / Architecture

### Description
Hoping compliance doesn't apply. This pattern violates best practices and introduces technical debt that compounds over time.
