# Skill: Analyze and Optimize Region Selection

## Purpose

Analyze current infrastructure costs related to Region Selection and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Region Selection in a production Laravel application
- When optimizing or hardening Region Selection for operational use
...
1. Inventory current Region Selection resources, configurations, and usage patterns
...
- Configure and Implement Region Selection
- Monitor and Maintain Region Selection
...
# Skill: Implement Region Selection Cost Controls

## Purpose

Establish governance and automated controls to maintain Region Selection cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Region Selection
