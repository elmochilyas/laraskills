# Skill: Analyze and Optimize Multi Region Database

## Purpose

Analyze current infrastructure costs related to Multi Region Database and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Multi Region Database in a production Laravel application
- When optimizing or hardening Multi Region Database for operational use
...
1. Inventory current Multi Region Database resources, configurations, and usage patterns
...
- Configure and Implement Multi Region Database
- Monitor and Maintain Multi Region Database
...
# Skill: Implement Multi Region Database Cost Controls

## Purpose

Establish governance and automated controls to maintain Multi Region Database cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Multi Region Database
