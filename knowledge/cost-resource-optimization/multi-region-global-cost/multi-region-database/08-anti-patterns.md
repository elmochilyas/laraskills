...
1. Active-active multi-region databases
2. Synchronous cross-region writes
3. No DR testing
4. Same instance size in all regions
...
## Anti-Pattern 1: Active-active multi-region databases

### Category
Design / Architecture

### Description
Active-active multi-region databases. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Synchronous cross-region writes

### Category
Design / Architecture

### Description
Synchronous cross-region writes. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No DR testing

### Category
Design / Architecture

### Description
No DR testing. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Same instance size in all regions

### Category
Design / Architecture

### Description
Same instance size in all regions. This pattern violates best practices and introduces technical debt that compounds over time.
