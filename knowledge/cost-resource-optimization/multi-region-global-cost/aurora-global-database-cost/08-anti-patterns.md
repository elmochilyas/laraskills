...
1. Active-active Global Database
2. Over-provisioned secondary
3. No failover testing
4. CloudFront after Global Database
...
## Anti-Pattern 1: Active-active Global Database

### Category
Design / Architecture

### Description
Active-active Global Database. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Over-provisioned secondary

### Category
Design / Architecture

### Description
Over-provisioned secondary. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No failover testing

### Category
Design / Architecture

### Description
No failover testing. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: CloudFront after Global Database

### Category
Design / Architecture

### Description
CloudFront after Global Database. This pattern violates best practices and introduces technical debt that compounds over time.
