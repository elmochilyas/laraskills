# Skill: Analyze and Optimize Aurora Global Database Cost

## Purpose

Analyze current infrastructure costs related to Aurora Global Database Cost and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Aurora Global Database Cost in a production Laravel application
- When optimizing or hardening Aurora Global Database Cost for operational use
...
1. Inventory current Aurora Global Database Cost resources, configurations, and usage patterns
...
- Configure and Implement Aurora Global Database Cost
- Monitor and Maintain Aurora Global Database Cost
...
# Skill: Implement Aurora Global Database Cost Cost Controls

## Purpose

Establish governance and automated controls to maintain Aurora Global Database Cost cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Aurora Global Database Cost
