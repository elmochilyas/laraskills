# Skill: Analyze and Optimize Active Passive Multi Region

## Purpose

Analyze current infrastructure costs related to Active Passive Multi Region and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Active Passive Multi Region in a production Laravel application
- When optimizing or hardening Active Passive Multi Region for operational use
...
1. Inventory current Active Passive Multi Region resources, configurations, and usage patterns
...
- Configure and Implement Active Passive Multi Region
- Monitor and Maintain Active Passive Multi Region
...
# Skill: Implement Active Passive Multi Region Cost Controls

## Purpose

Establish governance and automated controls to maintain Active Passive Multi Region cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Active Passive Multi Region
