...
1. Active-active by default
2. No failover testing
3. Multi-region without CloudFront first
4. Same-size standby
...
## Anti-Pattern 1: Active-active by default

### Category
Design / Architecture

### Description
Active-active by default. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No failover testing
...
## Anti-Pattern 3: Multi-region without CloudFront first

### Category
Design / Architecture

### Description
Multi-region without CloudFront first. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Same-size standby

### Category
Design / Architecture

### Description
Same-size standby. This pattern violates best practices and introduces technical debt that compounds over time.
