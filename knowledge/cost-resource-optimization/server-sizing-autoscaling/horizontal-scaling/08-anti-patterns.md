...
2. Identical ASG min/max
3. No lifecycle hooks
4. No ALB health checks
...
## Anti-Pattern 1: Monolithic scaling

### Category
Design / Architecture

### Description
Monolithic scaling. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Identical ASG min/max

### Category
Design / Architecture

### Description
Identical ASG min/max. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No lifecycle hooks

### Category
Design / Architecture

### Description
No lifecycle hooks. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: No ALB health checks

### Category
Design / Architecture

### Description
No ALB health checks. This pattern violates best practices and introduces technical debt that compounds over time.
