# Skill: Analyze and Optimize Horizontal Scaling

## Purpose

Analyze current infrastructure costs related to Horizontal Scaling and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Horizontal Scaling in a production Laravel application
- When optimizing or hardening Horizontal Scaling for operational use
...
1. Inventory current Horizontal Scaling resources, configurations, and usage patterns
...
- Configure and Implement Horizontal Scaling
- Monitor and Maintain Horizontal Scaling
...
# Skill: Implement Horizontal Scaling Cost Controls

## Purpose

Establish governance and automated controls to maintain Horizontal Scaling cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Horizontal Scaling
