# Skill: Analyze and Optimize Predictive Scaling

## Purpose

Analyze current infrastructure costs related to Predictive Scaling and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Predictive Scaling in a production Laravel application
- When optimizing or hardening Predictive Scaling for operational use
...
1. Inventory current Predictive Scaling resources, configurations, and usage patterns
...
- Configure and Implement Predictive Scaling
- Monitor and Maintain Predictive Scaling
...
# Skill: Implement Predictive Scaling Cost Controls

## Purpose

Establish governance and automated controls to maintain Predictive Scaling cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Predictive Scaling
