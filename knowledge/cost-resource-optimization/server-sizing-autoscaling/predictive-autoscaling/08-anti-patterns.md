...
1. Predictive-only scaling
2. Predictive scaling without max capacity
3. Using predictive for one-off events
4. Enabling without historical data
...
## Anti-Pattern 1: Predictive-only scaling

### Category
Design / Architecture

### Description
Predictive-only scaling. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Predictive scaling without max capacity

### Category
Design / Architecture

### Description
Predictive scaling without max capacity. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Using predictive for one-off events

### Category
Design / Architecture

### Description
Using predictive for one-off events. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Enabling without historical data

### Category
Design / Architecture

### Description
Enabling without historical data. This pattern violates best practices and introduces technical debt that compounds over time.
