# Skill: Analyze and Optimize Predictive Autoscaling

## Purpose

Analyze current infrastructure costs related to Predictive Autoscaling and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Predictive Autoscaling in a production Laravel application
- When optimizing or hardening Predictive Autoscaling for operational use
...
1. Inventory current Predictive Autoscaling resources, configurations, and usage patterns
...
- Configure and Implement Predictive Autoscaling
- Monitor and Maintain Predictive Autoscaling
...
# Skill: Implement Predictive Autoscaling Cost Controls

## Purpose

Establish governance and automated controls to maintain Predictive Autoscaling cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Predictive Autoscaling
