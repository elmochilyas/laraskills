...
1. 24/7 staging
2. No schedule at all
3. Manual scale-up/down
4. Production-only thinking
...
## Anti-Pattern 1: 24/7 staging

### Category
Design / Architecture

### Description
24/7 staging. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No schedule at all

### Category
Design / Architecture

### Description
No schedule at all. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Manual scale-up/down

### Category
Design / Architecture

### Description
Manual scale-up/down. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Production-only thinking

### Category
Design / Architecture

### Description
Production-only thinking. This pattern violates best practices and introduces technical debt that compounds over time.
