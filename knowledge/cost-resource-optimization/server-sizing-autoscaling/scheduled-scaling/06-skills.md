# Skill: Analyze and Optimize Scheduled Scaling

## Purpose

Analyze current infrastructure costs related to Scheduled Scaling and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Scheduled Scaling in a production Laravel application
- When optimizing or hardening Scheduled Scaling for operational use
...
1. Inventory current Scheduled Scaling resources, configurations, and usage patterns
...
- Configure and Implement Scheduled Scaling
- Monitor and Maintain Scheduled Scaling
...
# Skill: Implement Scheduled Scaling Cost Controls

## Purpose

Establish governance and automated controls to maintain Scheduled Scaling cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Scheduled Scaling
