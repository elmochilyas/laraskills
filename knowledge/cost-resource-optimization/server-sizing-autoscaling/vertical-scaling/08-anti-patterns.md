...
1. Vertical-only architecture
2. Instances at 80%+ max size
3. Right-sizing to peak
4. Manual vertical scaling
...
## Anti-Pattern 1: Vertical-only architecture

### Category
Design / Architecture

### Description
Vertical-only architecture. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Instances at 80%+ max size

### Category
Design / Architecture

### Description
Instances at 80%+ max size. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Right-sizing to peak

### Category
Design / Architecture

### Description
Right-sizing to peak. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Manual vertical scaling

### Category
Design / Architecture

### Description
Manual vertical scaling. This pattern violates best practices and introduces technical debt that compounds over time.
