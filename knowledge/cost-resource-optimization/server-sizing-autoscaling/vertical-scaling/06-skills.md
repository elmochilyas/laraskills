# Skill: Analyze and Optimize Vertical Scaling

## Purpose

Analyze current infrastructure costs related to Vertical Scaling and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Vertical Scaling in a production Laravel application
- When optimizing or hardening Vertical Scaling for operational use
...
1. Inventory current Vertical Scaling resources, configurations, and usage patterns
...
- Configure and Implement Vertical Scaling
- Monitor and Maintain Vertical Scaling
...
# Skill: Implement Vertical Scaling Cost Controls

## Purpose

Establish governance and automated controls to maintain Vertical Scaling cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Vertical Scaling
