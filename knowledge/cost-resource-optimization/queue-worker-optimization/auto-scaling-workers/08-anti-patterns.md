...
1. CPU-based worker scaling
2. min=0 workers
3. Manual scaling during batch processing
4. On-Demand only workers
...
## Anti-Pattern 1: CPU-based worker scaling

### Category
Design / Architecture

### Description
CPU-based worker scaling. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: min=0 workers

### Category
Design / Architecture

### Description
min=0 workers. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Manual scaling during batch processing

### Category
Design / Architecture

### Description
Manual scaling during batch processing. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: On-Demand only workers

### Category
Design / Architecture

### Description
On-Demand only workers. This pattern violates best practices and introduces technical debt that compounds over time.
