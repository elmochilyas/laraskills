...
2. All jobs on same queue
3. No throughput monitoring
4. Receiving 1 message per poll
...
## Anti-Pattern 1: 1-second polling interval

### Category
Design / Architecture

### Description
1-second polling interval. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: All jobs on same queue

### Category
Design / Architecture

### Description
All jobs on same queue. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No throughput monitoring

### Category
Design / Architecture

### Description
No throughput monitoring. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Receiving 1 message per poll

### Category
Design / Architecture

### Description
Receiving 1 message per poll. This pattern violates best practices and introduces technical debt that compounds over time.
