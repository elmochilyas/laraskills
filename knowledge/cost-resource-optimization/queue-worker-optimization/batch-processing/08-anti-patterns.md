...
1. Batching unrelated jobs into single Laravel batch
2. Synchronous batch processing in web request
3. Batch size > 10
...
## Anti-Pattern 1: Batching unrelated jobs into single Laravel batch

### Category
Design / Architecture

### Description
Batching unrelated jobs into single Laravel batch. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Synchronous batch processing in web request

### Category
Design / Architecture

### Description
Synchronous batch processing in web request. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Batch size > 10

### Category
Design / Architecture

### Description
Batch size > 10. This pattern violates best practices and introduces technical debt that compounds over time.
