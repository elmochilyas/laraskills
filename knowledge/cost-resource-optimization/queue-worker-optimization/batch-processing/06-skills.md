# Skill: Analyze and Optimize Batch Processing

## Purpose

Analyze current infrastructure costs related to Batch Processing and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Batch Processing in a production Laravel application
- When optimizing or hardening Batch Processing for operational use
...
1. Inventory current Batch Processing resources, configurations, and usage patterns
...
- 1: Always Set MaxNumberOfMessages=10
...
- Configure and Implement Batch Processing
- Monitor and Maintain Batch Processing
...
# Skill: Implement Batch Processing Cost Controls

## Purpose

Establish governance and automated controls to maintain Batch Processing cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Batch Processing
