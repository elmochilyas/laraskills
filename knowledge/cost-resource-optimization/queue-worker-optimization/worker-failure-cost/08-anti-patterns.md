...
1. Endless retries for all jobs
2. Same retry strategy for all jobs
3. Ignoring Spot termination in workers
4. Large DLQ without review
...
## Anti-Pattern 1: Endless retries for all jobs

### Category
Design / Architecture

### Description
Endless retries for all jobs. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Same retry strategy for all jobs

### Category
Design / Architecture

### Description
Same retry strategy for all jobs. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Ignoring Spot termination in workers

### Category
Design / Architecture

### Description
Ignoring Spot termination in workers. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Large DLQ without review

### Category
Design / Architecture

### Description
Large DLQ without review. This pattern violates best practices and introduces technical debt that compounds over time.
