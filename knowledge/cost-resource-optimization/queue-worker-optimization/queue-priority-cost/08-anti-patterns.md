...
1. 9 priority levels
2. Priority queue without monitoring
3. All jobs as high priority
4. Low-priority workers on On-Demand
...
## Anti-Pattern 1: 9 priority levels

### Category
Design / Architecture

### Description
9 priority levels. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Priority queue without monitoring

### Category
Design / Architecture

### Description
Priority queue without monitoring. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: All jobs as high priority

### Category
Design / Architecture

### Description
All jobs as high priority. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Low-priority workers on On-Demand

### Category
Design / Architecture

### Description
Low-priority workers on On-Demand. This pattern violates best practices and introduces technical debt that compounds over time.
