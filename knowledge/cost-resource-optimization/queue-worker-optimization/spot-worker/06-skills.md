# Skill: Analyze and Optimize Spot Worker

## Purpose

Analyze current infrastructure costs related to Spot Worker and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Spot Worker in a production Laravel application
- When optimizing or hardening Spot Worker for operational use
...
1. Inventory current Spot Worker resources, configurations, and usage patterns
...
- 1: Use Spot for All Queue Workers
...
- Configure and Implement Spot Worker
- Monitor and Maintain Spot Worker
...
# Skill: Implement Spot Worker Cost Controls

## Purpose

Establish governance and automated controls to maintain Spot Worker cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Spot Worker
