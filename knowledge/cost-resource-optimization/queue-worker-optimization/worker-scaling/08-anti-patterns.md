...
2. Web + queue on same ASG
3. On-Demand workers for fault-tolerant workloads
...
## Anti-Pattern 2: Web + queue on same ASG

### Category
Design / Architecture

### Description
Web + queue on same ASG. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: On-Demand workers for fault-tolerant workloads

### Category
Design / Architecture

### Description
On-Demand workers for fault-tolerant workloads. This pattern violates best practices and introduces technical debt that compounds over time.
