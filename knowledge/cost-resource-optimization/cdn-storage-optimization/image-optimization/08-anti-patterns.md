...
2. JPEG for everything
3. No alt text for optimized images
...
## Anti-Pattern 1: Client-side resize

### Category
Design / Architecture

### Description
Client-side resize. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: JPEG for everything

### Category
Design / Architecture

### Description
JPEG for everything. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No alt text for optimized images

### Category
Design / Architecture

### Description
No alt text for optimized images. This pattern violates best practices and introduces technical debt that compounds over time.
