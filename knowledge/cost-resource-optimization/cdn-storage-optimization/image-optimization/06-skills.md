# Skill: Analyze and Optimize Image Optimization

## Purpose

Analyze current infrastructure costs related to Image Optimization and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Image Optimization in a production Laravel application
- When optimizing or hardening Image Optimization for operational use
...
1. Inventory current Image Optimization resources, configurations, and usage patterns
...
- 1: Convert to WebP at Upload Time
...
- Configure and Implement Image Optimization
- Monitor and Maintain Image Optimization
...
# Skill: Implement Image Optimization Cost Controls

## Purpose

Establish governance and automated controls to maintain Image Optimization cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Image Optimization
