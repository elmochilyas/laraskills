...
3. Not compressing API responses
...
## Anti-Pattern 1: Double compression

### Category
Design / Architecture

### Description
Double compression. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Application-level compression

### Category
Design / Architecture

### Description
Application-level compression. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Not compressing API responses

### Category
Design / Architecture

### Description
Not compressing API responses. This pattern violates best practices and introduces technical debt that compounds over time.
