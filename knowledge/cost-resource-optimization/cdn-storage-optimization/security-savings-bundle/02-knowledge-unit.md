...
## Core Concepts
- **Discount**: Up to 30% off CloudFront with commitment
- **Free WAF**: WAF web ACL and rule credits included
- **Bundle includes**: CloudFront, WAF, Shield Advanced, Bot Control
- **Commitment**: Annual or multi-year pricing agreement
- **Best for**: Apps with significant CDN traffic + security needs
...
## Research Notes
The Security Savings Bundle was introduced in 2025 as part of AWS's commitment-based pricing expansion. It's most valuable for high-traffic Laravel apps already using CloudFront + WAF. For smaller apps (<1TB/month), the free WAF tier with CloudFront free tier already provides adequate coverage without bundle commitment.
