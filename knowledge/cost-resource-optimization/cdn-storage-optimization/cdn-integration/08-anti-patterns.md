...
1. Public S3 bucket for assets
2. Single behavior for all traffic
3. CloudFront without OAC
...
## Anti-Pattern 1: Public S3 bucket for assets

### Category
Design / Architecture

### Description
Public S3 bucket for assets. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Single behavior for all traffic

### Category
Design / Architecture

### Description
Single behavior for all traffic. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: CloudFront without OAC

### Category
Design / Architecture

### Description
CloudFront without OAC. This pattern violates best practices and introduces technical debt that compounds over time.
