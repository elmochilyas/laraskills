...
1. Single bucket, no lifecycle
2. Glacier as CDN origin
3. Manual object tiering
...
## Anti-Pattern 1: Single bucket, no lifecycle

### Category
Design / Architecture

### Description
Single bucket, no lifecycle. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Glacier as CDN origin

### Category
Design / Architecture

### Description
Glacier as CDN origin. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Manual object tiering

### Category
Design / Architecture

### Description
Manual object tiering. This pattern violates best practices and introduces technical debt that compounds over time.
