...
1. `no-cache` without validation
2. Same Cache-Control for all routes
3. Immutable on non-hashed URLs
...
## Anti-Pattern 1: `no-cache` without validation

### Category
Design / Architecture

### Description
`no-cache` without validation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Same Cache-Control for all routes

### Category
Design / Architecture

### Description
Same Cache-Control for all routes. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Immutable on non-hashed URLs

### Category
Design / Architecture

### Description
Immutable on non-hashed URLs. This pattern violates best practices and introduces technical debt that compounds over time.
