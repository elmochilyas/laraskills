...
1. Signed URLs for public content
2. PHP-proxied file downloads
3. Same signed URL for all users
...
## Anti-Pattern 1: Signed URLs for public content

### Category
Design / Architecture

### Description
Signed URLs for public content. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: PHP-proxied file downloads

### Category
Design / Architecture

### Description
PHP-proxied file downloads. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Same signed URL for all users

### Category
Design / Architecture

### Description
Same signed URL for all users. This pattern violates best practices and introduces technical debt that compounds over time.
