...
1. Shield for single-region low traffic
2. Shield with no cacheable content
3. Shield region different from origin
...
## Anti-Pattern 1: Shield for single-region low traffic

### Category
Design / Architecture

### Description
Shield for single-region low traffic. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Shield with no cacheable content

### Category
Design / Architecture

### Description
Shield with no cacheable content. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Shield region different from origin

### Category
Design / Architecture

### Description
Shield region different from origin. This pattern violates best practices and introduces technical debt that compounds over time.
