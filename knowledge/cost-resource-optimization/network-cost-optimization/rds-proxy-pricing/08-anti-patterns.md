...
1. RDS Proxy for everything
2. Serverless v2 + RDS Proxy without cost analysis
3. No ConnectionBorrowTimeout
4. RDS Proxy for MySQL on EC2
...
## Anti-Pattern 1: RDS Proxy for everything

### Category
Design / Architecture

### Description
RDS Proxy for everything. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Serverless v2 + RDS Proxy without cost analysis

### Category
Design / Architecture

### Description
Serverless v2 + RDS Proxy without cost analysis. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No ConnectionBorrowTimeout

### Category
Design / Architecture

### Description
No ConnectionBorrowTimeout. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: RDS Proxy for MySQL on EC2

### Category
Design / Architecture

### Description
RDS Proxy for MySQL on EC2. This pattern violates best practices and introduces technical debt that compounds over time.
