# Skill: Analyze and Optimize Region Data Affinity

## Purpose

Analyze current infrastructure costs related to Region Data Affinity and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Region Data Affinity in a production Laravel application
- When optimizing or hardening Region Data Affinity for operational use
...
1. Inventory current Region Data Affinity resources, configurations, and usage patterns
...
- Configure and Implement Region Data Affinity
- Monitor and Maintain Region Data Affinity
...
# Skill: Implement Region Data Affinity Cost Controls

## Purpose

Establish governance and automated controls to maintain Region Data Affinity cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Region Data Affinity
