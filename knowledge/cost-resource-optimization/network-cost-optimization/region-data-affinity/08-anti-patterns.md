...
1. Single-AZ with no multi-region
2. All services in public subnets
3. Cross-region synchronous calls
4. Ignoring DataTransfer costs
...
## Anti-Pattern 1: Single-AZ with no multi-region

### Category
Design / Architecture

### Description
Single-AZ with no multi-region. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: All services in public subnets

### Category
Design / Architecture

### Description
All services in public subnets. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Cross-region synchronous calls

### Category
Design / Architecture

### Description
Cross-region synchronous calls. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Ignoring DataTransfer costs

### Category
Design / Architecture

### Description
Ignoring DataTransfer costs. This pattern violates best practices and introduces technical debt that compounds over time.
