...
1. NAT Gateway for all AWS traffic
2. Multi-AZ without analysis
3. No VPC endpoints
4. Spread-eagle service placement
...
## Anti-Pattern 1: NAT Gateway for all AWS traffic

### Category
Design / Architecture

### Description
NAT Gateway for all AWS traffic. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Multi-AZ without analysis

### Category
Design / Architecture

### Description
Multi-AZ without analysis. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No VPC endpoints

### Category
Design / Architecture

### Description
No VPC endpoints. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Spread-eagle service placement

### Category
Design / Architecture

### Description
Spread-eagle service placement. This pattern violates best practices and introduces technical debt that compounds over time.
