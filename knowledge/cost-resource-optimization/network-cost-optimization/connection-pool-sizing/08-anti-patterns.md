...
1. No pooler with many workers
2. Same pool size for all connections
3. Unlimited pool size
...
## Anti-Pattern 1: No pooler with many workers

### Category
Design / Architecture

### Description
No pooler with many workers. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Same pool size for all connections

### Category
Design / Architecture

### Description
Same pool size for all connections. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Unlimited pool size

### Category
Design / Architecture

### Description
Unlimited pool size. This pattern violates best practices and introduces technical debt that compounds over time.
