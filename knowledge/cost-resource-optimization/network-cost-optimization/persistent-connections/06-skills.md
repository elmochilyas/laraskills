# Skill: Analyze and Optimize Persistent Connections

## Purpose

Analyze current infrastructure costs related to Persistent Connections and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Persistent Connections in a production Laravel application
- When optimizing or hardening Persistent Connections for operational use
...
1. Inventory current Persistent Connections resources, configurations, and usage patterns
...
- Configure and Implement Persistent Connections
- Monitor and Maintain Persistent Connections
...
# Skill: Implement Persistent Connections Cost Controls

## Purpose

Establish governance and automated controls to maintain Persistent Connections cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Persistent Connections
