...
1. Persistent connections across tenants
2. Persistent connections on ephemeral workers
...
## Anti-Pattern 1: Persistent connections across tenants

### Category
Design / Architecture

### Description
Persistent connections across tenants. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Persistent connections on ephemeral workers

### Category
Design / Architecture

### Description
Persistent connections on ephemeral workers. This pattern violates best practices and introduces technical debt that compounds over time.
