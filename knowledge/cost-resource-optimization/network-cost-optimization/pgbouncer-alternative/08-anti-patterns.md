...
1. PgBouncer on the same server without resource limits
2. No auth_file configured
3. Using PgBouncer with MySQL
4. Not patching PgBouncer
...
## Anti-Pattern 1: PgBouncer on the same server without resource limits

### Category
Design / Architecture

### Description
PgBouncer on the same server without resource limits. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No auth_file configured

### Category
Design / Architecture

### Description
No auth_file configured. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Using PgBouncer with MySQL

### Category
Design / Architecture

### Description
Using PgBouncer with MySQL. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Not patching PgBouncer

### Category
Design / Architecture

### Description
Not patching PgBouncer. This pattern violates best practices and introduces technical debt that compounds over time.
