...
1. 3-year All Upfront for untested workload
2. Zonal RIs without capacity planning
3. Standard RIs for expected Graviton migration
4. RI for dev/staging
...
## Anti-Pattern 1: 3-year All Upfront for untested workload

### Category
Design / Architecture

### Description
3-year All Upfront for untested workload. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Zonal RIs without capacity planning

### Category
Design / Architecture

### Description
Zonal RIs without capacity planning. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Standard RIs for expected Graviton migration

### Category
Design / Architecture

### Description
Standard RIs for expected Graviton migration. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: RI for dev/staging

### Category
Design / Architecture

### Description
RI for dev/staging. This pattern violates best practices and introduces technical debt that compounds over time.
