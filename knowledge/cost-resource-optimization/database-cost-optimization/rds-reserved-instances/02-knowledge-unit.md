...
- **Source**: AWS Documentation, CloudBurn (2026)
- **Reliability**: High
...
- **Convertible RIs**: Up to 54% savings, allows changing instance family

## Mental Models
- **RI as subscription**: Pay upfront for a guaranteed discount; like a gym membership vs per-visit pricing
- **Flexibility tradeoff**: Higher commitment = higher savings; more flexibility = lower savings
...
## Research Notes
RIs remain valuable for steady-state database workloads with predictable growth. The 2025 introduction of Database Savings Plans provides a more flexible alternative. Best practice: use RIs for baseline production databases, On-Demand for variable workloads, and Database Savings Plans for multi-instance fleets.
