# Skill: Analyze and Optimize Rds Reserved Instances

## Purpose

Analyze current infrastructure costs related to Rds Reserved Instances and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Rds Reserved Instances in a production Laravel application
- When optimizing or hardening Rds Reserved Instances for operational use
...
1. Inventory current Rds Reserved Instances resources, configurations, and usage patterns
...
- Configure and Implement Rds Reserved Instances
- Monitor and Maintain Rds Reserved Instances
...
# Skill: Implement Rds Reserved Instances Cost Controls

## Purpose

Establish governance and automated controls to maintain Rds Reserved Instances cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Rds Reserved Instances
