...
1. Setting max_connections to 10000 on small instance
2. No connection timeout
3. Sharing max_connections budget across apps
4. Ignoring RDS Proxy cost
...
## Anti-Pattern 1: Setting max_connections to 10000 on small instance

### Category
Design / Architecture

### Description
Setting max_connections to 10000 on small instance. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No connection timeout

### Category
Design / Architecture

### Description
No connection timeout. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Sharing max_connections budget across apps

### Category
Design / Architecture

### Description
Sharing max_connections budget across apps. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Ignoring RDS Proxy cost

### Category
Design / Architecture

### Description
Ignoring RDS Proxy cost. This pattern violates best practices and introduces technical debt that compounds over time.
