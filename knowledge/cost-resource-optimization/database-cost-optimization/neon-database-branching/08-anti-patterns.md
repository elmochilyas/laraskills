...
1. Sharing one dev database across team
2. Manually restoring backups for test environments
3. No branch lifecycle management
4. Branching production for every minor task
...
## Anti-Pattern 1: Sharing one dev database across team

### Category
Design / Architecture

### Description
Sharing one dev database across team. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Manually restoring backups for test environments

### Category
Design / Architecture

### Description
Manually restoring backups for test environments. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No branch lifecycle management

### Category
Design / Architecture

### Description
No branch lifecycle management. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Branching production for every minor task

### Category
Design / Architecture

### Description
Branching production for every minor task. This pattern violates best practices and introduces technical debt that compounds over time.
