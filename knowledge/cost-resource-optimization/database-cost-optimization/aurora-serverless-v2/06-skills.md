# Skill: Analyze and Optimize Aurora Serverless V2

## Purpose

Analyze current infrastructure costs related to Aurora Serverless V2 and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Aurora Serverless V2 in a production Laravel application
- When optimizing or hardening Aurora Serverless V2 for operational use
...
1. Inventory current Aurora Serverless V2 resources, configurations, and usage patterns
...
- Configure and Implement Aurora Serverless V2
- Monitor and Maintain Aurora Serverless V2
...
# Skill: Implement Aurora Serverless V2 Cost Controls

## Purpose

Establish governance and automated controls to maintain Aurora Serverless V2 cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Aurora Serverless V2
