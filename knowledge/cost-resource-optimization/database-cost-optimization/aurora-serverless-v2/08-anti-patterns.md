...
1. Min ACU = 0.5 in production
2. Serverless v2 + RDS Proxy without cost analysis
3. No max ACU limit
4. Serverless v2 for write-heavy workloads
...
## Anti-Pattern 1: Min ACU = 0.5 in production

### Category
Design / Architecture

### Description
Min ACU = 0.5 in production. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No max ACU limit

### Category
Design / Architecture

### Description
No max ACU limit. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Serverless v2 for write-heavy workloads

### Category
Design / Architecture

### Description
Serverless v2 for write-heavy workloads. This pattern violates best practices and introduces technical debt that compounds over time.
