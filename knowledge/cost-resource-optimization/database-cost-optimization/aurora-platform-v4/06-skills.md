# Skill: Analyze and Optimize Aurora Platform V4

## Purpose

Analyze current infrastructure costs related to Aurora Platform V4 and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Aurora Platform V4 in a production Laravel application
- When optimizing or hardening Aurora Platform V4 for operational use
...
1. Inventory current Aurora Platform V4 resources, configurations, and usage patterns
...
- Configure and Implement Aurora Platform V4
- Monitor and Maintain Aurora Platform V4
...
# Skill: Implement Aurora Platform V4 Cost Controls

## Purpose

Establish governance and automated controls to maintain Aurora Platform V4 cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Aurora Platform V4
