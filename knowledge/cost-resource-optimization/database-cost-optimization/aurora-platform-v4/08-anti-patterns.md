...
1. Staying on v3 indefinitely
2. Skipping instance rightsizing after v4
3. Upgrade without rollback plan
4. Not checking Aurora v4 prerequisites
...
## Anti-Pattern 1: Staying on v3 indefinitely

### Category
Design / Architecture

### Description
Staying on v3 indefinitely. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Skipping instance rightsizing after v4

### Category
Design / Architecture

### Description
Skipping instance rightsizing after v4. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Upgrade without rollback plan

### Category
Design / Architecture

### Description
Upgrade without rollback plan. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Not checking Aurora v4 prerequisites

### Category
Design / Architecture

### Description
Not checking Aurora v4 prerequisites. This pattern violates best practices and introduces technical debt that compounds over time.
