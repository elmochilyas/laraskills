...
1. Lazy loading in production
2. Over-fetching in API resources
...
## Anti-Pattern 1: Lazy loading in production

### Category
Design / Architecture

### Description
Lazy loading in production. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Over-fetching in API resources

### Category
Design / Architecture

### Description
Over-fetching in API resources. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No pagination on list endpoints

### Category
Design / Architecture

### Description
No pagination on list endpoints. This pattern violates best practices and introduces technical debt that compounds over time.
