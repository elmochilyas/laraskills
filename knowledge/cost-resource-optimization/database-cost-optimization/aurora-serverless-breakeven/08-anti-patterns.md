...
1. Serverless v2 for everything
2. Min ACU = 0.5 in production
3. No RI on provisioned
4. RDS Proxy with every Serverless v2
...
## Anti-Pattern 1: Serverless v2 for everything

### Category
Design / Architecture

### Description
Serverless v2 for everything. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Min ACU = 0.5 in production
...
## Anti-Pattern 3: No RI on provisioned

### Category
Design / Architecture

### Description
No RI on provisioned. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: RDS Proxy with every Serverless v2

### Category
Design / Architecture

### Description
RDS Proxy with every Serverless v2. This pattern violates best practices and introduces technical debt that compounds over time.
