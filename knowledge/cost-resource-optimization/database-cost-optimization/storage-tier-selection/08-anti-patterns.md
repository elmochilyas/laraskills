...
1. gp3 with 0 IOPS baseline
2. io2 for all databases
3. Aurora without I/O monitoring
4. Manual storage scaling
...
## Anti-Pattern 1: gp3 with 0 IOPS baseline

### Category
Design / Architecture

### Description
gp3 with 0 IOPS baseline. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: io2 for all databases

### Category
Design / Architecture

### Description
io2 for all databases. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Aurora without I/O monitoring

### Category
Design / Architecture

### Description
Aurora without I/O monitoring. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Manual storage scaling

### Category
Design / Architecture

### Description
Manual storage scaling. This pattern violates best practices and introduces technical debt that compounds over time.
