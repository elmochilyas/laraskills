...
1. Neon for production with strict HA requirements
2. Branching every PR with full production data
3. No compute limits on branches
4. Ignoring free tier limits
...
## Anti-Pattern 1: Neon for production with strict HA requirements

### Category
Design / Architecture

### Description
Neon for production with strict HA requirements. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Branching every PR with full production data

### Category
Design / Architecture

### Description
Branching every PR with full production data. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No compute limits on branches

### Category
Design / Architecture

### Description
No compute limits on branches. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Ignoring free tier limits

### Category
Design / Architecture

### Description
Ignoring free tier limits. This pattern violates best practices and introduces technical debt that compounds over time.
