...
1. Single replica for everything
2. Cross-region replica for active-active writes
3. Replica without monitoring
...
## Anti-Pattern 1: Single replica for everything

### Category
Design / Architecture

### Description
Single replica for everything. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Cross-region replica for active-active writes

### Category
Design / Architecture

### Description
Cross-region replica for active-active writes. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Replica without monitoring

### Category
Design / Architecture

### Description
Replica without monitoring. This pattern violates best practices and introduces technical debt that compounds over time.
