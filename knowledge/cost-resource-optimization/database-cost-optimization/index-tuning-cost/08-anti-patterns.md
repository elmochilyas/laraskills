...
1. Index-every-column approach
2. No monitoring of index usage
3. Indexing cascade in migrations
4. Duplicate indexes
...
## Anti-Pattern 1: Index-every-column approach

### Category
Design / Architecture

### Description
Index-every-column approach. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No monitoring of index usage

### Category
Design / Architecture

### Description
No monitoring of index usage. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Indexing cascade in migrations

### Category
Design / Architecture

### Description
Indexing cascade in migrations. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Duplicate indexes. This pattern violates best practices and introduces technical debt that compounds over time.
