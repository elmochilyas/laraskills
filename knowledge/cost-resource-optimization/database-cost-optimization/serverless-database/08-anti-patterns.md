...
1. Aurora Serverless v2 + single AZ
2. Neon for all environments including production
3. No max ACU cap
4. Serverless for steady-state workloads
...
## Anti-Pattern 1: Aurora Serverless v2 + single AZ

### Category
Design / Architecture

### Description
Aurora Serverless v2 + single AZ. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Neon for all environments including production

### Category
Design / Architecture

### Description
Neon for all environments including production. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No max ACU cap

### Category
Design / Architecture

### Description
No max ACU cap. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Serverless for steady-state workloads

### Category
Design / Architecture

### Description
Serverless for steady-state workloads. This pattern violates best practices and introduces technical debt that compounds over time.
