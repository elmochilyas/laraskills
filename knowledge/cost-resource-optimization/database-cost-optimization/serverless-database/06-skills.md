# Skill: Analyze and Optimize Serverless Database

## Purpose

Analyze current infrastructure costs related to Serverless Database and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Serverless Database in a production Laravel application
- When optimizing or hardening Serverless Database for operational use
...
1. Inventory current Serverless Database resources, configurations, and usage patterns
...
- Configure and Implement Serverless Database
- Monitor and Maintain Serverless Database
...
# Skill: Implement Serverless Database Cost Controls

## Purpose

Establish governance and automated controls to maintain Serverless Database cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Serverless Database
