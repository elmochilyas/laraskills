# Skill: Analyze and Optimize Rds Savings Plans

## Purpose

Analyze current infrastructure costs related to Rds Savings Plans and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Rds Savings Plans in a production Laravel application
- When optimizing or hardening Rds Savings Plans for operational use
...
1. Inventory current Rds Savings Plans resources, configurations, and usage patterns
...
- Configure and Implement Rds Savings Plans
- Monitor and Maintain Rds Savings Plans
...
# Skill: Implement Rds Savings Plans Cost Controls

## Purpose

Establish governance and automated controls to maintain Rds Savings Plans cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Rds Savings Plans
