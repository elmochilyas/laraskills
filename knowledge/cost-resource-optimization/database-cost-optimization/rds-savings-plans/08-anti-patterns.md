...
1. 3-year SP for startup with uncertain future
2. SP for dev/test databases
3. 100% SP coverage with no On-Demand
4. SP + RI overlap
...
## Anti-Pattern 1: 3-year SP for startup with uncertain future

### Category
Design / Architecture

### Description
3-year SP for startup with uncertain future. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: SP for dev/test databases

### Category
Design / Architecture

### Description
SP for dev/test databases. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: 100% SP coverage with no On-Demand

### Category
Design / Architecture

### Description
100% SP coverage with no On-Demand. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: SP + RI overlap

### Category
Design / Architecture

### Description
SP + RI overlap. This pattern violates best practices and introduces technical debt that compounds over time.
