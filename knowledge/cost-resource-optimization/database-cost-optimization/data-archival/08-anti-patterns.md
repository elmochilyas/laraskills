...
2. Manual archival
3. Archiving without testing restoration
4. S3 CSV archival without indexing
...
## Anti-Pattern 1: Keeping everything forever

### Category
Design / Architecture

### Description
Keeping everything forever. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Manual archival

### Category
Design / Architecture

### Description
Manual archival. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Archiving without testing restoration

### Category
Design / Architecture

### Description
Archiving without testing restoration. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: S3 CSV archival without indexing

### Category
Design / Architecture

### Description
S3 CSV archival without indexing. This pattern violates best practices and introduces technical debt that compounds over time.
