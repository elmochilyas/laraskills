# Skill: Analyze and Optimize Data Archival

## Purpose

Analyze current infrastructure costs related to Data Archival and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Data Archival in a production Laravel application
- When optimizing or hardening Data Archival for operational use
...
1. Inventory current Data Archival resources, configurations, and usage patterns
...
- Configure and Implement Data Archival
- Monitor and Maintain Data Archival
...
# Skill: Implement Data Archival Cost Controls

## Purpose

Establish governance and automated controls to maintain Data Archival cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Data Archival
