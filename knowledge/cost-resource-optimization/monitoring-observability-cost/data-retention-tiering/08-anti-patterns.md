...
1. Single-tier retention
2. Manual archive pruning
3. No compliance expiration tracking
4. Archiving everything
...
## Anti-Pattern 1: Single-tier retention

### Category
Design / Architecture

### Description
Single-tier retention. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Manual archive pruning

### Category
Design / Architecture

### Description
Manual archive pruning. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No compliance expiration tracking

### Category
Design / Architecture

### Description
No compliance expiration tracking. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Archiving everything

### Category
Design / Architecture

### Description
Archiving everything. This pattern violates best practices and introduces technical debt that compounds over time.
