# Skill: Analyze and Optimize Data Retention Tiering

## Purpose

Analyze current infrastructure costs related to Data Retention Tiering and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Data Retention Tiering in a production Laravel application
- When optimizing or hardening Data Retention Tiering for operational use
...
1. Inventory current Data Retention Tiering resources, configurations, and usage patterns
...
- Configure and Implement Data Retention Tiering
- Monitor and Maintain Data Retention Tiering
...
# Skill: Implement Data Retention Tiering Cost Controls

## Purpose

Establish governance and automated controls to maintain Data Retention Tiering cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Data Retention Tiering
