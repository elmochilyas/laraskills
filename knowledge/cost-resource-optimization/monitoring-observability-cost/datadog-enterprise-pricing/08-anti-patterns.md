...
1. Buying Datadog for a single-service Laravel app
2. Ignoring host count optimization
3. No sampling strategy
4. Relying solely on Datadog without infra alerts
...
## Anti-Pattern 1: Buying Datadog for a single-service Laravel app

### Category
Design / Architecture

### Description
Buying Datadog for a single-service Laravel app. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Ignoring host count optimization

### Category
Design / Architecture

### Description
Ignoring host count optimization. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No sampling strategy

### Category
Design / Architecture

### Description
No sampling strategy. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Relying solely on Datadog without infra alerts

### Category
Design / Architecture

### Description
Relying solely on Datadog without infra alerts. This pattern violates best practices and introduces technical debt that compounds over time.
