# Skill: Analyze and Optimize Datadog Enterprise Pricing

## Purpose

Analyze current infrastructure costs related to Datadog Enterprise Pricing and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Datadog Enterprise Pricing in a production Laravel application
- When optimizing or hardening Datadog Enterprise Pricing for operational use
...
1. Inventory current Datadog Enterprise Pricing resources, configurations, and usage patterns
...
- Configure and Implement Datadog Enterprise Pricing
- Monitor and Maintain Datadog Enterprise Pricing
...
# Skill: Implement Datadog Enterprise Pricing Cost Controls

## Purpose

Establish governance and automated controls to maintain Datadog Enterprise Pricing cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Datadog Enterprise Pricing
