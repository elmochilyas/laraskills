...
1. Verbose debug logging in production
2. Keeping all logs forever
3. One metric per state
4. Manual dashboard proliferation
...
## Anti-Pattern 1: Verbose debug logging in production

### Category
Design / Architecture

### Description
Verbose debug logging in production. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Keeping all logs forever

### Category
Design / Architecture

### Description
Keeping all logs forever. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: One metric per state

### Category
Design / Architecture

### Description
One metric per state. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Manual dashboard proliferation

### Category
Design / Architecture

### Description
Manual dashboard proliferation. This pattern violates best practices and introduces technical debt that compounds over time.
