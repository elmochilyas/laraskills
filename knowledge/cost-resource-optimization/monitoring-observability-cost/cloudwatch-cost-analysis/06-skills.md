# Skill: Analyze and Optimize Cloudwatch Cost Analysis

## Purpose

Analyze current infrastructure costs related to Cloudwatch Cost Analysis and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Cloudwatch Cost Analysis in a production Laravel application
- When optimizing or hardening Cloudwatch Cost Analysis for operational use
...
1. Inventory current Cloudwatch Cost Analysis resources, configurations, and usage patterns
...
- Configure and Implement Cloudwatch Cost Analysis
- Monitor and Maintain Cloudwatch Cost Analysis
...
# Skill: Implement Cloudwatch Cost Analysis Cost Controls

## Purpose

Establish governance and automated controls to maintain Cloudwatch Cost Analysis cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Cloudwatch Cost Analysis
