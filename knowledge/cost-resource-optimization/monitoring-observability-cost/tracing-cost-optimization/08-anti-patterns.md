...
1. Tracing without monitoring cost
2. Excessive span detail
...
## Anti-Pattern 1: Tracing without monitoring cost

### Category
Design / Architecture

### Description
Tracing without monitoring cost. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Excessive span detail

### Category
Design / Architecture

### Description
Excessive span detail. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No sampling configuration

### Category
Design / Architecture

### Description
No sampling configuration. This pattern violates best practices and introduces technical debt that compounds over time.
