# Skill: Analyze and Optimize Tracing Cost Optimization

## Purpose

Analyze current infrastructure costs related to Tracing Cost Optimization and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Tracing Cost Optimization in a production Laravel application
- When optimizing or hardening Tracing Cost Optimization for operational use
...
1. Inventory current Tracing Cost Optimization resources, configurations, and usage patterns
...
- Configure and Implement Tracing Cost Optimization
- Monitor and Maintain Tracing Cost Optimization
...
# Skill: Implement Tracing Cost Optimization Cost Controls

## Purpose

Establish governance and automated controls to maintain Tracing Cost Optimization cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Tracing Cost Optimization
