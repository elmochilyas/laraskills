...
1. Sending infrastructure metrics to New Relic
2. Full tracing on all endpoints
3. Logging everything to New Relic
4. No ingest budget
...
## Anti-Pattern 1: Sending infrastructure metrics to New Relic

### Category
Design / Architecture

### Description
Sending infrastructure metrics to New Relic. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Full tracing on all endpoints

### Category
Design / Architecture

### Description
Full tracing on all endpoints. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Logging everything to New Relic

### Category
Design / Architecture

### Description
Logging everything to New Relic. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: No ingest budget

### Category
Design / Architecture

### Description
No ingest budget. This pattern violates best practices and introduces technical debt that compounds over time.
