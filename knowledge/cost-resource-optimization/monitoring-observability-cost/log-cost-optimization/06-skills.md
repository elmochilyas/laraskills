# Skill: Analyze and Optimize Log Cost Optimization

## Purpose

Analyze current infrastructure costs related to Log Cost Optimization and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Log Cost Optimization in a production Laravel application
- When optimizing or hardening Log Cost Optimization for operational use
...
1. Inventory current Log Cost Optimization resources, configurations, and usage patterns
...
- Configure and Implement Log Cost Optimization
- Monitor and Maintain Log Cost Optimization
...
# Skill: Implement Log Cost Optimization Cost Controls

## Purpose

Establish governance and automated controls to maintain Log Cost Optimization cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Log Cost Optimization
