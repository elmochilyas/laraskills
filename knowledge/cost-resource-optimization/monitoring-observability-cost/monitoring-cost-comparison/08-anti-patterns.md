...
1. Enterprise tool for startup scale
2. No hybrid strategy
3. Tool proliferation
4. Set-and-forget monitoring cost
...
## Anti-Pattern 1: Enterprise tool for startup scale

### Category
Design / Architecture

### Description
Enterprise tool for startup scale. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No hybrid strategy

### Category
Design / Architecture

### Description
No hybrid strategy. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Tool proliferation

### Category
Design / Architecture

### Description
Tool proliferation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Set-and-forget monitoring cost

### Category
Design / Architecture

### Description
Set-and-forget monitoring cost. This pattern violates best practices and introduces technical debt that compounds over time.
