...
1. Scout for multi-language environments
2. Scout without infrastructure monitoring
3. Highest tier by default
4. No error alerting
...
## Anti-Pattern 1: Scout for multi-language environments

### Category
Design / Architecture

### Description
Scout for multi-language environments. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Scout without infrastructure monitoring

### Category
Design / Architecture

### Description
Scout without infrastructure monitoring. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Highest tier by default

### Category
Design / Architecture

### Description
Highest tier by default. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: No error alerting

### Category
Design / Architecture

### Description
No error alerting. This pattern violates best practices and introduces technical debt that compounds over time.
