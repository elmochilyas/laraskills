# Skill: Analyze and Optimize Scout Apm Laravel

## Purpose

Analyze current infrastructure costs related to Scout Apm Laravel and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Scout Apm Laravel in a production Laravel application
- When optimizing or hardening Scout Apm Laravel for operational use
...
1. Inventory current Scout Apm Laravel resources, configurations, and usage patterns
...
- Configure and Implement Scout Apm Laravel
- Monitor and Maintain Scout Apm Laravel
...
# Skill: Implement Scout Apm Laravel Cost Controls

## Purpose

Establish governance and automated controls to maintain Scout Apm Laravel cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Scout Apm Laravel
