...
### Description
Metric explosion. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No metric cost monitoring

### Category
Design / Architecture

### Description
No metric cost monitoring. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: duplicate metrics

### Category
Design / Architecture

### Description
duplicate metrics. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Excessive granularity

### Category
Design / Architecture

### Description
Excessive granularity. This pattern violates best practices and introduces technical debt that compounds over time.
