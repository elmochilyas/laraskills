...
1. Mass flush on deploy
2. No TTL on any key
3. Same TTL for hot and cold data
...
## Anti-Pattern 1: Mass flush on deploy

### Category
Design / Architecture

### Description
Mass flush on deploy. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No TTL on any key

### Category
Design / Architecture

### Description
No TTL on any key. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Same TTL for hot and cold data

### Category
Design / Architecture

### Description
Same TTL for hot and cold data. This pattern violates best practices and introduces technical debt that compounds over time.
