...
1. Single-node production Redis
2. Cache-everything mentality
3. Mixing cache tiers incorrectly
...
## Anti-Pattern 1: Single-node production Redis

### Category
Design / Architecture

### Description
Single-node production Redis. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Cache-everything mentality

### Category
Design / Architecture

### Description
Cache-everything mentality. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Mixing cache tiers incorrectly

### Category
Design / Architecture

### Description
Mixing cache tiers incorrectly. This pattern violates best practices and introduces technical debt that compounds over time.
