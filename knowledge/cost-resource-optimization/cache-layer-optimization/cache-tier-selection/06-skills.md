# Skill: Analyze and Optimize Cache Tier Selection

## Purpose

Analyze current infrastructure costs related to Cache Tier Selection and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Cache Tier Selection in a production Laravel application
- When optimizing or hardening Cache Tier Selection for operational use
...
1. Inventory current Cache Tier Selection resources, configurations, and usage patterns
...
- 1: Default to Redis with Graviton Nodes
...
- Configure and Implement Cache Tier Selection
- Monitor and Maintain Cache Tier Selection
...
# Skill: Implement Cache Tier Selection Cost Controls

## Purpose

Establish governance and automated controls to maintain Cache Tier Selection cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Cache Tier Selection
