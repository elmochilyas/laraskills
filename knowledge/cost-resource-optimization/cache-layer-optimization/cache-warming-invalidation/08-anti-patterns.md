...
1. Cache-everything-on-deploy
2. No invalidation strategy
3. Sync invalidation in web requests
...
## Anti-Pattern 1: Cache-everything-on-deploy

### Category
Design / Architecture

### Description
Cache-everything-on-deploy. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
No invalidation strategy. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Sync invalidation in web requests

### Category
Design / Architecture

### Description
Sync invalidation in web requests. This pattern violates best practices and introduces technical debt that compounds over time.
