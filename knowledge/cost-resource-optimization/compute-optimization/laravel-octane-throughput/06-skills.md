# Skill: Analyze and Optimize Laravel Octane Throughput

## Purpose

Analyze current infrastructure costs related to Laravel Octane Throughput and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Laravel Octane Throughput in a production Laravel application
- When optimizing or hardening Laravel Octane Throughput for operational use
...
1. Inventory current Laravel Octane Throughput resources, configurations, and usage patterns
...
- Configure and Implement Laravel Octane Throughput
- Monitor and Maintain Laravel Octane Throughput
...
# Skill: Implement Laravel Octane Throughput Cost Controls

## Purpose

Establish governance and automated controls to maintain Laravel Octane Throughput cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Laravel Octane Throughput
