...
1. PHP-FPM as default
2. No max_requests
3. Static property abuse
4. Shared server for web + queues
...
## Anti-Pattern 1: PHP-FPM as default

### Category
Design / Architecture

### Description
PHP-FPM as default. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No max_requests

### Category
Design / Architecture

### Description
No max_requests. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Static property abuse

### Category
Design / Architecture

### Description
Static property abuse. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Shared server for web + queues

### Category
Design / Architecture

### Description
Shared server for web + queues. This pattern violates best practices and introduces technical debt that compounds over time.
