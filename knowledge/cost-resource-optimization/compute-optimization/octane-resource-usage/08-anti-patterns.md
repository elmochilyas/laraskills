...
1. Octane for simple CRUD apps
2. No OPcache with Octane
3. Singleton abuse
...
## Anti-Pattern 1: Octane for simple CRUD apps

### Category
Design / Architecture

### Description
Octane for simple CRUD apps. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No OPcache with Octane

### Category
Design / Architecture

### Description
No OPcache with Octane. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Singleton abuse. This pattern violates best practices and introduces technical debt that compounds over time.
