# Skill: Analyze and Optimize Octane Resource Usage

## Purpose

Analyze current infrastructure costs related to Octane Resource Usage and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Octane Resource Usage in a production Laravel application
- When optimizing or hardening Octane Resource Usage for operational use
...
1. Inventory current Octane Resource Usage resources, configurations, and usage patterns
...
- Configure and Implement Octane Resource Usage
- Monitor and Maintain Octane Resource Usage
...
# Skill: Implement Octane Resource Usage Cost Controls

## Purpose

Establish governance and automated controls to maintain Octane Resource Usage cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Octane Resource Usage
