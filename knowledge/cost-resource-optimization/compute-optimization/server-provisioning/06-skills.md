# Skill: Analyze and Optimize Server Provisioning

## Purpose

Analyze current infrastructure costs related to Server Provisioning and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Server Provisioning in a production Laravel application
- When optimizing or hardening Server Provisioning for operational use
...
1. Inventory current Server Provisioning resources, configurations, and usage patterns
...
- Configure and Implement Server Provisioning
- Monitor and Maintain Server Provisioning
...
# Skill: Implement Server Provisioning Cost Controls

## Purpose

Establish governance and automated controls to maintain Server Provisioning cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Server Provisioning
