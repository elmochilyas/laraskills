...
3. Shared volumes across instances
4. No backups on data volumes
...
## Anti-Pattern 1: Manual server provisioning

### Category
Design / Architecture

### Description
Manual server provisioning. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Instances with public IPs

### Category
Design / Architecture

### Description
Instances with public IPs. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Shared volumes across instances

### Category
Design / Architecture

### Description
Shared volumes across instances. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: No backups on data volumes

### Category
Design / Architecture

### Description
No backups on data volumes. This pattern violates best practices and introduces technical debt that compounds over time.
