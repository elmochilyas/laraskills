...
1. Disabling OPcache for "debugging"
2. Insufficient max_accelerated_files
3. JIT on I/O-bound workloads
...
## Anti-Pattern 1: Disabling OPcache for "debugging"

### Category
Design / Architecture

### Description
Disabling OPcache for "debugging". This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Insufficient max_accelerated_files

### Category
Design / Architecture

### Description
Insufficient max_accelerated_files. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: JIT on I/O-bound workloads

### Category
Design / Architecture

### Description
JIT on I/O-bound workloads. This pattern violates best practices and introduces technical debt that compounds over time.
