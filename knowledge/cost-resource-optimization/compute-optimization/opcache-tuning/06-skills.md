# Skill: Analyze and Optimize Opcache Tuning

## Purpose

Analyze current infrastructure costs related to Opcache Tuning and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Opcache Tuning in a production Laravel application
- When optimizing or hardening Opcache Tuning for operational use
...
1. Inventory current Opcache Tuning resources, configurations, and usage patterns
...
- Configure and Implement Opcache Tuning
- Monitor and Maintain Opcache Tuning
...
# Skill: Implement Opcache Tuning Cost Controls

## Purpose

Establish governance and automated controls to maintain Opcache Tuning cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Opcache Tuning
