...
1. Staying on x86 by default
2. Mixing architectures without multi-arch builds
3. Ignoring Graviton for cost reports
4. Late adoption
...
## Anti-Pattern 1: Staying on x86 by default

### Category
Design / Architecture

### Description
Staying on x86 by default. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Mixing architectures without multi-arch builds

### Category
Design / Architecture

### Description
Mixing architectures without multi-arch builds. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Ignoring Graviton for cost reports

### Category
Design / Architecture

### Description
Ignoring Graviton for cost reports. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Late adoption

### Category
Design / Architecture

### Description
Late adoption. This pattern violates best practices and introduces technical debt that compounds over time.
