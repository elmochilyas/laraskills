...
1. Rip-and-replace migration
2. Cloud as silver bullet
3. No rollback plan
4. Over-provisioning on Cloud
...
## Anti-Pattern 1: Rip-and-replace migration

### Category
Design / Architecture

### Description
Rip-and-replace migration. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Cloud as silver bullet

### Category
Design / Architecture

### Description
Cloud as silver bullet. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Over-provisioning on Cloud

### Category
Design / Architecture

### Description
Over-provisioning on Cloud. This pattern violates best practices and introduces technical debt that compounds over time.
