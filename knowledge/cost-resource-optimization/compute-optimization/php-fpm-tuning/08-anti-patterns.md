...
1. Static pool with large max_children
2. On-demand for production traffic
3. No monitoring of FPM metrics
...
## Anti-Pattern 1: Static pool with large max_children

### Category
Design / Architecture

### Description
Static pool with large max_children. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: On-demand for production traffic

### Category
Design / Architecture

### Description
On-demand for production traffic. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No monitoring of FPM metrics

### Category
Design / Architecture

### Description
No monitoring of FPM metrics. This pattern violates best practices and introduces technical debt that compounds over time.
