# Skill: Analyze and Optimize Fargate Pricing Analysis

## Purpose

Analyze current infrastructure costs related to Fargate Pricing Analysis and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Fargate Pricing Analysis in a production Laravel application
- When optimizing or hardening Fargate Pricing Analysis for operational use
...
1. Inventory current Fargate Pricing Analysis resources, configurations, and usage patterns
...
- Configure and Implement Fargate Pricing Analysis
- Monitor and Maintain Fargate Pricing Analysis
...
# Skill: Implement Fargate Pricing Analysis Cost Controls

## Purpose

Establish governance and automated controls to maintain Fargate Pricing Analysis cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Fargate Pricing Analysis
