...
1. Task-per-PHP-worker
2. Always-on for dev/staging
3. EKS for single-service Fargate
...
## Anti-Pattern 1: Task-per-PHP-worker

### Category
Design / Architecture

### Description
Task-per-PHP-worker. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Always-on for dev/staging

### Category
Design / Architecture

### Description
Always-on for dev/staging. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: EKS for single-service Fargate

### Category
Design / Architecture

### Description
EKS for single-service Fargate. This pattern violates best practices and introduces technical debt that compounds over time.
