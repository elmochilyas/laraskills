# Skill: Analyze and Optimize Fargate Spot Workers

## Purpose

Analyze current infrastructure costs related to Fargate Spot Workers and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Fargate Spot Workers in a production Laravel application
- When optimizing or hardening Fargate Spot Workers for operational use
...
1. Inventory current Fargate Spot Workers resources, configurations, and usage patterns
...
- Configure and Implement Fargate Spot Workers
- Monitor and Maintain Fargate Spot Workers
...
# Skill: Implement Fargate Spot Workers Cost Controls

## Purpose

Establish governance and automated controls to maintain Fargate Spot Workers cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Fargate Spot Workers
