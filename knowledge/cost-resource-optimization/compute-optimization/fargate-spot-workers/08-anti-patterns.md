...
1. 100% Spot without fallback
2. Stateful services on Spot
3. Spot for production web serving
4. No job retry limit
...
## Anti-Pattern 1: 100% Spot without fallback

### Category
Design / Architecture

### Description
100% Spot without fallback. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Stateful services on Spot

### Category
Design / Architecture

### Description
Stateful services on Spot. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Spot for production web serving

### Category
Design / Architecture

### Description
Spot for production web serving. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: No job retry limit

### Category
Design / Architecture

### Description
No job retry limit. This pattern violates best practices and introduces technical debt that compounds over time.
