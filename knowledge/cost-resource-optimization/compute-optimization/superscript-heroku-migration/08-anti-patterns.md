...
1. Migrating all Heroku apps simultaneously
2. Skipping Octane validation
3. No rollback plan
4. Ignoring Neon cold start for user-facing DB queries
...
## Anti-Pattern 1: Migrating all Heroku apps simultaneously

### Category
Design / Architecture

### Description
Migrating all Heroku apps simultaneously. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Skipping Octane validation

### Category
Design / Architecture

### Description
Skipping Octane validation. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
No rollback plan. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Ignoring Neon cold start for user-facing DB queries

### Category
Design / Architecture

### Description
Ignoring Neon cold start for user-facing DB queries. This pattern violates best practices and introduces technical debt that compounds over time.
