...
1. Manual worker management
2. Web + queue on same server
3. On-Demand workers only
...
## Anti-Pattern 1: Manual worker management

### Category
Design / Architecture

### Description
Manual worker management. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Web + queue on same server

### Category
Design / Architecture

### Description
Web + queue on same server. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: On-Demand workers only

### Category
Design / Architecture

### Description
On-Demand workers only. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: No backpressure handling

### Category
Design / Architecture

### Description
No backpressure handling. This pattern violates best practices and introduces technical debt that compounds over time.
