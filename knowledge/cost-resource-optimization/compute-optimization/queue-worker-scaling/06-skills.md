# Skill: Analyze and Optimize Queue Worker Scaling

## Purpose

Analyze current infrastructure costs related to Queue Worker Scaling and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Queue Worker Scaling in a production Laravel application
- When optimizing or hardening Queue Worker Scaling for operational use
...
1. Inventory current Queue Worker Scaling resources, configurations, and usage patterns
...
- Configure and Implement Queue Worker Scaling
- Monitor and Maintain Queue Worker Scaling
...
# Skill: Implement Queue Worker Scaling Cost Controls

## Purpose

Establish governance and automated controls to maintain Queue Worker Scaling cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Queue Worker Scaling
