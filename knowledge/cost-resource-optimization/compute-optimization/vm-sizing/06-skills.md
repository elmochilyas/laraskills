# Skill: Analyze and Optimize Vm Sizing

## Purpose

Analyze current infrastructure costs related to Vm Sizing and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Vm Sizing in a production Laravel application
- When optimizing or hardening Vm Sizing for operational use
...
1. Inventory current Vm Sizing resources, configurations, and usage patterns
...
- Configure and Implement Vm Sizing
- Monitor and Maintain Vm Sizing
...
# Skill: Implement Vm Sizing Cost Controls

## Purpose

Establish governance and automated controls to maintain Vm Sizing cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Vm Sizing
