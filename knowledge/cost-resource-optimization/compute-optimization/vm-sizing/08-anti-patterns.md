...
1. One big instance instead of multiple small
2. x86 default
3. Sizing for peak without Auto Scaling
...
## Anti-Pattern 1: One big instance instead of multiple small

### Category
Design / Architecture

### Description
One big instance instead of multiple small. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: x86 default

### Category
Design / Architecture

### Description
x86 default. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Sizing for peak without Auto Scaling

### Category
Design / Architecture

### Description
Sizing for peak without Auto Scaling. This pattern violates best practices and introduces technical debt that compounds over time.
