...
2. Vapor lock-in without review
3. Rip-and-replace Vapor simultaneous migration
4. Ignoring Forge for commodity workloads
...
## Anti-Pattern 1: Cloud for everything

### Category
Design / Architecture

### Description
Cloud for everything. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Vapor lock-in without review

### Category
Design / Architecture

### Description
Vapor lock-in without review. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Rip-and-replace Vapor simultaneous migration

### Category
Design / Architecture

### Description
Rip-and-replace Vapor simultaneous migration. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Ignoring Forge for commodity workloads

### Category
Design / Architecture

### Description
Ignoring Forge for commodity workloads. This pattern violates best practices and introduces technical debt that compounds over time.
