# Skill: Analyze and Optimize Context Switching

## Purpose

Analyze current infrastructure costs related to Context Switching and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Context Switching in a production Laravel application
- When optimizing or hardening Context Switching for operational use
...
1. Inventory current Context Switching resources, configurations, and usage patterns
...
- Configure and Implement Context Switching
- Monitor and Maintain Context Switching
...
# Skill: Implement Context Switching Cost Controls

## Purpose

Establish governance and automated controls to maintain Context Switching cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Context Switching
