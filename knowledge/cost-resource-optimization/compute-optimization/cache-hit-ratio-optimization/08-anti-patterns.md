...
1. Cache-flush-on-deploy
2. Random eviction reliance
3. Same TTL for all cache entries
...
## Anti-Pattern 1: Cache-flush-on-deploy

### Category
Design / Architecture

### Description
Cache-flush-on-deploy. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Random eviction reliance

### Category
Design / Architecture

### Description
Random eviction reliance. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Same TTL for all cache entries

### Category
Design / Architecture

### Description
Same TTL for all cache entries. This pattern violates best practices and introduces technical debt that compounds over time.
