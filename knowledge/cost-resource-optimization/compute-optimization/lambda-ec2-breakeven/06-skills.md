# Skill: Analyze and Optimize Lambda Ec2 Breakeven

## Purpose

Analyze current infrastructure costs related to Lambda Ec2 Breakeven and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Lambda Ec2 Breakeven in a production Laravel application
- When optimizing or hardening Lambda Ec2 Breakeven for operational use
...
1. Inventory current Lambda Ec2 Breakeven resources, configurations, and usage patterns
...
- Configure and Implement Lambda Ec2 Breakeven
- Monitor and Maintain Lambda Ec2 Breakeven
...
# Skill: Implement Lambda Ec2 Breakeven Cost Controls

## Purpose

Establish governance and automated controls to maintain Lambda Ec2 Breakeven cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Lambda Ec2 Breakeven
