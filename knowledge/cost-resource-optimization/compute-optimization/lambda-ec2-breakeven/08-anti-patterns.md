...
1. Lambda-only architecture at scale
2. EC2 over-provisioned "for safety"
3. Vapor lock-in without breakeven review
4. Ignoring Fargate option
...
## Anti-Pattern 1: Lambda-only architecture at scale

### Category
Design / Architecture

### Description
Lambda-only architecture at scale. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: EC2 over-provisioned "for safety"

### Category
Design / Architecture

### Description
EC2 over-provisioned "for safety". This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Vapor lock-in without breakeven review

### Category
Design / Architecture

### Description
Vapor lock-in without breakeven review. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Ignoring Fargate option

### Category
Design / Architecture

### Description
Ignoring Fargate option. This pattern violates best practices and introduces technical debt that compounds over time.
