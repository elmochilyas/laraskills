...
1. Vapor cost calculated on HTTP request count alone
2. Scaling traffic on Vapor without recalculating breakeven
3. Assuming multiplier is fixed
4. No cost monitoring per Vapor feature
...
## Anti-Pattern 1: Vapor cost calculated on HTTP request count alone

### Category
Design / Architecture

### Description
Vapor cost calculated on HTTP request count alone. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Scaling traffic on Vapor without recalculating breakeven

### Category
Design / Architecture

### Description
Scaling traffic on Vapor without recalculating breakeven. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Assuming multiplier is fixed

### Category
Design / Architecture

### Description
Assuming multiplier is fixed. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: No cost monitoring per Vapor feature

### Category
Design / Architecture

### Description
No cost monitoring per Vapor feature. This pattern violates best practices and introduces technical debt that compounds over time.
