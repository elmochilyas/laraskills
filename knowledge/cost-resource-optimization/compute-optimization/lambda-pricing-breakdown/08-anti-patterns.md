...
## Anti-Pattern 1: Runaway recursion

### Category
Design / Architecture

### Description
Runaway recursion. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Unthrottled event sources

### Category
Design / Architecture

### Description
Unthrottled event sources. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Lambda for everything

### Category
Design / Architecture

### Description
Lambda for everything. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Vapor cost trap

### Category
Design / Architecture

### Description
Vapor cost trap. This pattern violates best practices and introduces technical debt that compounds over time.
