...
1. No pooling with Octane
2. Pooler on database server
3. No monitoring on pool
...
## Anti-Pattern 1: No pooling with Octane

### Category
Design / Architecture

### Description
No pooling with Octane. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Pooler on database server

### Category
Design / Architecture

### Description
Pooler on database server. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No monitoring on pool

### Category
Design / Architecture

### Description
No monitoring on pool. This pattern violates best practices and introduces technical debt that compounds over time.
