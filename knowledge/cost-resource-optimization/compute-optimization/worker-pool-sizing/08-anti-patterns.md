...
1. Fixed workers for variable load
2. Shared pool for web and queue
3. Workers > RAM capacity
...
## Anti-Pattern 1: Fixed workers for variable load

### Category
Design / Architecture

### Description
Fixed workers for variable load. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Shared pool for web and queue

### Category
Design / Architecture

### Description
Shared pool for web and queue. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Workers > RAM capacity

### Category
Design / Architecture

### Description
Workers > RAM capacity. This pattern violates best practices and introduces technical debt that compounds over time.
