...
1. Nginx in front of RoadRunner
2. Running RoadRunner as root
3. Using RoadRunner for legacy Laravel 7/8
...
## Anti-Pattern 1: Nginx in front of RoadRunner

### Category
Design / Architecture

### Description
Nginx in front of RoadRunner. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Running RoadRunner as root

### Category
Design / Architecture

### Description
Running RoadRunner as root. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Using RoadRunner for legacy Laravel 7/8

### Category
Design / Architecture

### Description
Using RoadRunner for legacy Laravel 7/8. This pattern violates best practices and introduces technical debt that compounds over time.
