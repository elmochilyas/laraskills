...
1. Premium tier for no reason
2. Optimization paralysis
3. Vanity metrics
4. Ignoring operations cost
...
## Anti-Pattern 1: Premium tier for no reason

### Category
Design / Architecture

### Description
Premium tier for no reason. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Optimization paralysis

### Category
Design / Architecture

### Description
Optimization paralysis. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Vanity metrics. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Ignoring operations cost

### Category
Design / Architecture

### Description
Ignoring operations cost. This pattern violates best practices and introduces technical debt that compounds over time.
