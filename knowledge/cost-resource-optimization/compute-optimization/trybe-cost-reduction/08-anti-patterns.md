...
1. Vapor at extreme scale without evaluation
2. Rip-and-replace migration at 500M req/month
3. No cost monitoring after migration
...
## Anti-Pattern 1: Vapor at extreme scale without evaluation

### Category
Design / Architecture

### Description
Vapor at extreme scale without evaluation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Rip-and-replace migration at 500M req/month

### Category
Design / Architecture

### Description
Rip-and-replace migration at 500M req/month. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No cost monitoring after migration

### Category
Design / Architecture

### Description
No cost monitoring after migration. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Single-environment deployment

### Category
Design / Architecture

### Description
Single-environment deployment. This pattern violates best practices and introduces technical debt that compounds over time.
