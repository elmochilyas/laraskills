# Skill: Analyze and Optimize Spot Instances Strategy

## Purpose

Analyze current infrastructure costs related to Spot Instances Strategy and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Spot Instances Strategy in a production Laravel application
- When optimizing or hardening Spot Instances Strategy for operational use
...
1. Inventory current Spot Instances Strategy resources, configurations, and usage patterns
...
- Configure and Implement Spot Instances Strategy
- Monitor and Maintain Spot Instances Strategy
...
# Skill: Implement Spot Instances Strategy Cost Controls

## Purpose

Establish governance and automated controls to maintain Spot Instances Strategy cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Spot Instances Strategy
