...
1. Spot for databases
2. Single-AZ Spot
3. No On-Demand fallback
4. Manual Spot management
5. Spot for Octane
...
## Anti-Pattern 1: Spot for databases

### Category
Design / Architecture

### Description
Spot for databases. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Single-AZ Spot

### Category
Design / Architecture

### Description
Single-AZ Spot. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No On-Demand fallback

### Category
Design / Architecture

### Description
No On-Demand fallback. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Manual Spot management

### Category
Design / Architecture

### Description
Manual Spot management. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Spot for Octane

### Category
Design / Architecture

### Description
Spot for Octane. This pattern violates best practices and introduces technical debt that compounds over time.
