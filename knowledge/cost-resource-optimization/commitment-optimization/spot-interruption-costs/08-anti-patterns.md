...
1. Spot for everything without analysis
2. No Spot interruption monitoring
3. Ignoring engineering overhead
4. Long-running stateful jobs on Spot
...
## Anti-Pattern 1: Spot for everything without analysis

### Category
Design / Architecture

### Description
Spot for everything without analysis. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No Spot interruption monitoring

### Category
Design / Architecture

### Description
No Spot interruption monitoring. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Ignoring engineering overhead

### Category
Design / Architecture

### Description
Ignoring engineering overhead. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Long-running stateful jobs on Spot

### Category
Design / Architecture

### Description
Long-running stateful jobs on Spot. This pattern violates best practices and introduces technical debt that compounds over time.
