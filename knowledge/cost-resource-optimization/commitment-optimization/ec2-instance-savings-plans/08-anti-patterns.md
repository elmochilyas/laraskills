...
1. Instance SP for Fargate or Lambda
2. Instance SP for development accounts
...
## Anti-Pattern 1: Instance SP for Fargate or Lambda

### Category
Design / Architecture

### Description
Instance SP for Fargate or Lambda. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Instance SP for development accounts

### Category
Design / Architecture

### Description
Instance SP for development accounts. This pattern violates best practices and introduces technical debt that compounds over time.
