# Skill: Analyze and Optimize Ec2 Instance Savings Plans

## Purpose

Analyze current infrastructure costs related to Ec2 Instance Savings Plans and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Ec2 Instance Savings Plans in a production Laravel application
- When optimizing or hardening Ec2 Instance Savings Plans for operational use
...
1. Inventory current Ec2 Instance Savings Plans resources, configurations, and usage patterns
...
- Configure and Implement Ec2 Instance Savings Plans
- Monitor and Maintain Ec2 Instance Savings Plans
...
# Skill: Implement Ec2 Instance Savings Plans Cost Controls

## Purpose

Establish governance and automated controls to maintain Ec2 Instance Savings Plans cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Ec2 Instance Savings Plans
