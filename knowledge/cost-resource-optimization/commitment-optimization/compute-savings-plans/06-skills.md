# Skill: Analyze and Optimize Compute Savings Plans

## Purpose

Analyze current infrastructure costs related to Compute Savings Plans and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Compute Savings Plans in a production Laravel application
- When optimizing or hardening Compute Savings Plans for operational use
...
1. Inventory current Compute Savings Plans resources, configurations, and usage patterns
...
- Configure and Implement Compute Savings Plans
- Monitor and Maintain Compute Savings Plans
...
# Skill: Implement Compute Savings Plans Cost Controls

## Purpose

Establish governance and automated controls to maintain Compute Savings Plans cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Compute Savings Plans
