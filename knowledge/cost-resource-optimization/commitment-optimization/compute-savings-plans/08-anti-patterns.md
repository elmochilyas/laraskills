...
1. Buying RIs instead of Compute SPs
2. 100% On-Demand
3. Auto-renew without review
4. Single-account SP management
...
## Anti-Pattern 1: Buying RIs instead of Compute SPs

### Category
Design / Architecture

### Description
Buying RIs instead of Compute SPs. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: 100% On-Demand

### Category
Design / Architecture

### Description
100% On-Demand. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Auto-renew without review

### Category
Design / Architecture

### Description
Auto-renew without review. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Single-account SP management

### Category
Design / Architecture

### Description
Single-account SP management. This pattern violates best practices and introduces technical debt that compounds over time.
