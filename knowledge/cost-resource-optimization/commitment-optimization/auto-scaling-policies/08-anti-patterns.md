...
1. Manual scaling
2. Scaling on CloudWatch metrics with 1-minute resolution
3. Identical min/max capacity
4. No scale-in protection
...
## Anti-Pattern 1: Manual scaling

### Category
Design / Architecture

### Description
Manual scaling. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Scaling on CloudWatch metrics with 1-minute resolution

### Category
Design / Architecture

### Description
Scaling on CloudWatch metrics with 1-minute resolution. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Identical min/max capacity

### Category
Design / Architecture

### Description
Identical min/max capacity. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: No scale-in protection

### Category
Design / Architecture

### Description
No scale-in protection. This pattern violates best practices and introduces technical debt that compounds over time.
