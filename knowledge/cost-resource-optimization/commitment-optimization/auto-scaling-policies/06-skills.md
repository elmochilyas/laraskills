# Skill: Analyze and Optimize Auto Scaling Policies

## Purpose

Analyze current infrastructure costs related to Auto Scaling Policies and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Auto Scaling Policies in a production Laravel application
- When optimizing or hardening Auto Scaling Policies for operational use
...
1. Inventory current Auto Scaling Policies resources, configurations, and usage patterns
...
- Configure and Implement Auto Scaling Policies
- Monitor and Maintain Auto Scaling Policies
...
# Skill: Implement Auto Scaling Policies Cost Controls

## Purpose

Establish governance and automated controls to maintain Auto Scaling Policies cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Auto Scaling Policies
