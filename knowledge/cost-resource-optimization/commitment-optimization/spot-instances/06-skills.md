# Skill: Analyze and Optimize Spot Instances

## Purpose

Analyze current infrastructure costs related to Spot Instances and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Spot Instances in a production Laravel application
- When optimizing or hardening Spot Instances for operational use
...
1. Inventory current Spot Instances resources, configurations, and usage patterns
...
- Configure and Implement Spot Instances
- Monitor and Maintain Spot Instances
...
# Skill: Implement Spot Instances Cost Controls

## Purpose

Establish governance and automated controls to maintain Spot Instances cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Spot Instances
