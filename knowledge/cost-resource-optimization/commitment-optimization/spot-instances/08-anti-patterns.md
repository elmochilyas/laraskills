...
## Anti-Pattern 3: No fallback to On-Demand

### Category
Design / Architecture

### Description
No fallback to On-Demand. This pattern violates best practices and introduces technical debt that compounds over time.
