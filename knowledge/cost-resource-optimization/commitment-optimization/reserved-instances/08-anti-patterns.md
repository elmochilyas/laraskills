...
1. Buying RIs for all instances including variable capacity
2. No RI for production database
3. Setting RI to auto-renew
...
## Anti-Pattern 1: Buying RIs for all instances including variable capacity

### Category
Design / Architecture

### Description
Buying RIs for all instances including variable capacity. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No RI for production database

### Category
Design / Architecture

### Description
No RI for production database. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Setting RI to auto-renew

### Category
Design / Architecture

### Description
Setting RI to auto-renew. This pattern violates best practices and introduces technical debt that compounds over time.
