# Skill: Analyze and Optimize Reserved Instances

## Purpose

Analyze current infrastructure costs related to Reserved Instances and implement optimizations to reduce spending while maintaining performance.

## When To Use

- When implementing Reserved Instances in a production Laravel application
- When optimizing or hardening Reserved Instances for operational use
...
1. Inventory current Reserved Instances resources, configurations, and usage patterns
...
- Configure and Implement Reserved Instances
- Monitor and Maintain Reserved Instances
...
# Skill: Implement Reserved Instances Cost Controls

## Purpose

Establish governance and automated controls to maintain Reserved Instances cost optimization over time.
...
1. Define budget thresholds and cost allocation tags for Reserved Instances
