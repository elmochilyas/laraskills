# Skill: Implement Cqrs Read Model Projector

## Purpose

Set up Cqrs Read Model Projector for data engineering and analytics workflows in a Laravel application, covering ingestion, processing, and storage.

## When To Use

- When implementing Cqrs Read Model Projector in a production Laravel application
- When optimizing or hardening Cqrs Read Model Projector for operational use
...
1. Define the data schema and structure for Cqrs Read Model Projector
...
- 1: Always Queue Projector Execution
- 2: Idempotent Projectors with `upsert()`
- 3: One Projector Class Per Read Model

## Related Skills

- Configure and Implement Cqrs Read Model Projector
- Monitor and Maintain Cqrs Read Model Projector

## Success Criteria

- Cqrs Read Model Projector configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize Cqrs Read Model Projector for Scale

## Purpose

Scale and optimize Cqrs Read Model Projector for production analytics workloads including performance tuning, cost management, and reliability.
