...
# Core Concepts
This knowledge unit addresses key concerns related to Distributed monolith anti-pattern in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Assuming deploying separately equals decoupled â†’ shared DB makes them coupled
...
- **Description**: Adding event bus without service autonomy â†’ events don't fix wrong boundaries
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: "Microservices" without DevOps maturity â†’ deployment complexity outweighs benefit
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not monitoring cross-service calls â†’ coupling undetected until too late
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Rewriting monolith as microservices â†’ distributed monolith with more moving parts
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Microservices, Service decomposition
Related: Shared database anti-pattern, Service boundaries, Data ownership, Synchronous coupling
...
When assisting with architecture decisions related to Distributed monolith anti-pattern:
