...
# Core Concepts
This knowledge unit addresses key concerns related to Interface explosion vs interface starvation in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Interface for every service class (explosion) â†’ navigation nightmare, mock everything unnecessarily
...
- **Description**: No interfaces for external dependencies (starvation) â†’ can't test without real services
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Interface defined after implementation â†’ interface mirrors concrete class exactly
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Interface with "I" prefix â†’ Java conventions in PHP (not idiomatic)
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: One interface, one implementation, never swapped â†’ wasted abstraction
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: ISP, Interface design
Related: ISP violations (too large interfaces), Premature abstraction (YAGNI), Adapter pattern (interface at boundaries)
...
When assisting with architecture decisions related to Interface explosion vs interface starvation:
