...
# Core Concepts
This knowledge unit addresses key concerns related to Coupling types and measurement in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Ignoring coupling until rewrites are needed â†’ high coupling entrenched
...
- **Description**: Measuring but not acting â†’ metrics without refactoring
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Focusing only on code coupling â†’ ignoring deployment/team coupling
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Excessive decoupling (everything via events) â†’ complexity outweighs benefit
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Treating all coupling equally â†’ data coupling is acceptable, content coupling is not
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Cohesion types, Modular design
Related: Cohesion measurement, Dependency analysis, Modularity metrics, Architecture fitness functions
...
When assisting with architecture decisions related to Coupling types and measurement:
