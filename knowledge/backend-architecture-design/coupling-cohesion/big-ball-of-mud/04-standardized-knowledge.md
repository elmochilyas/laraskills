...
# Core Concepts
This knowledge unit addresses key concerns related to Big Ball of Mud detection and remediation in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Attempting full rewrite â†’ high risk, loss of business knowledge
...
- **Description**: Big Bang refactoring â†’ too many changes at once, breaks everything
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No boundaries enforcement â†’ new code continues degrading
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Perfectionism â†’ 80% improvement is better than 100% abandonment
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No metrics â†’ can't measure progress or regression
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Leadership doesn't invest â†’ architectural debt accumulates faster
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Coupling types, Cohesion types
Related: Strangler Fig (remediation pattern), God class, Distributed monolith, Architecture fitness functions
...
When assisting with architecture decisions related to Big Ball of Mud detection and remediation:
