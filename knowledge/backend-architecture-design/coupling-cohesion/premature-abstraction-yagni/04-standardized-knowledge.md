...
# Core Concepts
This knowledge unit addresses key concerns related to Premature abstraction and YAGNI violations in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Abstracting because "we might need it later" â†’ YAGNI violation
...
- **Description**: Interface for everything â†’ navigation overhead, mocking complexity
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Repository for every model â†’ unnecessary abstraction for CRUD
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not abstracting at proven variation points â†’ lots of duplicated switch statements
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Over-correcting: never abstracting â†’ model pollution, duplicated logic
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: YAGNI, KISS
Related: Interface explosion (over-abstraction), Interface starvation (under-abstraction), Big Ball of Mud (no abstraction)
...
When assisting with architecture decisions related to Premature abstraction and YAGNI violations:
