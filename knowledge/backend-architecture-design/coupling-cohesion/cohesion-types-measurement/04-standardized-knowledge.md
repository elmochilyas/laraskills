...
Cohesion measures how closely the responsibilities of a module are related. Higher cohesion is better â€” elements within a module should contribute to a single, well-defined purpose. The cohesion spectrum (coincidental â†’ logical â†’ temporal â†’ procedural â†’ communicational â†’ sequential â†’ functional) ranges from worst to best. In Laravel, low cohesion appears as "Utility" classes (logical cohesion), god models (coincidental/functional mix), and service classes doing unrelated operations. Measurement helps identify classes that should be split.

---

# Core Concepts
This knowledge unit addresses key concerns related to Cohesion types and measurement in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Treating cohesion as boolean â†’ it's a spectrum, not pass/fail
...
- **Description**: Functional cohesion for everything â†’ not all classes need to be single-method
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: High cohesion at expense of coupling â†’ splitting classes increases coupling
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Measuring without context â†’ metrics without understanding class purpose
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Ignoring package-level cohesion â†’ focusing only on class cohesion
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Coupling types, Class design
Related: Coupling measurement, SRP, Modularity metrics, Class splitting techniques
...
When assisting with architecture decisions related to Cohesion types and measurement:
