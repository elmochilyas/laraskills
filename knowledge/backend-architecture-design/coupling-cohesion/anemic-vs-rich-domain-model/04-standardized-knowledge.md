...
# Core Concepts
This knowledge unit addresses key concerns related to Anemic domain model vs rich domain model in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Anemic models everywhere, even for complex behavior â†’ all logic in services, no OOP benefit
...
- **Description**: Rich models with persistence concerns â†’ domain model depends on DB (Active Record coupling)
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Overcorrecting: forcing behaviors that don't belong on models â†’ model grows too large
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: All-or-nothing thinking â†’ some areas benefit from rich models, others from anemic
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not recognizing Eloquent's dual role â†’ model is both domain object and persistence object
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Domain Model pattern, Information Expert GRASP
Related: Transaction Script (always anemic alternative), Service Layer (where fat services grow), Domain Model (rich alternative)
...
When assisting with architecture decisions related to Anemic domain model vs rich domain model:
