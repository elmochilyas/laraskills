...
# Core Concepts
This knowledge unit addresses key concerns related to Architecture fitness functions via static analysis in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Too many rules, too early â†’ developer frustration, rules ignored
...
- **Description**: Rules that don't reflect actual architecture â†’ false positives, noise
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No CI enforcement â†’ rules run locally only, violations creep in
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Rules that are too permissive â†’ violations pass, rules meaningless
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not updating rules when architecture changes â†’ rules out of sync with actual architecture
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Only negative rules (what NOT to do) â†’ no positive guidance on intended structure
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Static analysis, Architectural principles
Related: ADRs (human decisions + automated enforcement), Dependency analysis, CI architecture checks
...
When assisting with architecture decisions related to Architecture fitness functions via static analysis:
