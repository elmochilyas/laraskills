...
Modular monolith starts as a single deployment unit but with clear module boundaries (like microservices without distribution). Each module has its own domain, database schema (separate tables, not separate databases), and communication via well-defined interfaces. This architecture is the recommended starting point for most applications â€” it provides microservices-like modularity without distributed system complexity. When the monolith's constraints become binding, individual modules can be extracted into services.

---

# Core Concepts
This knowledge unit addresses key concerns related to Modular monolith as starting architecture in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Shared database tables across modules â†’ coupling at data level
...
- **Description**: Modules calling each other's Eloquent models directly â†’ bypasses interface
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Shared kernel growing too large â†’ modules tightly coupled through shared code
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No interface between modules â†’ cannot extract module without rewrite
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Premature module separation â†’ wrong boundaries, frequent refactoring
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Modules not independently testable â†’ module tests depend on other modules
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Related: Service decomposition, Microservices decomposition threshold, Domain modules
...
When assisting with architecture decisions related to Modular monolith as starting architecture:
