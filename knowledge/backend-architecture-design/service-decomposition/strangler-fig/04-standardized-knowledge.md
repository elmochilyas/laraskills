...
Strangler Fig pattern incrementally replaces legacy functionality with new services by routing specific features to new implementations while the rest continue on the legacy system. Over time, the legacy system is "strangled" â€” replaced piece by piece until nothing remains. The pattern enables risk-free migration: each replacement is independently testable, rollbackable, and deliverable. In Laravel, this pattern applies to extracting modules from monoliths or replacing legacy PHP systems.

---

# Core Concepts
This knowledge unit addresses key concerns related to Strangler fig pattern for incremental decomposition in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Strangling too many features at once â†’ massive parallel work, coordination overhead
...
- **Description**: No feature flag for rollback â†’ new service fails, cannot quickly revert
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Extracting tightly coupled features â†’ need to rewrite more than expected
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not strangling the full feature â†’ legacy code remains for edge cases
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Strangling without interface â†’ new service contract doesn't match legacy
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Wrong extraction order â†’ extracting low-value features first delays ROI
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No performance comparison â†’ new service slower than legacy, undetected
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Bounded contexts, Service decomposition
Related: Big Ball of Mud (strangling big ball of mud), Service extraction patterns, Decomposition strategies
...
When assisting with architecture decisions related to Strangler fig pattern for incremental decomposition:
