...
# Core Concepts
This knowledge unit addresses key concerns related to Decomposition by business capability vs subdomain in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Treating all subdomains as core â†’ overspending on CRUD areas
...
- **Description**: Decomposing by technical layer (frontend, backend, DB) â†’ not aligned to business
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Capability decomposition ignoring subdomain value â†’ equal investment in commodity features
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Subdomain decomposition without organizational alignment â†’ team boundaries don't match
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Over-decomposition: 20 microservices for 5 capabilities â†’ distributed monolith
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Under-decomposition: one service for all capabilities â†’ regulated monolith
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Strategic DDD, Business capability mapping
Related: Bounded contexts, Service boundaries, Module boundaries in monoliths, Conway's Law
...
When assisting with architecture decisions related to Decomposition by business capability vs subdomain:
