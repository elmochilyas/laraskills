...
# Core Concepts
This knowledge unit addresses key concerns related to Service boundaries in distributed systems in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Shared database â†’ tightly coupled at data level, cannot deploy independently
...
- **Description**: Synchronous call chains â†’ Aâ†’Bâ†’Câ†’D latency and coupling
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Transactional operations across services â†’ distributed transaction complexity
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Shared code library with business logic â†’ coupled through shared library
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Service too fine-grained â†’ overhead of inter-service communication
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Service too coarse-grained â†’ team coordination, deployment conflicts
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No anti-corruption layer at service boundaries â†’ external concepts pollute internal model
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Bounded contexts, Aggregate design
Related: Data ownership, Transactional boundaries, Distributed monolith anti-pattern, Strangler fig pattern
...
When assisting with architecture decisions related to Service boundaries in distributed systems:
