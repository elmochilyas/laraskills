...
# Core Concepts
This knowledge unit addresses key concerns related to Aggregate boundaries as decomposition units in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Giant aggregates with many entities â†’ performance issues, transaction conflicts
...
- **Description**: Tiny aggregates with one field â†’ unnecessary fragmentation
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Cross-aggregate transactions â†’ distributed transaction complexity
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Aggregate referencing other aggregates by object â†’ coupling, loading overhead
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Ignoring aggregates in service decomposition â†’ services split by technical concerns
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: DDD tactical aggregates, Transaction boundaries
Related: Bounded contexts, Service boundaries, Transactional boundaries, Eventual consistency
...
When assisting with architecture decisions related to Aggregate boundaries as decomposition units:
