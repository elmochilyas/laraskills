...
# Core Concepts
This knowledge unit addresses key concerns related to ADR formats (Nygard, MADR, Y-Statement) in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Creating ADRs as afterthought â†’ decisions alrady made, ADR is post-hoc rationalization
...
- **Description**: No supersession management â†’ old ADRs linger as active, confusion about current decisions
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Too many ADRs for trivial decisions â†’ ADR fatigue, team stops using them
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Too few ADRs for significant decisions â†’ decisions undocumented, rationale lost
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: ADRs not reviewed â†’ stale decisions no longer apply
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: ADRs in separate system â†’ hidden from developers during coding
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No ADR template â†’ inconsistent quality, missing sections
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Related: Architecture fitness functions (complement ADRs with automated checks), C4 modeling, Architectural reviews
...
When assisting with architecture decisions related to ADR formats (Nygard, MADR, Y-Statement):
