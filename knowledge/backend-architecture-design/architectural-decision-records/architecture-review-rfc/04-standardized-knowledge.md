...
# Core Concepts
This knowledge unit addresses key concerns related to Architecture review and RFC processes in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: RFPs are too long â†’ nobody reads them, process becomes bottleneck
...
- **Description**: No review period deadline â†’ RFCs stall indefinitely
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Decisions by seniority, not merit â†’ best argument loses to highest title
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: RFC after implementation â†’ "retroactive" RFC defeats purpose
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No lightweight option â†’ even small decisions require full RFC
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: RFCs not searchable â†’ previous decisions unknown, repeated discussions
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No retrospective â†’ same mistakes repeated for next big decision
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: ADR formats, Team collaboration
Related: ADR (RFC output format), Architecture governance, Decision-making frameworks
...
When assisting with architecture decisions related to Architecture review and RFC processes:
