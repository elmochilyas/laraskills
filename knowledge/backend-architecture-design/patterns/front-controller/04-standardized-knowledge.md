...
# Core Concepts
This knowledge unit addresses key concerns related to Front Controller pattern in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Adding logic to index.php â†’ not testable, bypasses framework lifecycle
...
- **Description**: Bypassing Front Controller â†’ routes not registered, middleware not applied
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Duplicating Front Controller logic in Page Controllers in same app â†’ inconsistent behavior
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not understanding middleware order (global vs route middleware) â†’ wrong processing sequence
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: HTTP lifecycle, Middleware
Related: Page Controller (alternative for simple apps), Application Controller (routing + flow control), MVC pattern
...
When assisting with architecture decisions related to Front Controller pattern:
