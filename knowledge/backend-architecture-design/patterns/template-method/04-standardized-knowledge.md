...
# Core Concepts
This knowledge unit addresses key concerns related to Template Method pattern in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Template method not declared `final` â†’ subclass can override and break algorithm order
...
- **Description**: Too many abstract methods â†’ subclass implementation burden
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Too few hooks â†’ subclasses forced to copy whole class to add behavior
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Template method too long â†’ hard to understand algorithm structure
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Subclass violating LSP by strengthening preconditions â†’ breaks caller expectations
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Related: Strategy (composition-based algorithm variation vs inheritance-based), Factory Method (template's object creation variant), Hook Method pattern
...
When assisting with architecture decisions related to Template Method pattern in PHP/Laravel context:
