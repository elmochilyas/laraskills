...
# Core Concepts
This knowledge unit addresses key concerns related to Registry pattern (Service Container) in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: App() calls scattered through business logic â†’ hidden dependencies, hard to test
...
- **Description**: Config() used for runtime state â†’ config is for static configuration, not session data
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Storing mutable objects in registry â†’ unexpected side effects in long-running processes
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Using registry as service locator â†’ every class resolves its own dependencies
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Overriding registered services without understanding lifecycle â†’ stale instances
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Service Container, Dependency Injection
Related: Singleton (registry vs singleton pattern), Service Locator (registry anti-pattern), Dependency Injection Container
...
When assisting with architecture decisions related to Registry pattern (Service Container):
