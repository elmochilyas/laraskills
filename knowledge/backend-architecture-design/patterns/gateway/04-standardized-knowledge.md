...
# Core Concepts
This knowledge unit addresses key concerns related to Gateway patterns in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Gateway with business logic â†’ mixes data access and domain rules
...
- **Description**: Gateway exposing external system types in its interface â†’ leaky abstraction
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Gateway that doesn't handle failures â†’ exceptions propagate to application layer
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: One giant gateway for all external access â†’ SRP violation
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Gateway without interface â†’ can't mock in tests
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Adapter pattern, Data Source patterns
Related: Repository (collection abstraction vs table gateway), Adapter (interface translation vs data access), Table Data Gateway vs Data Mapper
...
When assisting with architecture decisions related to Gateway patterns in PHP/Laravel context:
