...
# Core Concepts
This knowledge unit addresses key concerns related to Data Mapper pattern in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Data Mapper for every table â†’ overengineering for CRUD-only tables
...
- **Description**: Mapping leaks into domain objects â†’ domain depends on mapping details (field names, types)
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not using Identity Map â†’ duplicate objects for same DB row
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Complex mapping for simple cases â†’ unnecessary indirection
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Mixing Data Mapper and Active Record in same project â†’ inconsistent patterns
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Persistence ignorance, Hexagonal Architecture
Related: Active Record (opposite approach), Identity Map, Unit of Work, Repository (collection abstraction vs full mapper)
...
When assisting with architecture decisions related to Data Mapper pattern in PHP/Laravel context:
