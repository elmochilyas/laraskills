...
# Core Concepts
This knowledge unit addresses key concerns related to Facade pattern in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Confusing Laravel Facades with GoF Facade â€” they solve different problems
...
- **Description**: Facade that exposes all subsystem methods â†’ no simplification, just delegation
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Multiple facades for same subsystem â†’ inconsistent access patterns
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Facade with mutable state â†’ side effect unpredictability
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Over-facading: facade for every class â†’ unnecessary indirection
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Dependency injection, Service layer
Related: Adapter (makes interface compatible vs simpler), Mediator (coordinates communication vs simplifies access), Service Layer (application boundary facade)
...
When assisting with architecture decisions related to Facade pattern in PHP/Laravel context:
