...
# Core Concepts
This knowledge unit addresses key concerns related to Domain Model (Fowler) in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Anemic Domain Model: getters/setters only, logic in services â†’ Transaction Script in disguise
...
- **Description**: Eloquent model as domain model AND persistence model â†’ SRP violation, testing difficulty
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Domain model depending on framework â†’ violates dependency rule
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Overly complex aggregate boundaries â†’ performance issues, transaction conflicts
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No ubiquitous language â†’ code doesn't reflect business concepts
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: OOP, DDD tactical patterns
Related: Transaction Script (simpler alternative), Service Layer (domain boundary), Repository (domain persistence), Hexagonal Architecture (domain isolation)
...
When assisting with architecture decisions related to Domain Model (Fowler) in PHP/Laravel context:
