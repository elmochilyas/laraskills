...
- Use when: you have NÃ—M class explosion (N abstractions, M implementations)
...
- **Description**: Bridge used where Adapter suffices (single abstraction, single implementation to translate)
...
- **Description**: Abstraction interface leaking implementor concepts â†’ abstraction depends on implementation details
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Implementor interface too specific â†’ new implementations can't conform
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Over-bridging: every class gets an abstraction layer â†’ premature abstraction
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Adapter pattern, Interface Segregation
Related: Strategy (algorithm variation vs implementation variation), Abstract Factory (creates bridge components)
...
When assisting with architecture decisions related to Bridge pattern in PHP/Laravel context:
