...
# Core Concepts
This knowledge unit addresses key concerns related to Strategy pattern in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Strategy interface too specific â†’ new algorithms can't conform
...
- **Description**: Strategy methods with side effects â†’ same algorithm different results
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Strategy selection logic spread across codebase â†’ hard to change selection criteria
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Strategies duplicating common logic â†’ extract base class (but prefer composition)
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not testing strategies in combination with context â†’ strategy works alone but fails in context
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Interface segregation, Polymorphism
Related: State (state-dependent behavior vs algorithm selection), Template Method (algorithm skeleton vs interchangeable parts), Factory (creates strategy objects)
...
When assisting with architecture decisions related to Strategy pattern in PHP/Laravel context:
