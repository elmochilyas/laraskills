...
# Core Concepts
This knowledge unit addresses key concerns related to Builder pattern in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Builder that allows invalid object states â†’ `build()` must guard at construction time
...
- **Description**: Builder with too many responsibilities â†’ separate builders per product type
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not providing defaults â†’ caller must set every parameter even when reasonable defaults exist
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Mutable builder reused after `build()` â€” mutations affect already-built object
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Builder creating objects with inconsistent state (e.g., service URL without API key)
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: PHP 8 named arguments, Constructor promotion
Related: Factory (simple creation vs complex), Prototype (cloning vs building), DTO construction patterns
...
When assisting with architecture decisions related to Builder pattern in PHP/Laravel context:
