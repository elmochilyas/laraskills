...
# Core Concepts
This knowledge unit addresses key concerns related to Chain of Responsibility pattern in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Handler modifying the passable object in unexpected ways â†’ subsequent handlers see modified state
...
- **Description**: Handler return type inconsistency â†’ pipe returns response vs modified passable
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Forgetting to call `$next($passable)` â†’ chain silently terminates
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Heavy logic in frequently-skipped handler â†’ pay cost of early rejection anyway
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Handler depending on previous handler's side effects â†’ implicit coupling
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Callables, closures
Related: Decorator (adds behavior vs passes request), Command (encapsulates request vs chains handlers), Middleware pattern
...
When assisting with architecture decisions related to Chain of Responsibility pattern in PHP/Laravel context:
