...
# Core Concepts
This knowledge unit addresses key concerns related to Identity Map pattern in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Assuming identity map covers all queries â†’ where() queries return new instances
...
- **Description**: Not refreshing model after external DB change â†’ stale data served
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Identity map prevents read-after-write consistency within same request
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Cloned model references same identity â†’ clone vs identity confusion
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Octane: identity map growth â†’ memory leak
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Object identity, ORM basics
Related: Unit of Work (uses identity map for change tracking), Repository (may maintain identity map), Lazy Load (identity map used in proxy hydration)
...
When assisting with architecture decisions related to Identity Map pattern in PHP/Laravel context:
