...
# Core Concepts
This knowledge unit addresses key concerns related to Repository (Fowler) in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Repository that mirrors Eloquent methods exactly â†’ no abstraction benefit, just wrapping
...
- **Description**: Repository returning Eloquent models â†’ domain layer still coupled to Eloquent
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Generic repository interface (IRepository<T>) â†’ PHP generics limitations, overly generic
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Repository for every model â†’ unnecessary abstraction for every table
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Repository methods that return different types conditionally â†’ unpredictable
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Dependency Inversion Principle, Interface segregation
Related: Data Mapper (full ORM mapping vs collection abstraction), Unit of Work (transaction tracking), Domain Model (what repository returns)
...
When assisting with architecture decisions related to Repository (Fowler) in PHP/Laravel context:
