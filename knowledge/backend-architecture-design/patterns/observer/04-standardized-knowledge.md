...
# Core Concepts
This knowledge unit addresses key concerns related to Observer pattern in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Synchronous listener doing heavy I/O â†’ blocks response time
...
- **Description**: Listener modifying the same data the event originated from â†’ conflicts, circular events
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not handling listener exceptions â†’ unhandled exception crashes the request
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Too many events/liteners â†’ application becomes hard to reason about
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Event payload containing entire objects â†’ serialization issues, coupling
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Event-driven architecture basics
Related: Mediator (centralized control vs distributed notification), Domain Events (domain concept vs infrastructure), Pub/Sub (message broker vs in-process)
...
When assisting with architecture decisions related to Observer pattern in PHP/Laravel context:
