...
# Core Concepts
This knowledge unit addresses key concerns related to Record Set pattern (Laravel Collection) in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Loading entire dataset into Collection when DB could filter â†’ memory bloat
...
- **Description**: Method chain too long with side effects â†’ hard to debug
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Using Collection where LazyCollection is appropriate â†’ memory issues
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not understanding immutability â†’ expecting chain to modify original
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Assuming Collection operations are as optimized as DB â†’ performance surprises
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: PHP arrays, array functions
Related: LazyCollection (streaming vs eager), Eloquent Collections, Higher-order messages, Collection macros
...
When assisting with architecture decisions related to Record Set pattern (Laravel Collection):
