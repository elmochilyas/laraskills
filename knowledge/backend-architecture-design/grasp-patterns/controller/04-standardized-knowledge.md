...
# Core Concepts
This knowledge unit addresses key concerns related to GRASP: Creator, Controller, Low Coupling, High Cohesion in the context of backend architecture and design for PHP/Laravel applications.
...
Prerequisites: OOP, Class design
Related: SRP (high cohesion), Information Expert (creator decisions), Hexagonal Architecture (low coupling at scale)
...
When assisting with architecture decisions related to GRASP: Creator, Controller, Low Coupling, High Cohesion:
