...
# Core Concepts
This knowledge unit addresses key concerns related to GRASP: High Cohesion in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Utils/Helpers classes â†’ coincidental cohesion
...
- **Description**: God classes with unrelated methods â†’ zero cohesion
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Too many small classes (over-splitting) â†’ high cohesion but navigation overhead
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Sacrificing cohesion for reusability â†’ class does too much to "be reusable"
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Class named "Manager" â€” usually low cohesion
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: SRP, Class design
Related: Low Coupling (balance), God class (low cohesion), Modular design, Functional cohesion
...
When assisting with architecture decisions related to GRASP: High Cohesion:
