...
# Core Concepts
This knowledge unit addresses key concerns related to GRASP: Polymorphism, Pure Fabrication, Indirection, Protected Variations in the context of backend architecture and design for PHP/Laravel applications.
...
Related: Strategy (Polymorphism), Repository (Pure Fabrication), Adapter (Indirection), Anti-Corruption Layer (Protected Variations)
...
When assisting with architecture decisions related to GRASP: Polymorphism, Pure Fabrication, Indirection, Protected Variations:
