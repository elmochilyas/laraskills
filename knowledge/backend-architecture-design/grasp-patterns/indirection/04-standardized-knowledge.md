...
# Core Concepts
This knowledge unit addresses key concerns related to GRASP: Indirection in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Unnecessary indirection: adding layers where no decoupling benefit â†’ complexity without value
...
- **Description**: Leaky indirection: intermediate object exposes underlying component's types â†’ defeats purpose
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Indirection hidden from developer â†’ "magic" behavior, hard to trace
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Over-indirection: 5 layers of abstraction for simple operation â†’ performance + navigation cost
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not using indirection at natural boundaries â†’ high coupling, hard to change
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Low Coupling, Facade pattern
Related: Pure Fabrication (indirection mechanisms are often Pure Fabrications), Mediator pattern, Event-driven architecture
...
When assisting with architecture decisions related to GRASP: Indirection:
