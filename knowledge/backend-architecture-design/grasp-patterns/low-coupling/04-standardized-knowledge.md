...
# Core Concepts
This knowledge unit addresses key concerns related to GRASP: Low Coupling in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Unnecessary coupling: directly calling distant class methods â†’ use events or mediator
...
- **Description**: Coupling through shared state: static properties, facades â†’ inject dependencies explicitly
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Coupling at wrong level: domain coupled to framework â†’ violates dependency rule
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Over-decoupling: every class behind interface â†’ unnecessary indirection
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Ignoring coupling direction: high-level depending on low-level â†’ violates DIP
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Coupling types
Related: High Cohesion (balance with low coupling), DIP, DI, Event-driven decoupling
...
When assisting with architecture decisions related to GRASP: Low Coupling:
