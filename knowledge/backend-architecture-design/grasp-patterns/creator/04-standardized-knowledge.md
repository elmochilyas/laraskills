...
Creator assigns responsibility for creating instances of class A to class B that contains, composites, records, closely uses, or has the data to initialize A. In Laravel, Creator guides where object creation belongs â€” aggregate roots create their children, factories create complex objects, and repositories create domain objects. Correct Creator assignments prevent creation logic from scattering across unrelated classes.

---

# Core Concepts
This knowledge unit addresses key concerns related to GRASP: Creator in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Creating objects in unrelated classes â†’ creation logic scattered, hard to change
...
- **Description**: Using Creator for every object â†’ some creations belong in Factories (Pure Fabrication)
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Controller creating domain objects â†’ controller shouldn't know domain construction details
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not considering aggregate roots as creators â†’ aggregate should create its children
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Information Expert, Object creation
Related: Factory (Pure Fabrication alternative), Aggregate root (natural creator), Repository (creates domain objects)
...
When assisting with architecture decisions related to GRASP: Creator:
