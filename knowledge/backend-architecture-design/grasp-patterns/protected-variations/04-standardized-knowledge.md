...
# Core Concepts
This knowledge unit addresses key concerns related to GRASP: Protected Variations in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Over-protecting: wrapping everything in interfaces "just in case" â†’ YAGNI
...
- **Description**: Under-protecting: not wrapping external dependencies â†’ vendor lock-in, untestable
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Wrong variation point: protecting stable elements, ignoring volatile ones
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Leaky protection: interface exposes variation point concepts â†’ no real protection
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Protection without abstraction: using if/else instead of polymorphism â†’ no real protection
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: OCP, Variation identification
Related: Anti-Corruption Layer (system-level protection), Adapter pattern (interface protection), Strategy pattern (algorithm variation)
...
When assisting with architecture decisions related to GRASP: Protected Variations:
