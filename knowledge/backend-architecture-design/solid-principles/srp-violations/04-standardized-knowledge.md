...
# Core Concepts
This knowledge unit addresses key concerns related to SOLID principles in PHP: SRP violations in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Over-splitting: 100 tiny classes for 10 responsibilities â†’ navigation nightmare
...
- **Description**: Extracting responsibility but keeping coupling â†’ extracted class still depends on model
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Trait-based separation that hides dependencies â†’ trait uses model methods implicitly
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Abandoning SRP entirely because "Laravel doesn't enforce it"
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Cohesion, Class design
Related: God class anti-pattern, Action Domain pattern, Service Layer (organizes responsibilities)
...
When assisting with architecture decisions related to SOLID principles in PHP: SRP violations:
