...
# Core Concepts
This knowledge unit addresses key concerns related to SOLID principles in PHP: OCP violations in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Premature OCP: creating strategy interfaces for single implementation â†’ YAGNI
...
- **Description**: Over-engineering: interface per class + factory + registry for what could be enum match
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Open but not closed: strategy interface changes when new variant added â†’ violates OCP
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Leaky strategy selection: selection logic duplicates across codebase
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Polymorphism, Strategy pattern
Related: SRP (OCP enabled by SRP), Strategy pattern (primary OCP tool), Pipeline pattern, Events for extension
...
When assisting with architecture decisions related to SOLID principles in PHP: OCP violations:
