...
# Core Concepts
This knowledge unit addresses key concerns related to SOLID principles in PHP: LSP violations in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Inheriting for code reuse without checking substitutability â†’ "I want those methods"
...
- **Description**: Overriding method with covariant return type but weaker postcondition
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Adding validation in child that base didn't have â†’ strengthens precondition
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Silent no-op: child method does nothing while base documents specific behavior
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Collection inheritance: subclassing Eloquent Collection can violate LSP
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Inheritance, Polymorphism, Design by Contract
Related: Composition over Inheritance, Interface Segregation (reduce LSP surface), PHP type system (covariance/contravariance)
...
When assisting with architecture decisions related to SOLID principles in PHP: LSP violations:
