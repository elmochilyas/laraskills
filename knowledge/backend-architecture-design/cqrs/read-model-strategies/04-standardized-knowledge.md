...
# Core Concepts
This knowledge unit addresses key concerns related to Read model strategies (denormalized tables, materialized views, in-memory) in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Denormalizing when in-memory transformation suffices â†’ data duplication management
...
- **Description**: Event-sourced projections for simple dashboards â†’ overengineering
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No read model at all â†’ write-optimized schema for complex reads â†’ slow queries
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Stale read model without refresh mechanism â†’ users see outdated data
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Cached read model without invalidation â†’ stale data persists
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: CQRS, Database design
Related: Event sourcing projections, Cache strategies, Eloquent API Resources
...
When assisting with architecture decisions related to Read model strategies (denormalized tables, materialized views, in-memory):
