...
# Core Concepts
This knowledge unit addresses key concerns related to Query handler patterns in PHP/Laravel context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Query handler modifying state â†’ violates CQRS
...
- **Description**: Query returning entities instead of DTOs â†’ couples read models to ORM
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Query handler in same class as command handler â†’ mixes concerns
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Over-separating: query handler per field combination â†’ class explosion
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not optimizing for read patterns â†’ query handler uses write-optimized models
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: CQRS basics, DTO patterns
Related: Read model strategies, Repository pattern, Caching strategies
...
When assisting with architecture decisions related to Query handler patterns in PHP/Laravel context:
