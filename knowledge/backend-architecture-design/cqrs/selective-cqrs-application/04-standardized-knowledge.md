...
# Core Concepts
This knowledge unit addresses key concerns related to When to apply CQRS selectively per bounded context in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: System-wide CQRS Level 3 â†’ massive overengineering for simple contexts
...
- **Description**: No CQRS anywhere â†’ missing optimization opportunities
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Mixed levels without clear boundaries â†’ confusion about which level applies
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Starting at Level 3 â†’ unable to reduce complexity later
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Bounded contexts, CQRS maturity levels
Related: Domain-Driven Design bounded contexts, Event sourcing selection criteria
...
When assisting with architecture decisions related to When to apply CQRS selectively per bounded context:
