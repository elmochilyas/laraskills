...
# Core Concepts
This knowledge unit addresses key concerns related to Choreography vs orchestration in event-driven systems in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Choreography with circular event dependencies â†’ event storms
...
- **Description**: Orchestration for simple 2-step flows â†’ unnecessary overhead
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No saga recovery in orchestration â†’ coordinator crash loses workflow state
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Mixing both inconsistently â†’ hard to understand coordination model
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Assuming choreography is "free" â†’ implicit workflows are hard to maintain
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Event-driven architecture, Distributed systems
Related: Saga pattern (orchestration implementation), Event storming (design choreography), Distributed tracing
...
When assisting with architecture decisions related to Choreography vs orchestration in event-driven systems:
