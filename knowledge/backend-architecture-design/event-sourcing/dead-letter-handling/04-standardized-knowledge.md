...
# Core Concepts
This knowledge unit addresses key concerns related to Dead letter handling for failed projections in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: No retry limit â†’ infinite retries on permanent failure â†’ resource exhaustion
...
- **Description**: No DLQ â†’ failed events silently dropped â†’ projection gets out of sync
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No alerting on DLQ growth â†’ projection divergence undetected
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Replaying events without idempotency â†’ duplicate side effects
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Same retry strategy for all failure types â†’ transient vs permanent handled identically
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Deleting dead letters instead of investigating â†’ root cause never fixed
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Event sourcing projections, Message queuing
Related: Outbox pattern, Retry strategies, Idempotent consumers, Projection rebuild
...
When assisting with architecture decisions related to Dead letter handling for failed projections:
