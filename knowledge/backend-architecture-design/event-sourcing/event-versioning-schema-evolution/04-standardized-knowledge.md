...
# Core Concepts
This knowledge unit addresses key concerns related to Event versioning and schema evolution in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: No versioning strategy from day 1 â†’ cannot evolve events after production
...
- **Description**: Removing fields instead of deprecating â†’ immediate consumer breakage
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Renaming fields â†’ consumers looking for old name get null
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Changing field types â†’ type errors in consumers
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Upcasting in projection instead of in event store read â†’ upcasters scattered everywhere
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Events in shared namespace with no version â†’ can't distinguish old from new
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Event sourcing, Schema design
Related: Upcaster pattern, Projection rebuild, Consumer-driven contracts
...
When assisting with architecture decisions related to Event versioning and schema evolution:
