...
# Core Concepts
This knowledge unit addresses key concerns related to Outbox pattern for reliable event publishing in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: No idempotency in consumers â†’ duplicate events cause duplicate side effects
...
- **Description**: Publishing within business transaction â†’ blocks transaction for broker latency
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No monitoring of outbox table â†’ dead letters accumulate unnoticed
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Clearing outbox without verifying broker delivery â†’ events lost
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Outbox in separate transaction â†’ loses atomicity guarantee
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Polling interval too long â†’ high latency between event creation and publication
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Transactions, Event publishing
Related: Dual-write problem, Idempotent consumers, Transactional outbox, Saga pattern
...
When assisting with architecture decisions related to Outbox pattern for reliable event publishing:
