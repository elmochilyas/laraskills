...
# Core Concepts
This knowledge unit addresses key concerns related to Context mapping relationship patterns (Partnership, Shared Kernel, etc.) in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Shared Kernel grows too large â†’ model pollution across contexts
...
- **Description**: Partnership without regular meetings â†’ context drift
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Conformist when Anti-Corruption Layer is needed â†’ vendor lock-in risk
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Separate Ways when integration is needed â†’ duplicate data, inconsistent state
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No explicit context mapping â†’ relationships emerge chaotically
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Anti-Corruption Layer everywhere â†’ unnecessary translation overhead for aligned contexts
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Bounded contexts, Strategic DDD
Related: Anti-corruption layer, Open-Host Service pattern, Conway's Law
...
When assisting with architecture decisions related to Context mapping relationship patterns (Partnership, Shared Kernel, etc.):
