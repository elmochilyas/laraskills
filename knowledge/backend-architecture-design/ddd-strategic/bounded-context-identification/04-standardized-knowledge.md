...
# Core Concepts
This knowledge unit addresses key concerns related to Bounded context identification heuristics in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: One bounded context per database table â†’ too fine-grained
...
- **Description**: One bounded context for entire application â†’ missing boundaries (big ball of mud)
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Bounded contexts aligned with technical layers (controllers, services) â†’ wrong boundaries
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Ignoring organizational boundaries â†’ team conflicts over model changes
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not documenting context maps â†’ boundaries are implicit, not explicit
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Bounded contexts too late â†’ extracted after model pollution already occurred
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Related: Context mapping, Subdomain types, Event Storming, Service decomposition
...
When assisting with architecture decisions related to Bounded context identification heuristics:
