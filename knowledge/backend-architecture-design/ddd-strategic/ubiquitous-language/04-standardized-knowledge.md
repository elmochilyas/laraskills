...
# Core Concepts
This knowledge unit addresses key concerns related to Ubiquitous language maintenance practices in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Ubiquitous language only in documentation, not in code â†’ code has technical names
...
- **Description**: Imposing language from top-down without domain expert input â†’ artificial language
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Ignoring language drift â†’ model and code diverge over time
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Not updating glossary when language changes â†’ glossary becomes outdated
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: One ubiquitous language for entire system â†’ multiple bounded contexts have different languages
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Developers alone define language â†’ domain concepts misrepresented
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Prerequisites: Strategic DDD, Domain modeling
Related: Bounded contexts (language per context), Event Storming (language discovery), Domain Model pattern
...
When assisting with architecture decisions related to Ubiquitous language maintenance practices:
