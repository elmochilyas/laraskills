...
# Core Concepts
This knowledge unit addresses key concerns related to Layered architecture comparative analysis in the context of backend architecture and design for PHP/Laravel applications.
...
- **Description**: Believing layered architecture prevents coupling (it requires discipline, not enforcement)
...
- **Description**: Not enforcing layer dependencies (no static analysis for layer violations)
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Layer skipping as "shortcut" â†’ shortcuts become permanent patterns
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: No domain layer: services are Transaction Scripts, no business object model
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit

- **Description**: Infrastructure in every layer: Eloquent models used throughout all layers
- **Cause**: Lack of awareness or discipline in applying the pattern correctly
- **Consequence**: Reduced code quality, maintainability issues, or system fragility
- **Better**: Follow established patterns and practices documented in this knowledge unit
...
Related: Hexagonal (strict boundary alternative), Vertical Slice (cross-cutting alternative), Layer enforcement via static analysis
...
When assisting with architecture decisions related to Layered architecture comparative analysis:
