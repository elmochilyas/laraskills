# ECC Anti-Patterns -- Architecture tests to enforce layer boundaries
...
2. Architecture test abandonment
...
## Anti-Pattern 1: False sense of security

### Category
Design / Architecture

### Description
False sense of security. This pattern violates best practices and introduces technical debt that compounds over time.
...
- LAP-13/07-decision-trees.md

## Anti-Pattern 2: Architecture test abandonment

### Category
Design / Architecture

### Description
Architecture test abandonment. This pattern violates best practices and introduces technical debt that compounds over time.
