# ECC Anti-Patterns -- Framework independence of domain layer in practice
...
1. Independent domain, coupled tests
2. Framework-as-core
...
## Anti-Pattern 1: Independent domain, coupled tests

### Category
Design / Architecture

### Description
Independent domain, coupled tests. This pattern violates best practices and introduces technical debt that compounds over time.
...
- LAP-09/07-decision-trees.md

## Anti-Pattern 2: Framework-as-core

### Category
Design / Architecture

### Description
Framework-as-core. This pattern violates best practices and introduces technical debt that compounds over time.
