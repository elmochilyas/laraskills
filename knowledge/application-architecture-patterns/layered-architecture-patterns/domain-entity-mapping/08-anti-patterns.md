# ECC Anti-Patterns -- Mapping between domain entities and Eloquent models
...
1. Skipping mapping entirely
2. Mapper as anemic service
...
## Anti-Pattern 1: Skipping mapping entirely

### Category
Design / Architecture

### Description
Skipping mapping entirely. This pattern violates best practices and introduces technical debt that compounds over time.
...
- LAP-10/07-decision-trees.md

## Anti-Pattern 2: Mapper as anemic service

### Category
Design / Architecture

### Description
Mapper as anemic service. This pattern violates best practices and introduces technical debt that compounds over time.
