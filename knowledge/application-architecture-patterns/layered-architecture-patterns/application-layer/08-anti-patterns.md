# ECC Anti-Patterns -- Application layer: use cases, DTOs, application services
...
## Anti-Pattern 1: Fat use case

### Category
Design / Architecture

### Description
Fat use case. This pattern violates best practices and introduces technical debt that compounds over time.
...
- LAP-06/07-decision-trees.md

## Anti-Pattern 2: Use case calling use case

### Category
Design / Architecture

### Description
Use case calling use case. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: DTO as God object

### Category
Design / Architecture

### Description
DTO as God object. This pattern violates best practices and introduces technical debt that compounds over time.
