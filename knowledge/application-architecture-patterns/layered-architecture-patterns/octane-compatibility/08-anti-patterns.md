# ECC Anti-Patterns -- Octane compatibility considerations for layered architecture
...
## Anti-Pattern 1: User data leak

### Category
Design / Architecture

### Description
User data leak. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Singleton-as-default

### Category
Design / Architecture

### Description
Singleton-as-default. This pattern violates best practices and introduces technical debt that compounds over time.
