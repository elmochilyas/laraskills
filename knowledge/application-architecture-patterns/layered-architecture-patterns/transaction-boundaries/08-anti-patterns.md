# ECC Anti-Patterns -- Transaction boundaries in layered architecture
...
2. Transaction-per-method in repositories
...
## Anti-Pattern 1: Distributed transaction simulation

### Category
Design / Architecture

### Description
Distributed transaction simulation. This pattern violates best practices and introduces technical debt that compounds over time.
...
- LAP-11/07-decision-trees.md

## Anti-Pattern 2: Transaction-per-method in repositories

### Category
Design / Architecture

### Description
Transaction-per-method in repositories. This pattern violates best practices and introduces technical debt that compounds over time.
