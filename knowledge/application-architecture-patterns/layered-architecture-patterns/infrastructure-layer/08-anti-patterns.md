# ECC Anti-Patterns -- Infrastructure layer: Eloquent implementations, external adapters
...
1. Infrastructure coupling spread
2. Anemic Infrastructure
...
## Anti-Pattern 1: Infrastructure coupling spread

### Category
Design / Architecture

### Description
Infrastructure coupling spread. This pattern violates best practices and introduces technical debt that compounds over time.
...
- LAP-07/07-decision-trees.md

## Anti-Pattern 2: Anemic Infrastructure

### Category
Design / Architecture

### Description
Anemic Infrastructure. This pattern violates best practices and introduces technical debt that compounds over time.
