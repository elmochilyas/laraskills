# ECC Anti-Patterns -- Presentation layer: controllers, requests, resources, routes
...
### Description
Fat Controller. This pattern violates best practices and introduces technical debt that compounds over time.
...
- LAP-08/07-decision-trees.md

## Anti-Pattern 2: Inline validation

### Category
Design / Architecture

### Description
Inline validation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Model exposure

### Category
Design / Architecture

### Description
Model exposure. This pattern violates best practices and introduces technical debt that compounds over time.
