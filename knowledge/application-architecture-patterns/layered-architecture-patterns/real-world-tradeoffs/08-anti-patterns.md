# ECC Anti-Patterns -- Real-world tradeoffs: when Clean Architecture pays off
...
### Description
Premature architecture. This pattern violates best practices and introduces technical debt that compounds over time.
...
- LAP-14/07-decision-trees.md

## Anti-Pattern 2: Architecture fashion

### Category
Design / Architecture

### Description
Architecture fashion. This pattern violates best practices and introduces technical debt that compounds over time.
