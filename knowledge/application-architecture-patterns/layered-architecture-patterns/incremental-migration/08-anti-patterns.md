# ECC Anti-Patterns -- Incremental migration from MVC to layered architecture
...
1. Architecture lip service
2. Boy Scout rule violation
...
## Anti-Pattern 1: Architecture lip service

### Category
Design / Architecture

### Description
Architecture lip service. This pattern violates best practices and introduces technical debt that compounds over time.
...
- LAP-12/07-decision-trees.md

## Anti-Pattern 2: Boy Scout rule violation

### Category
Design / Architecture

### Description
Boy Scout rule violation. This pattern violates best practices and introduces technical debt that compounds over time.
