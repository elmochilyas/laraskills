# ECC Anti-Patterns -- Outbox pattern for reliable event delivery
...
1. No transactional guarantee
2. Separate transaction outbox
...
## Anti-Pattern 1: No transactional guarantee

### Category
Design / Architecture

### Description
No transactional guarantee. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-10/07-decision-trees.md

## Anti-Pattern 2: Separate transaction outbox

### Category
Design / Architecture

### Description
Separate transaction outbox. This pattern violates best practices and introduces technical debt that compounds over time.
