# ECC Anti-Patterns -- Facade pattern risks at context boundaries
...
1. God facade context
2. Facade-only access
...
## Anti-Pattern 1: God facade context

### Category
Design / Architecture

### Description
God facade context. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-12/07-decision-trees.md

## Anti-Pattern 2: Facade-only access

### Category
Design / Architecture

### Description
Facade-only access. This pattern violates best practices and introduces technical debt that compounds over time.
