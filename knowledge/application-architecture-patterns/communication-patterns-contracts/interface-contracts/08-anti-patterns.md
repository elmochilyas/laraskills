# ECC Anti-Patterns -- Formalized contracts between contexts
...
1. Silent contract violation
2. Contract pollution
...
## Anti-Pattern 1: Silent contract violation

### Category
Design / Architecture

### Description
Silent contract violation. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-01/07-decision-trees.md

## Anti-Pattern 2: Contract pollution

### Category
Design / Architecture

### Description
Contract pollution. This pattern violates best practices and introduces technical debt that compounds over time.
