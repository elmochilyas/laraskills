# ECC Anti-Patterns -- Event design patterns
...
## Anti-Pattern 1: Thin-event mania

### Category
Design / Architecture

### Description
Thin-event mania. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-04/07-decision-trees.md

## Anti-Pattern 2: Event version chaos

### Category
Design / Architecture

### Description
Event version chaos. This pattern violates best practices and introduces technical debt that compounds over time.
