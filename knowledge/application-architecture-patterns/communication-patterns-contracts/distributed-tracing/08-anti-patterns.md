# ECC Anti-Patterns -- Distributed tracing across contexts
...
## Anti-Pattern 1: Broken chain

### Category
Design / Architecture

### Description
Broken chain. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-11/07-decision-trees.md

## Anti-Pattern 2: No trace at all

### Category
Design / Architecture

### Description
No trace at all. This pattern violates best practices and introduces technical debt that compounds over time.
