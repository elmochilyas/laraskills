# ECC Anti-Patterns -- Circuit breaker pattern
...
## Anti-Pattern 1: No protection

### Category
Design / Architecture

### Description
No protection. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-06/07-decision-trees.md

## Anti-Pattern 2: Permanent open

### Category
Design / Architecture

### Description
Permanent open. This pattern violates best practices and introduces technical debt that compounds over time.
