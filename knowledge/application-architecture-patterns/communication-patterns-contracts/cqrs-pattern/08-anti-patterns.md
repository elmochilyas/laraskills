# ECC Anti-Patterns -- CQRS pattern
...
## Anti-Pattern 1: CQRS-for-CRUD

### Category
Design / Architecture

### Description
CQRS-for-CRUD. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-08/07-decision-trees.md

## Anti-Pattern 2: Leaky queries

### Category
Design / Architecture

### Description
Leaky queries. This pattern violates best practices and introduces technical debt that compounds over time.
