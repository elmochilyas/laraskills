# ECC Anti-Patterns -- Domain events within and across contexts
...
## Anti-Pattern 1: Event avalanche

### Category
Design / Architecture

### Description
Event avalanche. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-02/07-decision-trees.md

## Anti-Pattern 2: Lost events

### Category
Design / Architecture

### Description
Lost events. This pattern violates best practices and introduces technical debt that compounds over time.
