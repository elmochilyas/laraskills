# ECC Anti-Patterns -- Message bus and pub/sub patterns
...
## Anti-Pattern 1: God bus

### Category
Design / Architecture

### Description
God bus. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-05/07-decision-trees.md

## Anti-Pattern 2: Lost messages

### Category
Design / Architecture

### Description
Lost messages. This pattern violates best practices and introduces technical debt that compounds over time.
