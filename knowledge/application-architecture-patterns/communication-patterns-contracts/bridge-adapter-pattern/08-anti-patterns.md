# ECC Anti-Patterns -- Bridge/adapter pattern for context boundaries
...
## Anti-Pattern 1: Direct dependency

### Category
Design / Architecture

### Description
Direct dependency. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-07/07-decision-trees.md

## Anti-Pattern 2: Wrong-side adapter

### Category
Design / Architecture

### Description
Wrong-side adapter. This pattern violates best practices and introduces technical debt that compounds over time.
