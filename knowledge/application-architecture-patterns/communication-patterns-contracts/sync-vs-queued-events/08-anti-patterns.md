# ECC Anti-Patterns -- Synchronous vs queued event handling
...
1. Queue for everything
2. Sync for slow operations
...
## Anti-Pattern 1: Queue for everything

### Category
Design / Architecture

### Description
Queue for everything. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-03/07-decision-trees.md

## Anti-Pattern 2: Sync for slow operations

### Category
Design / Architecture

### Description
Sync for slow operations. This pattern violates best practices and introduces technical debt that compounds over time.
