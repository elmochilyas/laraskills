# ECC Anti-Patterns -- Event sourcing fundamentals
...
## Anti-Pattern 1: Event sourcing everywhere

### Category
Design / Architecture

### Description
Event sourcing everywhere. This pattern violates best practices and introduces technical debt that compounds over time.
...
- CPC-09/07-decision-trees.md

## Anti-Pattern 2: Snapshot neglect

### Category
Design / Architecture

### Description
Snapshot neglect. This pattern violates best practices and introduces technical debt that compounds over time.
