# ECC Anti-Patterns -- Static analysis rules for architecture
...
1. PHPStan for everything
2. Redundant enforcement
...
## Anti-Pattern 1: PHPStan for everything

### Category
Design / Architecture

### Description
PHPStan for everything. This pattern violates best practices and introduces technical debt that compounds over time.
...
- AEG-03/07-decision-trees.md

## Anti-Pattern 2: Redundant enforcement

### Category
Design / Architecture

### Description
Redundant enforcement. This pattern violates best practices and introduces technical debt that compounds over time.
