# ECC Anti-Patterns -- Onboarding documentation for architecture
...
1. Sink-or-swim onboarding
2. Outdated onboarding
...
## Anti-Pattern 1: Sink-or-swim onboarding

### Category
Design / Architecture

### Description
Sink-or-swim onboarding. This pattern violates best practices and introduces technical debt that compounds over time.
...
- AEG-10/07-decision-trees.md

## Anti-Pattern 2: Outdated onboarding

### Category
Design / Architecture

### Description
Outdated onboarding. This pattern violates best practices and introduces technical debt that compounds over time.
