# ECC Anti-Patterns -- CI enforcement of architecture rules
...
## Anti-Pattern 1: CI optional

### Category
Design / Architecture

### Description
CI optional. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
No baseline. This pattern violates best practices and introduces technical debt that compounds over time.
