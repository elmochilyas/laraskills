# ECC Anti-Patterns -- Refactoring and remediation workflows
...
## Anti-Pattern 1: Fix-it-later

### Category
Design / Architecture

### Description
Fix-it-later. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Big-bang rewrite. This pattern violates best practices and introduces technical debt that compounds over time.
