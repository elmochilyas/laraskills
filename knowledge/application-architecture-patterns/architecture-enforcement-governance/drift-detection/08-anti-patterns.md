# ECC Anti-Patterns -- Drift detection and architecture health
...
### Description
No measurement. This pattern violates best practices and introduces technical debt that compounds over time.
...
- AEG-08/07-decision-trees.md

## Anti-Pattern 2: Gaming the score

### Category
Design / Architecture

### Description
Gaming the score. This pattern violates best practices and introduces technical debt that compounds over time.
