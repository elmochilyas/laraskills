# ECC Anti-Patterns -- Import violation detection
...
1. No import detection
2. Only direct checks
...
## Anti-Pattern 1: No import detection

### Category
Design / Architecture

### Description
No import detection. This pattern violates best practices and introduces technical debt that compounds over time.
...
- AEG-05/07-decision-trees.md

## Anti-Pattern 2: Only direct checks

### Category
Design / Architecture

### Description
Only direct checks. This pattern violates best practices and introduces technical debt that compounds over time.
