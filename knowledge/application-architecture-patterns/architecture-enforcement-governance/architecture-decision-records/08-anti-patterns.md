# ECC Anti-Patterns -- Architecture Decision Records (ADRs)
...
## Anti-Pattern 1: Oral architecture

### Category
Design / Architecture

### Description
Oral architecture. This pattern violates best practices and introduces technical debt that compounds over time.
...
- AEG-06/07-decision-trees.md

## Anti-Pattern 2: ADR graveyard

### Category
Design / Architecture

### Description
ADR graveyard. This pattern violates best practices and introduces technical debt that compounds over time.
