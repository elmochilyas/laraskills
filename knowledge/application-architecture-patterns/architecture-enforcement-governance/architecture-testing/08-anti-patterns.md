# ECC Anti-Patterns -- Architecture testing (Pest tests for architecture rules)
...
## Anti-Pattern 1: Paper architecture

### Category
Design / Architecture

### Description
Paper architecture. This pattern violates best practices and introduces technical debt that compounds over time.
...
- AEG-01/07-decision-trees.md

## Anti-Pattern 2: False security

### Category
Design / Architecture

### Description
False security. This pattern violates best practices and introduces technical debt that compounds over time.
