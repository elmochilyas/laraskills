# ECC Anti-Patterns -- Team convention documentation
...
### Description
Tribal knowledge. This pattern violates best practices and introduces technical debt that compounds over time.
...
- AEG-07/07-decision-trees.md

## Anti-Pattern 2: Paper tiger

### Category
Design / Architecture

### Description
Paper tiger. This pattern violates best practices and introduces technical debt that compounds over time.
