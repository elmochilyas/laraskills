# ECC Anti-Patterns -- Database schema organization per bounded context
...
1. Shared tables between contexts
...
## Anti-Pattern 1: Shared tables between contexts

### Category
Design / Architecture

### Description
Shared tables between contexts. This pattern violates best practices and introduces technical debt that compounds over time.
...
- DBC-06/07-decision-trees.md

## Anti-Pattern 2: Cross-context foreign keys

### Category
Design / Architecture

### Description
Cross-context foreign keys. This pattern violates best practices and introduces technical debt that compounds over time.
