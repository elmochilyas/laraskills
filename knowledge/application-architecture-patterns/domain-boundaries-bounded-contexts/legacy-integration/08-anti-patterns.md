# ECC Anti-Patterns -- Integrating legacy systems at context boundaries
...
1. Legacy model imported directly
...
## Anti-Pattern 1: Legacy model imported directly

### Category
Design / Architecture

### Description
Legacy model imported directly. This pattern violates best practices and introduces technical debt that compounds over time.
...
- DBC-10/07-decision-trees.md

## Anti-Pattern 2: Migration without rollback

### Category
Design / Architecture

### Description
Migration without rollback. This pattern violates best practices and introduces technical debt that compounds over time.
