# ECC Anti-Patterns -- Multi-context transactions and saga patterns
...
1. Distributed transaction across contexts
2. Saga without state persistence
...
## Anti-Pattern 1: Distributed transaction across contexts

### Category
Design / Architecture

### Description
Distributed transaction across contexts. This pattern violates best practices and introduces technical debt that compounds over time.
...
- DBC-11/07-decision-trees.md

## Anti-Pattern 2: Saga without state persistence

### Category
Design / Architecture

### Description
Saga without state persistence. This pattern violates best practices and introduces technical debt that compounds over time.
