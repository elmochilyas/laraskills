# ECC Anti-Patterns -- Context mapping: relationships between contexts
...
## Anti-Pattern 1: No translation layer

### Category
Design / Architecture

### Description
No translation layer. This pattern violates best practices and introduces technical debt that compounds over time.
...
- DBC-02/07-decision-trees.md

## Anti-Pattern 2: Context map not maintained

### Category
Design / Architecture

### Description
Context map not maintained. This pattern violates best practices and introduces technical debt that compounds over time.
