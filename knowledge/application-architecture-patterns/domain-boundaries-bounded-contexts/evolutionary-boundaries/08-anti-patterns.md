# ECC Anti-Patterns -- Evolutionary boundaries: splitting a monolithic model
...
### Description
Analysis paralysis. This pattern violates best practices and introduces technical debt that compounds over time.
...
- DBC-08/07-decision-trees.md

## Anti-Pattern 2: Split and abandon

### Category
Design / Architecture

### Description
Split and abandon. This pattern violates best practices and introduces technical debt that compounds over time.
