# ECC Anti-Patterns -- Cross-context queries without database JOINs
...
1. Cross-context JOINs
2. N+1 cross-context queries
...
### Description
Cross-context JOINs. This pattern violates best practices and introduces technical debt that compounds over time.
...
- DBC-07/07-decision-trees.md

## Anti-Pattern 2: N+1 cross-context queries

### Category
Design / Architecture

### Description
N+1 cross-context queries. This pattern violates best practices and introduces technical debt that compounds over time.
