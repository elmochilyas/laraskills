# ECC Anti-Patterns -- Team-to-context mapping: Conway's Law in practice
...
## Anti-Pattern 1: Context shared across teams

### Category
Design / Architecture

### Description
Context shared across teams. This pattern violates best practices and introduces technical debt that compounds over time.
...
- DBC-09/07-decision-trees.md

## Anti-Pattern 2: Orphaned context

### Category
Design / Architecture

### Description
Orphaned context. This pattern violates best practices and introduces technical debt that compounds over time.
