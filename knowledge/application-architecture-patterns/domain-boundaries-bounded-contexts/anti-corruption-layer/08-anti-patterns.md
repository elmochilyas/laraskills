# ECC Anti-Patterns -- Anti-corruption layer pattern
...
## Anti-Pattern 1: Leaky ACL

### Category
Design / Architecture

### Description
Leaky ACL. This pattern violates best practices and introduces technical debt that compounds over time.
...
- DBC-04/07-decision-trees.md

## Anti-Pattern 2: ACL that's never updated

### Category
Design / Architecture

### Description
ACL that's never updated. This pattern violates best practices and introduces technical debt that compounds over time.
