# ECC Anti-Patterns -- Eloquent model ownership per context
...
## Anti-Pattern 1: Shared User model

### Category
Design / Architecture

### Description
Shared User model. This pattern violates best practices and introduces technical debt that compounds over time.
...
- DBC-05/07-decision-trees.md

## Anti-Pattern 2: Cross-context JOINs
