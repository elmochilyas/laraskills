# ECC Anti-Patterns -- Dependency injection for services and actions
...
## Anti-Pattern 1: Circular dependency

### Category
Design / Architecture

### Description
Circular dependency. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-09/07-decision-trees.md

## Anti-Pattern 2: Resolution failure

### Category
Design / Architecture

### Description
Resolution failure. This pattern violates best practices and introduces technical debt that compounds over time.
