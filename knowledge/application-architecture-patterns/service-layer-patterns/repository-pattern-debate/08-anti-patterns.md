# ECC Anti-Patterns -- Repository pattern debate: when it adds value vs. overhead
...
## Anti-Pattern 1: Repository drift

### Category
Design / Architecture

### Description
Repository drift. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-14/07-decision-trees.md

## Anti-Pattern 2: Abandoned repository

### Category
Design / Architecture

### Description
Abandoned repository. This pattern violates best practices and introduces technical debt that compounds over time.
