# ECC Anti-Patterns -- Service layer testing strategies
...
2. Brittle tests from tight coupling
...
## Anti-Pattern 1: Mock/reality mismatch

### Category
Design / Architecture

### Description
Mock/reality mismatch. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-17/07-decision-trees.md

## Anti-Pattern 2: Brittle tests from tight coupling

### Category
Design / Architecture

### Description
Brittle tests from tight coupling. This pattern violates best practices and introduces technical debt that compounds over time.
