# ECC Anti-Patterns -- DTO pattern: structured data transfer between layers
...
## Anti-Pattern 1: DTO bloat

### Category
Design / Architecture

### Description
DTO bloat. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-05/07-decision-trees.md

## Anti-Pattern 2: DTO serialization issues

### Category
Design / Architecture

### Description
DTO serialization issues. This pattern violates best practices and introduces technical debt that compounds over time.
