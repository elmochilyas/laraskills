# ECC Anti-Patterns -- Service vs. Action vs. Use Case: decision criteria
...
## Anti-Pattern 1: Architecture paralysis

### Category
Design / Architecture

### Description
Architecture paralysis. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-10/07-decision-trees.md

## Anti-Pattern 2: Pattern soup

### Category
Design / Architecture

### Description
Pattern soup. This pattern violates best practices and introduces technical debt that compounds over time.
