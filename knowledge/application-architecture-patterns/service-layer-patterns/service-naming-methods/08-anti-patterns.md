# ECC Anti-Patterns -- Service class naming conventions and method design
...
2. Method name/behavior mismatch
...
### Description
Inconsistent naming. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-07/07-decision-trees.md

## Anti-Pattern 2: Method name/behavior mismatch

### Category
Design / Architecture

### Description
Method name/behavior mismatch. This pattern violates best practices and introduces technical debt that compounds over time.
