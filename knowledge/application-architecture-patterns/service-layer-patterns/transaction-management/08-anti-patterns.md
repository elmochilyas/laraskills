# ECC Anti-Patterns -- Transaction management: where transactions belong
...
1. Distributed transaction without distributed infrastructure
2. Transaction per action
...
## Anti-Pattern 1: Distributed transaction without distributed infrastructure

### Category
Design / Architecture

### Description
Distributed transaction without distributed infrastructure. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-11/07-decision-trees.md

## Anti-Pattern 2: Transaction per action

### Category
Design / Architecture

### Description
Transaction per action. This pattern violates best practices and introduces technical debt that compounds over time.
