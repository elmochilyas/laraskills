# ECC Anti-Patterns -- Query objects as alternative to repositories
...
1. Query object explosion
2. Query/scopes duplication
...
## Anti-Pattern 1: Query object explosion

### Category
Design / Architecture

### Description
Query object explosion. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-16/07-decision-trees.md

## Anti-Pattern 2: Query/scopes duplication

### Category
Design / Architecture

### Description
Query/scopes duplication. This pattern violates best practices and introduces technical debt that compounds over time.
