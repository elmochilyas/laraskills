# ECC Anti-Patterns -- Repository pattern: feature-oriented vs. generic
...
1. Repository becomes query dumping ground
2. Repository + Eloquent duplicate logic
...
## Anti-Pattern 1: Repository becomes query dumping ground

### Category
Design / Architecture

### Description
Repository becomes query dumping ground. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-15/07-decision-trees.md

## Anti-Pattern 2: Repository + Eloquent duplicate logic

### Category
Design / Architecture

### Description
Repository + Eloquent duplicate logic. This pattern violates best practices and introduces technical debt that compounds over time.
