# ECC Anti-Patterns -- Service layer in Octane: state management considerations
...
1. User data leak across requests
2. Tenant cross-contamination
3. Intermittent unreproducible bugs
...
## Anti-Pattern 1: User data leak across requests

### Category
Design / Architecture

### Description
User data leak across requests. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-19/07-decision-trees.md

## Anti-Pattern 2: Tenant cross-contamination

### Category
Design / Architecture

### Description
Tenant cross-contamination. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Intermittent unreproducible bugs

### Category
Design / Architecture

### Description
Intermittent unreproducible bugs. This pattern violates best practices and introduces technical debt that compounds over time.
