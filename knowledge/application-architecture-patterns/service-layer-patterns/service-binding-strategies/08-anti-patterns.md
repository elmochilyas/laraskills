# ECC Anti-Patterns -- Service binding strategies: singleton vs. transient
...
- SLP-12/07-decision-trees.md

## Anti-Pattern 2: Stale tenant context

### Category
Design / Architecture

### Description
Stale tenant context. This pattern violates best practices and introduces technical debt that compounds over time.
