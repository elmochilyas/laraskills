# ECC Anti-Patterns -- Service-Action-Repository pyramid architecture
...
1. All three layers are the same file
2. Pyramid becomes flat
...
## Anti-Pattern 1: All three layers are the same file

### Category
Design / Architecture

### Description
All three layers are the same file. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-04/07-decision-trees.md

## Anti-Pattern 2: Pyramid becomes flat

### Category
Design / Architecture

### Description
Pyramid becomes flat. This pattern violates best practices and introduces technical debt that compounds over time.
