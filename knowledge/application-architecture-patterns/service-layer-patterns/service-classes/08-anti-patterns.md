# ECC Anti-Patterns -- Service classes: grouping operations by entity
...
1. Service calling service calling service
...
## Anti-Pattern 1: Service calling service calling service

### Category
Design / Architecture

### Description
Service calling service calling service. This pattern violates best practices and introduces technical debt that compounds over time.
