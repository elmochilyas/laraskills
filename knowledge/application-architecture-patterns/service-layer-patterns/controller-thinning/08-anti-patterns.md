# ECC Anti-Patterns -- Controller thinning: what to extract and what to keep
...
1. Service returning response objects
...
## Anti-Pattern 1: Service returning response objects

### Category
Design / Architecture

### Description
Service returning response objects. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-03/07-decision-trees.md

## Anti-Pattern 2: Controller with business logic

### Category
Design / Architecture

### Description
Controller with business logic. This pattern violates best practices and introduces technical debt that compounds over time.
