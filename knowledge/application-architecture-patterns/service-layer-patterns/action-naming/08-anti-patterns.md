# ECC Anti-Patterns -- Action class naming: verb-noun commands
...
## Anti-Pattern 1: Action name collision

### Category
Design / Architecture

### Description
Action name collision. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-08/07-decision-trees.md

## Anti-Pattern 2: Verb inconsistency

### Category
Design / Architecture

### Description
Verb inconsistency. This pattern violates best practices and introduces technical debt that compounds over time.
