# ECC Anti-Patterns -- Action classes: single-operation-per-class pattern
...
1. Action explosion without organization
2. Giant action
...
## Anti-Pattern 1: Action explosion without organization

### Category
Design / Architecture

### Description
Action explosion without organization. This pattern violates best practices and introduces technical debt that compounds over time.
...
- SLP-02/07-decision-trees.md

## Anti-Pattern 2: Giant action

### Category
Design / Architecture

### Description
Giant action. This pattern violates best practices and introduces technical debt that compounds over time.
