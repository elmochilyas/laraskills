# ECC Anti-Patterns -- Module registration and discovery mechanisms
...
### Description
Duplicate registration. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-04/07-decision-trees.md

## Anti-Pattern 2: Dead module registered

### Category
Design / Architecture

### Description
Dead module registered. This pattern violates best practices and introduces technical debt that compounds over time.
