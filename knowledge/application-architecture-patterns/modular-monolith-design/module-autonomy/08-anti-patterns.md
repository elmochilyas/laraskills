# ECC Anti-Patterns -- Module autonomy: routes, migrations, config, tests per module
...
## Anti-Pattern 1: Orphan migrations

### Category
Design / Architecture

### Description
Orphan migrations. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-05/07-decision-trees.md

## Anti-Pattern 2: Duplicate migration names

### Category
Design / Architecture

### Description
Duplicate migration names. This pattern violates best practices and introduces technical debt that compounds over time.
