# ECC Anti-Patterns -- Inter-module synchronous communication via contracts
...
1. Contract drift
2. Direct implementation import
...
## Anti-Pattern 1: Contract drift

### Category
Design / Architecture

### Description
Contract drift. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-06/07-decision-trees.md

## Anti-Pattern 2: Direct implementation import

### Category
Design / Architecture

### Description
Direct implementation import. This pattern violates best practices and introduces technical debt that compounds over time.
