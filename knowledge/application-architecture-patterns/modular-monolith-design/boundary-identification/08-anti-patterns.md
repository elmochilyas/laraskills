# ECC Anti-Patterns -- Module boundary identification: bounded context heuristics
...
1. Wrong boundary discovered too late
...
## Anti-Pattern 1: Wrong boundary discovered too late

### Category
Design / Architecture

### Description
Wrong boundary discovered too late. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-02/07-decision-trees.md

## Anti-Pattern 2: Context conflation

### Category
Design / Architecture

### Description
Context conflation. This pattern violates best practices and introduces technical debt that compounds over time.
