# ECC Anti-Patterns -- Shared kernel: what belongs in shared vs. modules
...
## Anti-Pattern 1: Shared Eloquent model

### Category
Design / Architecture

### Description
Shared Eloquent model. This pattern violates best practices and introduces technical debt that compounds over time.
