# ECC Anti-Patterns -- Testing strategies for modular monolith
...
## Anti-Pattern 1: Contract mismatch

### Category
Design / Architecture

### Description
Contract mismatch. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-16/07-decision-trees.md

## Anti-Pattern 2: Test suite too slow

### Category
Design / Architecture

### Description
Test suite too slow. This pattern violates best practices and introduces technical debt that compounds over time.
