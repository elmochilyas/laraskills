# ECC Anti-Patterns -- Module extraction path: from module to independent service
...
2. Extraction without rollback plan
...
### Description
Big bang extraction. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-11/07-decision-trees.md

## Anti-Pattern 2: Extraction without rollback plan

### Category
Design / Architecture

### Description
Extraction without rollback plan. This pattern violates best practices and introduces technical debt that compounds over time.
