# ECC Anti-Patterns -- Module isolation enforcement: linting and CI rules
...
## Anti-Pattern 1: Enforcement paralysis

### Category
Design / Architecture

### Description
Enforcement paralysis. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-12/07-decision-trees.md

## Anti-Pattern 2: Stale baseline

### Category
Design / Architecture

### Description
Stale baseline. This pattern violates best practices and introduces technical debt that compounds over time.
