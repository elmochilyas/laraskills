# ECC Anti-Patterns -- Module internal structure conventions
...
1. Module structure abandonment
2. Missing module boundary enforcement
...
## Anti-Pattern 1: Module structure abandonment

### Category
Design / Architecture

### Description
Module structure abandonment. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-03/07-decision-trees.md

## Anti-Pattern 2: Missing module boundary enforcement

### Category
Design / Architecture

### Description
Missing module boundary enforcement. This pattern violates best practices and introduces technical debt that compounds over time.
