# ECC Anti-Patterns -- Database schema ownership per module
...
1. Schema ownership violation in migrations
2. Orphan tables
...
## Anti-Pattern 1: Schema ownership violation in migrations

### Category
Design / Architecture

### Description
Schema ownership violation in migrations. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-13/07-decision-trees.md

## Anti-Pattern 2: Orphan tables

### Category
Design / Architecture

### Description
Orphan tables. This pattern violates best practices and introduces technical debt that compounds over time.
