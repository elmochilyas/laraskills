# ECC Anti-Patterns -- Cross-module data access: query patterns without JOINs
...
## Anti-Pattern 1: Inconsistent projections

### Category
Design / Architecture

### Description
Inconsistent projections. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-10/07-decision-trees.md

## Anti-Pattern 2: Cross-module N+1

### Category
Design / Architecture

### Description
Cross-module N+1. This pattern violates best practices and introduces technical debt that compounds over time.
