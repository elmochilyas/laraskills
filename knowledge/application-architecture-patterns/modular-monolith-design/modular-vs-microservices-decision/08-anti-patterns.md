# ECC Anti-Patterns -- Modular monolith vs. microservices decision framework
...
### Description
Premature microservices. This pattern violates best practices and introduces technical debt that compounds over time.
