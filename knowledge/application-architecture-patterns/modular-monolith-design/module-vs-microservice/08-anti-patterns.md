# ECC Anti-Patterns -- Module vs. microservice: definition and key differences
...
### Description
Distributed monolith. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-01/07-decision-trees.md

## Anti-Pattern 2: Module extraction failure

### Category
Design / Architecture

### Description
Module extraction failure. This pattern violates best practices and introduces technical debt that compounds over time.
