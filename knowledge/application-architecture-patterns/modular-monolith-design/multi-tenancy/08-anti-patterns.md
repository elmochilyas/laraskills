# ECC Anti-Patterns -- Multi-tenancy considerations in modular monolith
...
1. Hardcoded tenant strategy globally
2. No tenant isolation tests
...
## Anti-Pattern 1: Hardcoded tenant strategy globally

### Category
Design / Architecture

### Description
Hardcoded tenant strategy globally. This pattern violates best practices and introduces technical debt that compounds over time.
...
- MMD-14/07-decision-trees.md

## Anti-Pattern 2: No tenant isolation tests

### Category
Design / Architecture

### Description
No tenant isolation tests. This pattern violates best practices and introduces technical debt that compounds over time.
