...
Knowledge Unit: PHP Version Numbering — Minor Releases, Security vs Active Support
...
- **Version scheme**: `major.minor.patch` — PHP 8.5.0 (major=8, minor=8.5, patch=0)
...
**Leapfrog upgrades**: Skip intermediate versions when migrating (e.g., 7.4 ? 8.2 directly) to reduce migration cycles. Test each major boundary separately.

---

# Common Mistakes

**Running EOL versions in production**: PHP 7.4 and 8.0 receive no security patches. CVE exploits targeting known PHP vulnerabilities appear regularly. Upgrade before end-of-support deadlines.
...
Engine Version Performance Deltas | Version Migration Planning
