# Anti-Patterns: Reference Counting — zval refcount Lifecycle, GC_ADDREF/GC_DELREF, TRY Semantics
...
- 04-standardized-knowledge.md: Reference Counting — zval refcount Lifecycle, GC_ADDREF/GC_DELREF, TRY Semantics
