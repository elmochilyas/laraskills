# Anti-Patterns: Memory Leak Detection — Growing Static Collections, Closure Accumulation, Checkpointing, Profiling
...
- 04-standardized-knowledge.md: Memory Leak Detection — Growing Static Collections, Closure Accumulation, Checkpointing, Profiling
