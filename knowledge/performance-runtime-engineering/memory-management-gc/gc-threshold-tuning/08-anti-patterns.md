# Anti-Patterns: GC Threshold Tuning — gc_threshold Dynamic Adjustment, Collection Frequency, Root Buffer Sizing
...
- 04-standardized-knowledge.md: GC Threshold Tuning — gc_threshold Dynamic Adjustment, Collection Frequency, Root Buffer Sizing
