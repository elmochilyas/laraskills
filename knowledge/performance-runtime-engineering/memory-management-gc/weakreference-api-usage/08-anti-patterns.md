# Anti-Patterns: Standardized Knowledge: WeakReference API Usage
...
| Knowledge Unit | Standardized Knowledge: WeakReference API Usage |
...
- 04-standardized-knowledge.md: Standardized Knowledge: WeakReference API Usage
