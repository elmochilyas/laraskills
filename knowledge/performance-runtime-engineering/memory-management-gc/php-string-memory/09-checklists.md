...
**Knowledge Unit:** ku-12-php-string-memory
...
- [ ] Document and follow through on architectural decision: String concatenation vs implode vs sprintf
- [ ] Document and follow through on architectural decision: Handling large strings in memory
...
**Decision Trees:** String concatenation vs implode vs sprintf, Handling large strings in memory
