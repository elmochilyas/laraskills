...
- [ ] Document and follow through on architectural decision: Responding to memory_limit exceeded errors
- [ ] Document and follow through on architectural decision: Preventive vs reactive strategies
- [ ] Document and follow through on architectural decision: OOM kill and container memory limits
...
**Decision Trees:** Responding to memory_limit exceeded errors, Preventive vs reactive strategies, OOM kill and container memory limits
