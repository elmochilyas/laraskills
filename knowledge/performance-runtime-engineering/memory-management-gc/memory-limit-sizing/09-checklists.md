...
**Knowledge Unit:** ku-06-memory-limit-sizing
...
- [ ] Document and follow through on architectural decision: memory_limit value for FPM workers
- [ ] Document and follow through on architectural decision: Per-process vs total RSS budget
...
**Decision Trees:** memory_limit value for FPM workers, Per-process vs total RSS budget
