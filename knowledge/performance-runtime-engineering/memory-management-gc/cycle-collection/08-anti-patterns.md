# Anti-Patterns: Cycle Collection — Bacon-Rajan Algorithm, Root Buffer, Mark-Grey/Scan/Sweep Phases
...
- 04-standardized-knowledge.md: Cycle Collection — Bacon-Rajan Algorithm, Root Buffer, Mark-Grey/Scan/Sweep Phases
