...
**Knowledge Unit:** ku-11-array-memory-overhead
...
- [ ] Document and follow through on architectural decision: Array type selection for memory-sensitive code
- [ ] Document and follow through on architectural decision: SplFixedArray vs plain array
...
**Decision Trees:** Array type selection for memory-sensitive code, SplFixedArray vs plain array
