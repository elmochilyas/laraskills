...
**Knowledge Unit:** ku-07-gc-cpu-overhead
...
- [ ] Document and follow through on architectural decision: Whether GC CPU overhead is excessive
- [ ] Document and follow through on architectural decision: GC disable vs GC threshold tuning
...
**Decision Trees:** Whether GC CPU overhead is excessive, GC disable vs GC threshold tuning
