# Anti-Patterns: PHP Memory Model — Zend Engine Memory Manager, zval Structure, Allocation Tiers
...
- 04-standardized-knowledge.md: PHP Memory Model — Zend Engine Memory Manager, zval Structure, Allocation Tiers
