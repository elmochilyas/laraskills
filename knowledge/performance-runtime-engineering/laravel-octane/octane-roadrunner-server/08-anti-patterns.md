# Anti-Patterns: Octane RoadRunner Server — Go-Based Application Server, Goridge Binary Protocol
...
- 04-standardized-knowledge.md: Octane RoadRunner Server — Go-Based Application Server, Goridge Binary Protocol
