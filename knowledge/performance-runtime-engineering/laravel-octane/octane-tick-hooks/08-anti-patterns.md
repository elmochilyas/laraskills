# Anti-Patterns: Octane Tick Hooks — Scheduled Callbacks Within Octane Workers
...
- 04-standardized-knowledge.md: Octane Tick Hooks — Scheduled Callbacks Within Octane Workers
