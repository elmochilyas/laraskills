# Anti-Patterns: Octane FrankenPHP Server — Caddy Module, Embedded PHP, Worker Mode
...
- 04-standardized-knowledge.md: Octane FrankenPHP Server — Caddy Module, Embedded PHP, Worker Mode
