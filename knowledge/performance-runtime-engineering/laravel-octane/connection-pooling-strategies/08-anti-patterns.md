# Anti-Patterns: Connection Pooling Strategies — Database, Redis Across Workers
...
- 04-standardized-knowledge.md: Connection Pooling Strategies — Database, Redis Across Workers
