# Anti-Patterns: Monitoring Octane Status — php artisan octane:status, octane:profile-memory
...
- 04-standardized-knowledge.md: Monitoring Octane Status — php artisan octane:status, octane:profile-memory
