...
- **num_threads**: Minimum number of PHP threads always available. Set to number of CPU cores for compute-bound, 2-4x cores for I/O-bound.
...
**Setting max_threads too high**: Over-provisioning threads causes OOM, same as over-provisioning FPM workers. Calculate from available RAM, not from desired throughput.

---

# Related Knowledge Units

FrankenPHP Architecture | FrankenPHP Container Memory Management | PHP-FPM Pool Sizing Formula
