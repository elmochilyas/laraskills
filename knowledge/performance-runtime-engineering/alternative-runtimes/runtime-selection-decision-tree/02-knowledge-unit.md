...
Knowledge Unit: Runtime Selection Decision Tree — RoadRunner for High-Throughput, Swoole for High-Latency I/O, FrankenPHP for Simplicity
...
**Selecting a runtime without benchmarking your specific workload**: Runtime performance varies dramatically by I/O profile. Always benchmark with production-representative traffic patterns.

---

# Core Concepts

The runtime selection decision tree considers three dimensions: I/O latency profile, operational complexity, and Octane driver preference. Each runtime (RoadRunner, Swoole, FrankenPHP) optimizes for a different workload profile. Understanding these tradeoffs is essential for choosing the right runtime.

---

# Related Knowledge Units

Runtime Comparison Overview | Architecture Model Differences | Laravel Octane Driver Selection
