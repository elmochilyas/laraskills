# Anti-Patterns: OpCache Memory Sizing - memory_consumption, interned_strings_buffer |
...
- 04-standardized-knowledge.md: OpCache Memory Sizing - memory_consumption, interned_strings_buffer |
