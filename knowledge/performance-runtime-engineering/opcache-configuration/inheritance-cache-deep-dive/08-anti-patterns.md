# Anti-Patterns: Inheritance Cache Deep Dive - Class Hierarchy Pre-Resolution, Method Table Caching |
...
- 04-standardized-knowledge.md: Inheritance Cache Deep Dive - Class Hierarchy Pre-Resolution, Method Table Caching |
