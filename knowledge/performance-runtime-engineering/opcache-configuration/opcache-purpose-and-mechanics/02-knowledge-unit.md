...
**Library model**: Without OpCache, every visitor to the library must rewrite every book from scratch. OpCache is the librarian who keeps all books pre-written on shelves.

---

# Performance Considerations

- Default settings work but are far from optimal: `memory_consumption=128MB` may be too small for large applications
- Enable OpCache first, then tune. It provides the largest gain with zero code changes.
- OpCache with default settings: ~1.5-2x throughput. With optimized settings: ~2-4x throughput.

---

# Common Mistakes

**Not enabling OpCache in production**: Approximately 10-15% of production PHP deployments still have OpCache disabled. This is the largest single performance mistake.

---

# Related Knowledge Units

OpCache Memory Sizing | Max Accelerated Files Calculation | Production Hardening Settings
