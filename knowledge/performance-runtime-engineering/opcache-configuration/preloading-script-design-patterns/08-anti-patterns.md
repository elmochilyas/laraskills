# Anti-Patterns: Preloading Script Design Patterns - opcache_compile_file() vs include, Conditional Declarations |
...
- 04-standardized-knowledge.md: Preloading Script Design Patterns - opcache_compile_file() vs include, Conditional Declarations |
