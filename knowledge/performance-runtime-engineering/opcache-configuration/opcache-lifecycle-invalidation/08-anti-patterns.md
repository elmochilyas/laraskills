# Anti-Patterns: OpCache Lifecycle and Invalidation - opcache_reset(), opcache_invalidate(), PHP-FPM Graceful Reload |
...
- 04-standardized-knowledge.md: OpCache Lifecycle and Invalidation - opcache_reset(), opcache_invalidate(), PHP-FPM Graceful Reload |
