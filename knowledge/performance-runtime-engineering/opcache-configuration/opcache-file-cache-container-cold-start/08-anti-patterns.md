# Anti-Patterns: OpCache File Cache and Container Cold-Start Mitigation |
...
- 04-standardized-knowledge.md: OpCache File Cache and Container Cold-Start Mitigation |
