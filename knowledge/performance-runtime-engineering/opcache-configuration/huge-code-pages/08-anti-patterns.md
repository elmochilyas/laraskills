# Anti-Patterns: OpCache Huge Code Pages — opcache.huge_code_pages, TLB Pressure Reduction, Memory Mapping |
...
- 04-standardized-knowledge.md: OpCache Huge Code Pages — opcache.huge_code_pages, TLB Pressure Reduction, Memory Mapping |
