# Anti-Patterns: OpCache Overview — Purpose, Architecture, Lifecycle, Throughput Impact |
...
- 04-standardized-knowledge.md: OpCache Overview — Purpose, Architecture, Lifecycle, Throughput Impact |
