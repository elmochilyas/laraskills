# Anti-Patterns: OpCache CLI — opcache.enable_cli, CLI Script Performance, Best Practices |
...
- 04-standardized-knowledge.md: OpCache CLI — opcache.enable_cli, CLI Script Performance, Best Practices |
