# Anti-Patterns: OpCache Max Accelerated Files — max_accelerated_files, Hash Table Prime Numbers, File Counting |
...
- 04-standardized-knowledge.md: OpCache Max Accelerated Files — max_accelerated_files, Hash Table Prime Numbers, File Counting |
