...
Knowledge Unit: Benchmarking Concepts and Terminology — Throughput, Latency, Percentiles, Error Rate
...
- **Coordinated omission**: Bias where closed-loop benchmarks stop measuring when the system is overloaded, underestimating tail latency.

---

# Common Mistakes

**Reporting only average latency**: Average hides outliers. A system can have 50ms average with 5% of requests taking 5000ms. Always report p95 and p99.
...
Metrics Definition and Interpretation | Tool Selection by Layer | Coordinated Omission
