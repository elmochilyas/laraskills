# Anti-Patterns: Standardized Knowledge: Tideways Setup — Extension, Daemon, API Key, Sample Rate, Tracepoint Configuration
...
| Knowledge Unit | Standardized Knowledge: Tideways Setup — Extension, Daemon, API Key, Sample Rate, Tracepoint Configuration |
...
- 04-standardized-knowledge.md: Standardized Knowledge: Tideways Setup — Extension, Daemon, API Key, Sample Rate, Tracepoint Configuration
