# Anti-Patterns: Standardized Knowledge: eBPF PHP Profiling — Near-Zero Overhead, CPU Sampling, PID Scoping
...
| Knowledge Unit | Standardized Knowledge: eBPF PHP Profiling — Near-Zero Overhead, CPU Sampling, PID Scoping |
...
- 04-standardized-knowledge.md: Standardized Knowledge: eBPF PHP Profiling — Near-Zero Overhead, CPU Sampling, PID Scoping
