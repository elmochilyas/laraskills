...
Knowledge Unit: CPU-Bound vs I/O-Bound Worker Ratios — 2-4/core vs 8-12/core
...
**Workload classification**: Run a request profile. If CPU utilization is 20% during peak load, the workload is I/O-bound. If CPU utilization is 90%+, it's CPU-bound. If mixed (50-70%), use the midpoint ratio.

---

# Common Mistakes

**Assuming "more workers = more throughput"**: Beyond the optimal ratio, additional workers increase context switching (CPU-bound) or memory pressure (I/O-bound) without improving throughput. Always benchmark to find the inflection point.
