...
Knowledge Unit: Pool Sizing Formula — pm.max_children = (total_RAM - reserved) / avg_worker_RSS
...
16GB server ? reserve 6GB (OS + DB + Redis) ? 10GB available. Average worker RSS = 65MB, P95 = 95MB. With P95: 10,000MB / (95MB × 1.2 safety) = ~87 children. With average: 10,000MB / (65MB × 1.2) = ~128 children. Average-based oversubscribes by 47%.

---

# Common Mistakes

**Sizing by average RSS**: Average-based sizing causes OOM during peak memory variance. Always use P95 or P99 RSS multiplied by a safety factor.
...
PM Max Children P95 Calculation | Capacity Planning Safety Margins | Worker RSS Capacity Ceiling
