...
1. Level 0 in Production
2. Infinite Baseline
3. Ignoring False Positives
4. No PHPDoc on Models
...
## Anti-Pattern 1: Level 0 in Production

### Category
Design / Architecture

### Description
Level 0 in Production. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Infinite Baseline

### Category
Design / Architecture

### Description
Infinite Baseline. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Ignoring False Positives. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: No PHPDoc on Models

### Category
Design / Architecture

### Description
No PHPDoc on Models. This pattern violates best practices and introduces technical debt that compounds over time.
