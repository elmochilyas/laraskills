...
## Anti-Pattern 1: Pint in Production

### Category
Design / Architecture

### Description
Pint in Production. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No Configuration

### Category
Design / Architecture

### Description
No Configuration. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Ignoring Vendor Updates

### Category
Design / Architecture

### Description
Ignoring Vendor Updates. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Blind Auto-Fix

### Category
Design / Architecture

### Description
Blind Auto-Fix. This pattern violates best practices and introduces technical debt that compounds over time.
