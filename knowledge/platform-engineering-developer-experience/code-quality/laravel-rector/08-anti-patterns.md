...
1. Rector as Black Box
2. One Giant PR
3. No Testing After Rector
4. Rector on Production
...
## Anti-Pattern 1: Rector as Black Box

### Category
Design / Architecture

### Description
Rector as Black Box. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: One Giant PR

### Category
Design / Architecture

### Description
One Giant PR. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No Testing After Rector

### Category
Design / Architecture

### Description
No Testing After Rector. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Rector on Production

### Category
Design / Architecture

### Description
Rector on Production. This pattern violates best practices and introduces technical debt that compounds over time.
