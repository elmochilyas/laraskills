...
### Description
Over-Configuration. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No Exclusions

### Category
Design / Architecture

### Description
No Exclusions. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Blind Rule Changes

### Category
Design / Architecture

### Description
Blind Rule Changes. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Floating Config

### Category
Design / Architecture

### Description
Floating Config. This pattern violates best practices and introduces technical debt that compounds over time.
