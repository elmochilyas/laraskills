...
1. Full Custom Ruleset
2. Frequent Preset Switching
3. Ignoring Preset Changes
4. Forcing Non-Laravel Preset on Laravel
...
## Anti-Pattern 1: Full Custom Ruleset

### Category
Design / Architecture

### Description
Full Custom Ruleset. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Frequent Preset Switching

### Category
Design / Architecture

### Description
Frequent Preset Switching. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Ignoring Preset Changes

### Category
Design / Architecture

### Description
Ignoring Preset Changes. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Forcing Non-Laravel Preset on Laravel

### Category
Design / Architecture

### Description
Forcing Non-Laravel Preset on Laravel. This pattern violates best practices and introduces technical debt that compounds over time.
