...
3. Security Scanner as Automated Pen Tester
...
## Anti-Pattern 1: Secret Scanning

### Category
Design / Architecture

### Description
Secret Scanning. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: GitHub Advisory Database

### Category
Design / Architecture

### Description
GitHub Advisory Database. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Security Scanner as Automated Pen Tester

### Category
Design / Architecture

### Description
Security Scanner as Automated Pen Tester. This pattern violates best practices and introduces technical debt that compounds over time.
