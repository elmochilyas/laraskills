...
1. Using Dusk for everything
2. No screenshot capture on failure
3. Hardcoded wait times
4. Running Dusk and PHPUnit in the same job
5. Ignoring ChromeDriver version
...
## Anti-Pattern 1: Using Dusk for everything

### Category
Design / Architecture

### Description
Using Dusk for everything. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No screenshot capture on failure

### Category
Design / Architecture

### Description
No screenshot capture on failure. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Hardcoded wait times. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Running Dusk and PHPUnit in the same job

### Category
Design / Architecture

### Description
Running Dusk and PHPUnit in the same job. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Ignoring ChromeDriver version

### Category
Design / Architecture

### Description
Ignoring ChromeDriver version. This pattern violates best practices and introduces technical debt that compounds over time.
