...
1. Full suite on every push without parallelization
2. Skipping database testing entirely
3. Ignoring CI-only failures
4. No coverage enforcement
5. Service container without health check
...
## Anti-Pattern 1: Full suite on every push without parallelization

### Category
Design / Architecture

### Description
Full suite on every push without parallelization. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Skipping database testing entirely

### Category
Design / Architecture

### Description
Skipping database testing entirely. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Ignoring CI-only failures

### Category
Design / Architecture

### Description
Ignoring CI-only failures. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: No coverage enforcement

### Category
Design / Architecture

### Description
No coverage enforcement. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Service container without health check

### Category
Design / Architecture

### Description
Service container without health check. This pattern violates best practices and introduces technical debt that compounds over time.
