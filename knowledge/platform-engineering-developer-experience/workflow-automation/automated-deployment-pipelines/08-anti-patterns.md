...
1. Friday deployments
2. Automatic production deployment without staging verification
3. No rollback procedure
4. Manual deployment steps
5. One-click deploy that skips CI
...
## Anti-Pattern 1: Friday deployments

### Category
Design / Architecture

### Description
Friday deployments. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Automatic production deployment without staging verification

### Category
Design / Architecture

### Description
Automatic production deployment without staging verification. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No rollback procedure

### Category
Design / Architecture

### Description
No rollback procedure. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Manual deployment steps. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: One-click deploy that skips CI

### Category
Design / Architecture

### Description
One-click deploy that skips CI. This pattern violates best practices and introduces technical debt that compounds over time.
