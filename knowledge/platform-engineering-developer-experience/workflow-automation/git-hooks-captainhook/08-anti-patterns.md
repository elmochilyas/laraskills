...
1. Husky in Laravel projects
2. Full test suite in pre-commit
3. No auto-installation
4. Hooks without CI fallback
5. All-files check in pre-commit
...
## Anti-Pattern 1: Husky in Laravel projects

### Category
Design / Architecture

### Description
Husky in Laravel projects. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Full test suite in pre-commit

### Category
Design / Architecture

### Description
Full test suite in pre-commit. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No auto-installation

### Category
Design / Architecture

### Description
No auto-installation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Hooks without CI fallback

### Category
Design / Architecture

### Description
Hooks without CI fallback. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: All-files check in pre-commit

### Category
Design / Architecture

### Description
All-files check in pre-commit. This pattern violates best practices and introduces technical debt that compounds over time.
