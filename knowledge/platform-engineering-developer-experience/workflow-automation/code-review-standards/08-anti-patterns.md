...
1. Gatekeeping culture
2. Style debates in review
3. Request changes without explanation
4. One-person review bottleneck
5. Checklist fatigue
...
## Anti-Pattern 1: Gatekeeping culture

### Category
Design / Architecture

### Description
Gatekeeping culture. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Style debates in review

### Category
Design / Architecture

### Description
Style debates in review. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Request changes without explanation

### Category
Design / Architecture

### Description
Request changes without explanation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: One-person review bottleneck

### Category
Design / Architecture

### Description
One-person review bottleneck. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Checklist fatigue

### Category
Design / Architecture

### Description
Checklist fatigue. This pattern violates best practices and introduces technical debt that compounds over time.
