...
1. Zero-baseline requirement from day one
2. Hiding errors with @phpstan-ignore-line
3. Running PHPStan at level 0
4. No PHPStan in CI at all
5. Stale baseline never reduced
...
## Anti-Pattern 1: Zero-baseline requirement from day one

### Category
Design / Architecture

### Description
Zero-baseline requirement from day one. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Hiding errors with @phpstan-ignore-line

### Category
Design / Architecture

### Description
Hiding errors with @phpstan-ignore-line. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Running PHPStan at level 0

### Category
Design / Architecture

### Description
Running PHPStan at level 0. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: No PHPStan in CI at all

### Category
Design / Architecture

### Description
No PHPStan in CI at all. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Stale baseline never reduced

### Category
Design / Architecture

### Description
Stale baseline never reduced. This pattern violates best practices and introduces technical debt that compounds over time.
