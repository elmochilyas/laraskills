...
1. Monolithic workflow file
2. Skipping parallelization
3. Ignoring cache key strategy
4. Deploying on PR events
...
## Anti-Pattern 1: Monolithic workflow file

### Category
Design / Architecture

### Description
Monolithic workflow file. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Skipping parallelization

### Category
Design / Architecture

### Description
Skipping parallelization. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Ignoring cache key strategy

### Category
Design / Architecture

### Description
Ignoring cache key strategy. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Deploying on PR events

### Category
Design / Architecture

### Description
Deploying on PR events. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: No environment-specific configuration

### Category
Design / Architecture

### Description
No environment-specific configuration. This pattern violates best practices and introduces technical debt that compounds over time.
