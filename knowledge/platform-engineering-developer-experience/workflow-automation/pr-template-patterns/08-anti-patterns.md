...
1. Checklist as quality gate enforcement
2. Template as substitute for documentation
3. One-size-fits-all for every PR type
4. Template bypass allowed
5. Ignoring template feedback
...
## Anti-Pattern 1: Checklist as quality gate enforcement

### Category
Design / Architecture

### Description
Checklist as quality gate enforcement. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Template as substitute for documentation

### Category
Design / Architecture

### Description
Template as substitute for documentation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: One-size-fits-all for every PR type

### Category
Design / Architecture

### Description
One-size-fits-all for every PR type. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Template bypass allowed

### Category
Design / Architecture

### Description
Template bypass allowed. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Ignoring template feedback

### Category
Design / Architecture

### Description
Ignoring template feedback. This pattern violates best practices and introduces technical debt that compounds over time.
