...
1. The Forge-SSH Hybrid
2. The Manual Tweak
3. The Golden Recipe
4. The Abandoned Server
5. The API Key on a Post-it
...
## Anti-Pattern 1: The Forge-SSH Hybrid

### Category
Design / Architecture

### Description
The Forge-SSH Hybrid. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Manual Tweak

### Category
Design / Architecture

### Description
The Manual Tweak. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Golden Recipe

### Category
Design / Architecture

### Description
The Golden Recipe. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Abandoned Server

### Category
Design / Architecture

### Description
The Abandoned Server. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: The API Key on a Post-it

### Category
Design / Architecture

### Description
The API Key on a Post-it. This pattern violates best practices and introduces technical debt that compounds over time.
