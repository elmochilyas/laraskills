...
1. The Monolith Template
2. The Frozen Template
3. The Empty Template
4. The Over-Parameterized Template
...
## Anti-Pattern 1: The Monolith Template

### Category
Design / Architecture

### Description
The Monolith Template. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Frozen Template

### Category
Design / Architecture

### Description
The Frozen Template. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Empty Template

### Category
Design / Architecture

### Description
The Empty Template. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Over-Parameterized Template

### Category
Design / Architecture

### Description
The Over-Parameterized Template. This pattern violates best practices and introduces technical debt that compounds over time.
