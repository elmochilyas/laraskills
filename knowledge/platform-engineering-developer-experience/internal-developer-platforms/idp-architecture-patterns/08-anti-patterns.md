...
2. The Black Box Platform
3. The Kitchen Sink Platform
4. The Gatekeeper Platform
5. The Vendor Lock-In Platform
...
## Anti-Pattern 1: The Snowflake Platform

### Category
Design / Architecture

### Description
The Snowflake Platform. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Black Box Platform

### Category
Design / Architecture

### Description
The Black Box Platform. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Kitchen Sink Platform

### Category
Design / Architecture

### Description
The Kitchen Sink Platform. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Gatekeeper Platform

### Category
Design / Architecture

### Description
The Gatekeeper Platform. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: The Vendor Lock-In Platform

### Category
Design / Architecture

### Description
The Vendor Lock-In Platform. This pattern violates best practices and introduces technical debt that compounds over time.
