...
2. The Static Spreadsheet
3. The Incomplete Catalog
4. The Orphan Graveyard
...
## Anti-Pattern 1: The Database-Backed Catalog

### Category
Design / Architecture

### Description
The Database-Backed Catalog. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Static Spreadsheet

### Category
Design / Architecture

### Description
The Static Spreadsheet. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Incomplete Catalog

### Category
Design / Architecture

### Description
The Incomplete Catalog. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Orphan Graveyard

### Category
Design / Architecture

### Description
The Orphan Graveyard. This pattern violates best practices and introduces technical debt that compounds over time.
