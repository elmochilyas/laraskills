...
1. The Empty Portal
2. The Mandatory Portal
3. The Backstage Black Hole
4. The Custom Plugin Graveyard
...
## Anti-Pattern 1: The Empty Portal

### Category
Design / Architecture

### Description
The Empty Portal. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Mandatory Portal

### Category
Design / Architecture

### Description
The Mandatory Portal. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Backstage Black Hole

### Category
Design / Architecture

### Description
The Backstage Black Hole. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Custom Plugin Graveyard

### Category
Design / Architecture

### Description
The Custom Plugin Graveyard. This pattern violates best practices and introduces technical debt that compounds over time.
