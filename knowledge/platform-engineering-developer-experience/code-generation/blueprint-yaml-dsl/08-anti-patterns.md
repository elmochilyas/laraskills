...
4. Relationship Over-Inference
5. Draft as Afterthought
...
## Anti-Pattern 1: DSL Complexity

### Category
Design / Architecture

### Description
DSL Complexity. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No Validation CI

### Category
Design / Architecture

### Description
No Validation CI. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Inconsistent Column Naming

### Category
Design / Architecture

### Description
Inconsistent Column Naming. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Relationship Over-Inference

### Category
Design / Architecture

### Description
Relationship Over-Inference. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Draft as Afterthought

### Category
Design / Architecture

### Description
Draft as Afterthought. This pattern violates best practices and introduces technical debt that compounds over time.
