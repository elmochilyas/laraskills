...
1. Installer on Existing Projects
2. No Flags in Scripts
3. Skipping Post-Creation Steps
4. Ignoring PHP Extensions
5. Outdated Installer
...
## Anti-Pattern 1: Installer on Existing Projects

### Category
Design / Architecture

### Description
Installer on Existing Projects. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No Flags in Scripts

### Category
Design / Architecture

### Description
No Flags in Scripts. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Skipping Post-Creation Steps

### Category
Design / Architecture

### Description
Skipping Post-Creation Steps. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Ignoring PHP Extensions

### Category
Design / Architecture

### Description
Ignoring PHP Extensions. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Outdated Installer

### Category
Design / Architecture

### Description
Outdated Installer. This pattern violates best practices and introduces technical debt that compounds over time.
