...
1. Too Many Generators
2. Stub Sprawl
3. Rigid Generators
4. Unregistered Commands
5. Static Stubs Never Updated
...
## Anti-Pattern 1: Too Many Generators

### Category
Design / Architecture

### Description
Too Many Generators. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Stub Sprawl

### Category
Design / Architecture

### Description
Stub Sprawl. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Rigid Generators

### Category
Design / Architecture

### Description
Rigid Generators. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Unregistered Commands

### Category
Design / Architecture

### Description
Unregistered Commands. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Static Stubs Never Updated

### Category
Design / Architecture

### Description
Static Stubs Never Updated. This pattern violates best practices and introduces technical debt that compounds over time.
