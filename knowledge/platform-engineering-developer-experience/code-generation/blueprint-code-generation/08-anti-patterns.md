...
2. Draft as Documentation Only
3. Ignoring Tests
4. One Giant Draft
5. Forced Blueprint Fit
...
## Anti-Pattern 1: Complete Automation

### Category
Design / Architecture

### Description
Complete Automation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Draft as Documentation Only

### Category
Design / Architecture

### Description
Draft as Documentation Only. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Ignoring Tests. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: One Giant Draft

### Category
Design / Architecture

### Description
One Giant Draft. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Forced Blueprint Fit

### Category
Design / Architecture

### Description
Forced Blueprint Fit. This pattern violates best practices and introduces technical debt that compounds over time.
