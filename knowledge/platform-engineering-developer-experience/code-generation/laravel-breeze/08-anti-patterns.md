...
1. Breeze on Existing Apps
2. Skipping Asset Compilation
3. Over-Customization of Auth
...
## Anti-Pattern 1: Breeze on Existing Apps

### Category
Design / Architecture

### Description
Breeze on Existing Apps. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Skipping Asset Compilation

### Category
Design / Architecture

### Description
Skipping Asset Compilation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Over-Customization of Auth

### Category
Design / Architecture

### Description
Over-Customization of Auth. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Ignoring Generated Tests

### Category
Design / Architecture

### Description
Ignoring Generated Tests. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Stack Regret

### Category
Design / Architecture

### Description
Stack Regret. This pattern violates best practices and introduces technical debt that compounds over time.
