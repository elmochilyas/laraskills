...
1. Jetstream for Everything
2. No Team Scoping
3. Direct Database Manipulation
4. Over-Customization
5. Ignoring Upgrade Path
...
## Anti-Pattern 1: Jetstream for Everything

### Category
Design / Architecture

### Description
Jetstream for Everything. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No Team Scoping

### Category
Design / Architecture

### Description
No Team Scoping. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Direct Database Manipulation

### Category
Design / Architecture

### Description
Direct Database Manipulation. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Over-Customization. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Ignoring Upgrade Path

### Category
Design / Architecture

### Description
Ignoring Upgrade Path. This pattern violates best practices and introduces technical debt that compounds over time.
