...
1. The Encyclopedia
2. The Style Guide Only
3. The Opinionated Gospel
...
### Description
The Encyclopedia. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Style Guide Only

### Category
Design / Architecture

### Description
The Style Guide Only. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Opinionated Gospel

### Category
Design / Architecture

### Description
The Opinionated Gospel. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Frozen Document

### Category
Design / Architecture

### Description
The Frozen Document. This pattern violates best practices and introduces technical debt that compounds over time.
