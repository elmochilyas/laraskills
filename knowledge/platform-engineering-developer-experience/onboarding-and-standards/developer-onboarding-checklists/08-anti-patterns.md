...
1. The Firehose Checklist
2. The HR Checklist Only
3. The Read-Only Checklist
4. The Forgotten Checklist
...
## Anti-Pattern 1: The Firehose Checklist

### Category
Design / Architecture

### Description
The Firehose Checklist. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The HR Checklist Only

### Category
Design / Architecture

### Description
The HR Checklist Only. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Read-Only Checklist

### Category
Design / Architecture

### Description
The Read-Only Checklist. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Forgotten Checklist

### Category
Design / Architecture

### Description
The Forgotten Checklist. This pattern violates best practices and introduces technical debt that compounds over time.
