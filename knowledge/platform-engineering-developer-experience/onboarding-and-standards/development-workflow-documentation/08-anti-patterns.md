...
1. The Free-for-All
2. The Ticket-Before-Deployment
3. The Manual Deployment Playbook
4. The QA-Bottleneck
...
## Anti-Pattern 1: The Free-for-All

### Category
Design / Architecture

### Description
The Free-for-All. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Ticket-Before-Deployment

### Category
Design / Architecture

### Description
The Ticket-Before-Deployment. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Manual Deployment Playbook

### Category
Design / Architecture

### Description
The Manual Deployment Playbook. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The QA-Bottleneck

### Category
Design / Architecture

### Description
The QA-Bottleneck. This pattern violates best practices and introduces technical debt that compounds over time.
