...
1. The Silent Script
2. The Fragile Script
3. The Monolith Script
4. The Untested Script
5. The Manual-Equivalent Script
...
## Anti-Pattern 1: The Silent Script

### Category
Design / Architecture

### Description
The Silent Script. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Fragile Script

### Category
Design / Architecture

### Description
The Fragile Script. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Monolith Script

### Category
Design / Architecture

### Description
The Monolith Script. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Untested Script

### Category
Design / Architecture

### Description
The Untested Script. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: The Manual-Equivalent Script

### Category
Design / Architecture

### Description
The Manual-Equivalent Script. This pattern violates best practices and introduces technical debt that compounds over time.
