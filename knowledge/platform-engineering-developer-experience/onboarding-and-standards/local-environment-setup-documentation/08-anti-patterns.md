...
1. The One-Paragraph Setup
2. The Mac-Only Guide
3. The Outdated Screenshot Guide
4. The Untested Setup Guide
...
## Anti-Pattern 1: The One-Paragraph Setup

### Category
Design / Architecture

### Description
The One-Paragraph Setup. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Mac-Only Guide

### Category
Design / Architecture

### Description
The Mac-Only Guide. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Outdated Screenshot Guide

### Category
Design / Architecture

### Description
The Outdated Screenshot Guide. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Untested Setup Guide

### Category
Design / Architecture

### Description
The Untested Setup Guide. This pattern violates best practices and introduces technical debt that compounds over time.
