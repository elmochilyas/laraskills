...
1. Production Tinker Sessions
2. Bulk Data Operations
3. Session Dependency
4. Unlimited Result Sets
5. Skipping Eager Loading
...
## Anti-Pattern 1: Production Tinker Sessions

### Category
Design / Architecture

### Description
Production Tinker Sessions. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Bulk Data Operations

### Category
Design / Architecture

### Description
Bulk Data Operations. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Session Dependency

### Category
Design / Architecture

### Description
Session Dependency. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Unlimited Result Sets

### Category
Design / Architecture

### Description
Unlimited Result Sets. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Skipping Eager Loading

### Category
Design / Architecture

### Description
Skipping Eager Loading. This pattern violates best practices and introduces technical debt that compounds over time.
