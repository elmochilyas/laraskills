...
2. Prompt Without Validation
3. Repeated Confirmation
4. Sensitive Echo
5. Nested Interactive Chains
...
## Anti-Pattern 1: Required Interaction

### Category
Design / Architecture

### Description
Required Interaction. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Prompt Without Validation

### Category
Design / Architecture

### Description
Prompt Without Validation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Repeated Confirmation

### Category
Design / Architecture

### Description
Repeated Confirmation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Sensitive Echo

### Category
Design / Architecture

### Description
Sensitive Echo. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Nested Interactive Chains

### Category
Design / Architecture

### Description
Nested Interactive Chains. This pattern violates best practices and introduces technical debt that compounds over time.
