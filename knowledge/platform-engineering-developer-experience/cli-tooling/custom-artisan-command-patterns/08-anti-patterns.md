...
## Anti-Pattern 1: God Command

### Category
Design / Architecture

### Description
God Command. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Silent Failure. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Echo Overload

### Category
Design / Architecture

### Description
Echo Overload. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Tight Coupling. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Unsafe Production Commands

### Category
Design / Architecture

### Description
Unsafe Production Commands. This pattern violates best practices and introduces technical debt that compounds over time.
