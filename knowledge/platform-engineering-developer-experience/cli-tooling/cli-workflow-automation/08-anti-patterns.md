...
### Description
Monolithic Script. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No Rollback

### Category
Design / Architecture

### Description
No Rollback. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Environment Assumptions

### Category
Design / Architecture

### Description
Environment Assumptions. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Blind Parallelism

### Category
Design / Architecture

### Description
Blind Parallelism. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Output Ignorance

### Category
Design / Architecture

### Description
Output Ignorance. This pattern violates best practices and introduces technical debt that compounds over time.
