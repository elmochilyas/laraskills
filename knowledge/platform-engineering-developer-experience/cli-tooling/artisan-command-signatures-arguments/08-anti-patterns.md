...
2. Brittle Regex
3. Dynamic Argument Meaning
4. Empty Descriptions
5. Positional Breaking Changes
...
## Anti-Pattern 1: Signature Overload

### Category
Design / Architecture

### Description
Signature Overload. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Brittle Regex

### Category
Design / Architecture

### Description
Brittle Regex. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Dynamic Argument Meaning

### Category
Design / Architecture

### Description
Dynamic Argument Meaning. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Empty Descriptions

### Category
Design / Architecture

### Description
Empty Descriptions. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Positional Breaking Changes

### Category
Design / Architecture

### Description
Positional Breaking Changes. This pattern violates best practices and introduces technical debt that compounds over time.
