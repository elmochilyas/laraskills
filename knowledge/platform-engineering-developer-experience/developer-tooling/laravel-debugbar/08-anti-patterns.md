...
1. Permanent full capture
2. Debugbar as primary debugging tool for complex issues
...
## Anti-Pattern 1: Permanent full capture

### Category
Design / Architecture

### Description
Permanent full capture. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Debugbar as primary debugging tool for complex issues

### Category
Design / Architecture

### Description
Debugbar as primary debugging tool for complex issues. This pattern violates best practices and introduces technical debt that compounds over time.
