...
## Anti-Pattern 1: Skipping Pulse

### Category
Design / Architecture

### Description
Skipping Pulse. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Alert fatigue. This pattern violates best practices and introduces technical debt that compounds over time.
