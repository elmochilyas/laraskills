...
1. Logging as debugging
2. Same format everywhere
...
## Anti-Pattern 1: Logging as debugging

### Category
Design / Architecture

### Description
Logging as debugging. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Same format everywhere

### Category
Design / Architecture

### Description
Same format everywhere. This pattern violates best practices and introduces technical debt that compounds over time.
