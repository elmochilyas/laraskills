...
1. Using Pulse for debugging
2. Pulse without scheduler
...
## Anti-Pattern 1: Using Pulse for debugging

### Category
Design / Architecture

### Description
Using Pulse for debugging. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Pulse without scheduler

### Category
Design / Architecture

### Description
Pulse without scheduler. This pattern violates best practices and introduces technical debt that compounds over time.
