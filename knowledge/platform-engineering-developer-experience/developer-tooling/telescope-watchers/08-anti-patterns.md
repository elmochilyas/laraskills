...
1. Full capture as default
2. Ignoring request size limits
...
## Anti-Pattern 1: Full capture as default

### Category
Design / Architecture

### Description
Full capture as default. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Ignoring request size limits

### Category
Design / Architecture

### Description
Ignoring request size limits. This pattern violates best practices and introduces technical debt that compounds over time.
