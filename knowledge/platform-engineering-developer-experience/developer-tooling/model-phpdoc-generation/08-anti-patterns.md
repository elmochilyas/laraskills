...
1. Generating once and never updating
2. Without Doctrine DBAL
...
## Anti-Pattern 1: Generating once and never updating

### Category
Design / Architecture

### Description
Generating once and never updating. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Without Doctrine DBAL

### Category
Design / Architecture

### Description
Without Doctrine DBAL. This pattern violates best practices and introduces technical debt that compounds over time.
