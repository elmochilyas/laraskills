...
1. Mailpit as production mail server
2. Ignoring Mailpit in automated tests
...
## Anti-Pattern 1: Mailpit as production mail server

### Category
Design / Architecture

### Description
Mailpit as production mail server. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Ignoring Mailpit in automated tests

### Category
Design / Architecture

### Description
Ignoring Mailpit in automated tests. This pattern violates best practices and introduces technical debt that compounds over time.
