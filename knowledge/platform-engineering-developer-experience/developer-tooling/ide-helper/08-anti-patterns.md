...
1. Manual PHPDoc editing
2. Skipping meta generation
...
## Anti-Pattern 1: Manual PHPDoc editing

### Category
Design / Architecture

### Description
Manual PHPDoc editing. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Skipping meta generation

### Category
Design / Architecture

### Description
Skipping meta generation. This pattern violates best practices and introduces technical debt that compounds over time.
