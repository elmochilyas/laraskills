...
1. Custom card as mini-application
2. Recording from multiple sources without coordination
...
## Anti-Pattern 1: Custom card as mini-application

### Category
Design / Architecture

### Description
Custom card as mini-application. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Recording from multiple sources without coordination

### Category
Design / Architecture

### Description
Recording from multiple sources without coordination. This pattern violates best practices and introduces technical debt that compounds over time.
