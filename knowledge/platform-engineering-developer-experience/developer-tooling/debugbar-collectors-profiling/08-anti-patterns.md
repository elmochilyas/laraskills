...
1. Permanent Debugbar in staging
2. Over-collecting
...
## Anti-Pattern 1: Permanent Debugbar in staging

### Category
Design / Architecture

### Description
Permanent Debugbar in staging. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Over-collecting

### Category
Design / Architecture

### Description
Over-collecting. This pattern violates best practices and introduces technical debt that compounds over time.
