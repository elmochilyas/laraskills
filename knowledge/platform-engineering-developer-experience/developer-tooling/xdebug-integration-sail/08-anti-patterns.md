...
1. Xdebug as primary debugging tool for all issues
2. Profiling in development as default
...
## Anti-Pattern 1: Xdebug as primary debugging tool for all issues

### Category
Design / Architecture

### Description
Xdebug as primary debugging tool for all issues. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Profiling in development as default

### Category
Design / Architecture

### Description
Profiling in development as default. This pattern violates best practices and introduces technical debt that compounds over time.
