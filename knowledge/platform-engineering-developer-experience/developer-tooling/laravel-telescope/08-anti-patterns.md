...
1. Telescope as real-time monitor
...
## Anti-Pattern 1: Telescope as real-time monitor

### Category
Design / Architecture

### Description
Telescope as real-time monitor. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Unlimited retention

### Category
Design / Architecture

### Description
Unlimited retention. This pattern violates best practices and introduces technical debt that compounds over time.
