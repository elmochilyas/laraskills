...
1. Using MinIO for production storage
2. Storing production-like PII in MinIO
...
## Anti-Pattern 1: Using MinIO for production storage

### Category
Design / Architecture

### Description
Using MinIO for production storage. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Storing production-like PII in MinIO

### Category
Design / Architecture

### Description
Storing production-like PII in MinIO. This pattern violates best practices and introduces technical debt that compounds over time.
