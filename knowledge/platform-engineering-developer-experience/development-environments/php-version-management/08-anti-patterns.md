...
1. Latest PHP for all projects
2. Ignoring composer PHP constraints
...
## Anti-Pattern 1: Latest PHP for all projects

### Category
Design / Architecture

### Description
Latest PHP for all projects. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Ignoring composer PHP constraints

### Category
Design / Architecture

### Description
Ignoring composer PHP constraints. This pattern violates best practices and introduces technical debt that compounds over time.
