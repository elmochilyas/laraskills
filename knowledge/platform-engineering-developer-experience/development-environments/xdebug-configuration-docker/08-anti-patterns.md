...
1. Leaving debug mode on constantly
2. Xdebug for all debugging
...
## Anti-Pattern 1: Leaving debug mode on constantly

### Category
Design / Architecture

### Description
Leaving debug mode on constantly. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Xdebug for all debugging

### Category
Design / Architecture

### Description
Xdebug for all debugging. This pattern violates best practices and introduces technical debt that compounds over time.
