...
1. Mailpit as production email server
2. Skipping production email verification
...
## Anti-Pattern 1: Mailpit as production email server

### Category
Design / Architecture

### Description
Mailpit as production email server. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Skipping production email verification

### Category
Design / Architecture

### Description
Skipping production email verification. This pattern violates best practices and introduces technical debt that compounds over time.
