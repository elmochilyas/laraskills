...
1. Maintaining devcontainer separately from Sail
2. Prod-like security in dev container
...
## Anti-Pattern 1: Maintaining devcontainer separately from Sail

### Category
Design / Architecture

### Description
Maintaining devcontainer separately from Sail. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Prod-like security in dev container

### Category
Design / Architecture

### Description
Prod-like security in dev container. This pattern violates best practices and introduces technical debt that compounds over time.
