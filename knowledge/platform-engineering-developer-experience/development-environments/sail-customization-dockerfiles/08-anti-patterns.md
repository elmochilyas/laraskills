...
1. Overloading the PHP container
2. Unpublished customization
...
## Anti-Pattern 1: Overloading the PHP container

### Category
Design / Architecture

### Description
Overloading the PHP container. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Unpublished customization

### Category
Design / Architecture

### Description
Unpublished customization. This pattern violates best practices and introduces technical debt that compounds over time.
