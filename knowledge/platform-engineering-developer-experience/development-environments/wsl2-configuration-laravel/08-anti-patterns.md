...
1. Editing WSL2 files from Windows apps
2. Running Sail from Windows drive
...
## Anti-Pattern 1: Editing WSL2 files from Windows apps

### Category
Design / Architecture

### Description
Editing WSL2 files from Windows apps. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Running Sail from Windows drive

### Category
Design / Architecture

### Description
Running Sail from Windows drive. This pattern violates best practices and introduces technical debt that compounds over time.
