...
1. Hard-coding secrets in config files
2. Multiple .env files in production
...
## Anti-Pattern 1: Hard-coding secrets in config files

### Category
Design / Architecture

### Description
Hard-coding secrets in config files. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Multiple .env files in production

### Category
Design / Architecture

### Description
Multiple .env files in production. This pattern violates best practices and introduces technical debt that compounds over time.
