...
## Anti-Pattern 1: Production Compose file

### Category
Design / Architecture

### Description
Production Compose file. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Single-container everything

### Category
Design / Architecture

### Description
Single-container everything. This pattern violates best practices and introduces technical debt that compounds over time.
