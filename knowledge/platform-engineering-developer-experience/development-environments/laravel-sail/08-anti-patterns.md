...
1. Sail in production
2. Full Sail for simple projects
...
## Anti-Pattern 1: Sail in production

### Category
Design / Architecture

### Description
Sail in production. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Full Sail for simple projects

### Category
Design / Architecture

### Description
Full Sail for simple projects. This pattern violates best practices and introduces technical debt that compounds over time.
