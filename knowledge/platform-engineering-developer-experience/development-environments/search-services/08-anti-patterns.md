...
1. Using Sail Meilisearch in production
2. Ignoring search in CI
...
## Anti-Pattern 1: Using Sail Meilisearch in production

### Category
Design / Architecture

### Description
Using Sail Meilisearch in production. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Ignoring search in CI

### Category
Design / Architecture

### Description
Ignoring search in CI. This pattern violates best practices and introduces technical debt that compounds over time.
