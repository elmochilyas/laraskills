...
1. File cache in multi-container setups
2. Ignoring queue worker
...
## Anti-Pattern 1: File cache in multi-container setups

### Category
Design / Architecture

### Description
File cache in multi-container setups. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Ignoring queue worker

### Category
Design / Architecture

### Description
Ignoring queue worker. This pattern violates best practices and introduces technical debt that compounds over time.
