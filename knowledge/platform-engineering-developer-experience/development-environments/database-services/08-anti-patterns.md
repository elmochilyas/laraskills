...
1. Running migrations on production from local
2. Sharing one dev database across the team
...
## Anti-Pattern 1: Running migrations on production from local

### Category
Design / Architecture

### Description
Running migrations on production from local. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Sharing one dev database across the team

### Category
Design / Architecture

### Description
Sharing one dev database across the team. This pattern violates best practices and introduces technical debt that compounds over time.
