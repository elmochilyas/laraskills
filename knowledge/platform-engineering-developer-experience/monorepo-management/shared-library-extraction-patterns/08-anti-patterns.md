...
1. The Grand Unified Library
2. The Copy-Paste Library
3. The Abandoned Extraction
4. The Business Logic Library
5. The YAGNI Interface
...
## Anti-Pattern 1: The Grand Unified Library

### Category
Design / Architecture

### Description
The Grand Unified Library. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Copy-Paste Library

### Category
Design / Architecture

### Description
The Copy-Paste Library. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Abandoned Extraction

### Category
Design / Architecture

### Description
The Abandoned Extraction. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Business Logic Library

### Category
Design / Architecture

### Description
The Business Logic Library. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: The YAGNI Interface

### Category
Design / Architecture

### Description
The YAGNI Interface. This pattern violates best practices and introduces technical debt that compounds over time.
