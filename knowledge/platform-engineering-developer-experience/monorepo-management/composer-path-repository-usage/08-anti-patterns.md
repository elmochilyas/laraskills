...
1. The Production Path Repo
2. The Symlink Sprawl
3. The Ignored Lock File
4. The Frozen Dependency
...
## Anti-Pattern 1: The Production Path Repo

### Category
Design / Architecture

### Description
The Production Path Repo. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Symlink Sprawl

### Category
Design / Architecture

### Description
The Symlink Sprawl. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Ignored Lock File

### Category
Design / Architecture

### Description
The Ignored Lock File. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Frozen Dependency

### Category
Design / Architecture

### Description
The Frozen Dependency. This pattern violates best practices and introduces technical debt that compounds over time.
