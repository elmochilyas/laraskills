...
1. The Split-on-Push Pipeline
2. The Untested Split
3. The Snowflake Split Repo
4. The Manual Split Process
5. The Split-and-Forget
...
## Anti-Pattern 1: The Split-on-Push Pipeline

### Category
Design / Architecture

### Description
The Split-on-Push Pipeline. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Untested Split

### Category
Design / Architecture

### Description
The Untested Split. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Snowflake Split Repo

### Category
Design / Architecture

### Description
The Snowflake Split Repo. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Manual Split Process

### Category
Design / Architecture

### Description
The Manual Split Process. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: The Split-and-Forget

### Category
Design / Architecture

### Description
The Split-and-Forget. This pattern violates best practices and introduces technical debt that compounds over time.
