...
1. The Full Suite on Every Commit
2. The No-Cache Pipeline
3. The False Negative Machine
4. The Hidden Failure
...
## Anti-Pattern 1: The Full Suite on Every Commit

### Category
Design / Architecture

### Description
The Full Suite on Every Commit. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The No-Cache Pipeline

### Category
Design / Architecture

### Description
The No-Cache Pipeline. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The False Negative Machine

### Category
Design / Architecture

### Description
The False Negative Machine. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Hidden Failure

### Category
Design / Architecture

### Description
The Hidden Failure. This pattern violates best practices and introduces technical debt that compounds over time.
