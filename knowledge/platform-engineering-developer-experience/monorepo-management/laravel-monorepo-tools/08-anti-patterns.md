...
1. The Monolith Monorepo
2. The Git Graveyard
3. The Split-Free Monorepo
4. The Manual Split
...
## Anti-Pattern 1: The Monolith Monorepo

### Category
Design / Architecture

### Description
The Monolith Monorepo. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: The Git Graveyard

### Category
Design / Architecture

### Description
The Git Graveyard. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: The Split-Free Monorepo

### Category
Design / Architecture

### Description
The Split-Free Monorepo. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: The Manual Split

### Category
Design / Architecture

### Description
The Manual Split. This pattern violates best practices and introduces technical debt that compounds over time.
