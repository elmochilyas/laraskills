...
1. Doing everything in boot()
2. Giant provider classes
3. Ignoring deferred providers
4. Runtime logic in register()
5. Manual provider registration insistence
...
## Anti-Pattern 1: Doing everything in boot()

### Category
Design / Architecture

### Description
Doing everything in boot(). This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Giant provider classes

### Category
Design / Architecture

### Description
Giant provider classes. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Ignoring deferred providers

### Category
Design / Architecture

### Description
Ignoring deferred providers. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Runtime logic in register()

### Category
Design / Architecture

### Description
Runtime logic in register(). This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Manual provider registration insistence

### Category
Design / Architecture

### Description
Manual provider registration insistence. This pattern violates best practices and introduces technical debt that compounds over time.
