...
1. Only publishable, no automatic loading
2. Modifying published migrations in package updates
3. No down() method
4. One giant migration file
5. Foreign keys across packages
...
## Anti-Pattern 1: Only publishable, no automatic loading

### Category
Design / Architecture

### Description
Only publishable, no automatic loading. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Modifying published migrations in package updates

### Category
Design / Architecture

### Description
Modifying published migrations in package updates. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No down() method

### Category
Design / Architecture

### Description
No down() method. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
One giant migration file. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Foreign keys across packages

### Category
Design / Architecture

### Description
Foreign keys across packages. This pattern violates best practices and introduces technical debt that compounds over time.
