...
2. Changing namespace between versions
3. Overly deep namespaces
4. Namespace overloading
5. Ignoring Spatie tools
...
## Anti-Pattern 2: Changing namespace between versions

### Category
Design / Architecture

### Description
Changing namespace between versions. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Overly deep namespaces

### Category
Design / Architecture

### Description
Overly deep namespaces. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Namespace overloading

### Category
Design / Architecture

### Description
Namespace overloading. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Ignoring Spatie tools

### Category
Design / Architecture

### Description
Ignoring Spatie tools. This pattern violates best practices and introduces technical debt that compounds over time.
