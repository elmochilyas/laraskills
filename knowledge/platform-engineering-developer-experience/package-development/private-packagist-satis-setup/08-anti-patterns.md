...
1. Using path repositories for distribution
2. No authentication for Satis
3. Ignoring private registry in CI
4. Over-relying on public Packagist for internal packages
5. Not maintaining composer.lock when using private registries
...
## Anti-Pattern 1: Using path repositories for distribution

### Category
Design / Architecture

### Description
Using path repositories for distribution. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No authentication for Satis

### Category
Design / Architecture

### Description
No authentication for Satis. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Ignoring private registry in CI

### Category
Design / Architecture

### Description
Ignoring private registry in CI. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Over-relying on public Packagist for internal packages

### Category
Design / Architecture

### Description
Over-relying on public Packagist for internal packages. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Not maintaining composer.lock when using private registries

### Category
Design / Architecture

### Description
Not maintaining composer.lock when using private registries. This pattern violates best practices and introduces technical debt that compounds over time.
