...
1. Disabling auto-discovery globally
2. Manual registration for every package
3. Relying on auto-discovery for boot order
4. Dev-only packages without environment guards
...
## Anti-Pattern 1: Disabling auto-discovery globally

### Category
Design / Architecture

### Description
Disabling auto-discovery globally. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Manual registration for every package

### Category
Design / Architecture

### Description
Manual registration for every package. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Relying on auto-discovery for boot order

### Category
Design / Architecture

### Description
Relying on auto-discovery for boot order. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Dev-only packages without environment guards

### Category
Design / Architecture

### Description
Dev-only packages without environment guards. This pattern violates best practices and introduces technical debt that compounds over time.
