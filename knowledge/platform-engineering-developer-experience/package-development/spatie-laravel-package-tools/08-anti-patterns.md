...
1. Custom provider base class for every package
2. Bypassing the DSL for simple registration
3. Ignoring version compatibility
4. Overriding the specification processing
...
## Anti-Pattern 1: Custom provider base class for every package

### Category
Design / Architecture

### Description
Custom provider base class for every package. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Bypassing the DSL for simple registration

### Category
Design / Architecture

### Description
Bypassing the DSL for simple registration. This pattern violates best practices and introduces technical debt that compounds over time.
...
### Description
Ignoring version compatibility. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Overriding the specification processing

### Category
Design / Architecture

### Description
Overriding the specification processing. This pattern violates best practices and introduces technical debt that compounds over time.
