...
2. No view namespace registration for class components
3. Overriding component classes
4. Deep directory structure for anonymous components
5. One namespace for everything
...
## Anti-Pattern 1: Global component registration

### Category
Design / Architecture

### Description
Global component registration. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No view namespace registration for class components

### Category
Design / Architecture

### Description
No view namespace registration for class components. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Overriding component classes

### Category
Design / Architecture

### Description
Overriding component classes. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Deep directory structure for anonymous components

### Category
Design / Architecture

### Description
Deep directory structure for anonymous components. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: One namespace for everything

### Category
Design / Architecture

### Description
One namespace for everything. This pattern violates best practices and introduces technical debt that compounds over time.
