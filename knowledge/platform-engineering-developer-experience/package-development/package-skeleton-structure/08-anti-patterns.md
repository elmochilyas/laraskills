...
1. Ignoring the skeleton entirely
2. Deep nesting in src/
3. Monorepo forced into single skeleton
4. Over-customizing the skeleton
...
## Anti-Pattern 1: Ignoring the skeleton entirely

### Category
Design / Architecture

### Description
Ignoring the skeleton entirely. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Deep nesting in src/

### Category
Design / Architecture

### Description
Deep nesting in src/. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Monorepo forced into single skeleton

### Category
Design / Architecture

### Description
Monorepo forced into single skeleton. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Over-customizing the skeleton

### Category
Design / Architecture

### Description
Over-customizing the skeleton. This pattern violates best practices and introduces technical debt that compounds over time.
