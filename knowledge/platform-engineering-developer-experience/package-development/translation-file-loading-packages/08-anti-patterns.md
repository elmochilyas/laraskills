...
1. No translation support
2. Global namespace translations
3. One giant translation file
4. Translation as configuration
5. Skipping fallback locale
...
## Anti-Pattern 1: No translation support

### Category
Design / Architecture

### Description
No translation support. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Global namespace translations

### Category
Design / Architecture

### Description
Global namespace translations. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: One giant translation file

### Category
Design / Architecture

### Description
One giant translation file. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Translation as configuration

### Category
Design / Architecture

### Description
Translation as configuration. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Skipping fallback locale

### Category
Design / Architecture

### Description
Skipping fallback locale. This pattern violates best practices and introduces technical debt that compounds over time.
