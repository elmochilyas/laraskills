...
1. SemVer as marketing
2. Major version churn
...
## Anti-Pattern 1: SemVer as marketing

### Category
Design / Architecture

### Description
SemVer as marketing. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Major version churn

### Category
Design / Architecture

### Description
Major version churn. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: No version constraints

### Category
Design / Architecture

### Description
No version constraints. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Silent breaking changes

### Category
Design / Architecture

### Description
Silent breaking changes. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Version tag drift

### Category
Design / Architecture

### Description
Version tag drift. This pattern violates best practices and introduces technical debt that compounds over time.
