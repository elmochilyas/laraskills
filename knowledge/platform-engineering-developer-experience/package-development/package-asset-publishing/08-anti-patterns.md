...
1. Publishing everything from vendor
2. No pre-built option
3. Inconsistent asset directory naming
4. Versioning in file names only
5. One asset file for everything
...
## Anti-Pattern 1: Publishing everything from vendor

### Category
Design / Architecture

### Description
Publishing everything from vendor. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No pre-built option

### Category
Design / Architecture

### Description
No pre-built option. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Inconsistent asset directory naming

### Category
Design / Architecture

### Description
Inconsistent asset directory naming. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: Versioning in file names only

### Category
Design / Architecture

### Description
Versioning in file names only. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: One asset file for everything

### Category
Design / Architecture

### Description
One asset file for everything. This pattern violates best practices and introduces technical debt that compounds over time.
