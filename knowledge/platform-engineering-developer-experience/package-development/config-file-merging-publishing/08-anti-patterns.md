...
1. Config as documentation
2. No defaults, all options required
3. Publishing everything
4. env() in business logic
5. Deeply nested config arrays
...
## Anti-Pattern 1: Config as documentation

### Category
Design / Architecture

### Description
Config as documentation. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: No defaults, all options required

### Category
Design / Architecture

### Description
No defaults, all options required. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Publishing everything

### Category
Design / Architecture

### Description
Publishing everything. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: env() in business logic

### Category
Design / Architecture

### Description
env() in business logic. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 5: Deeply nested config arrays

### Category
Design / Architecture

### Description
Deeply nested config arrays. This pattern violates best practices and introduces technical debt that compounds over time.
