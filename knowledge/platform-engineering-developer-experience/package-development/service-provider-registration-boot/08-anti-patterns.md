...
1. Everything in boot()
2. Constructor injection in providers
3. Deferred providers with boot() logic
4. register() as initialization
...
## Anti-Pattern 1: Everything in boot()

### Category
Design / Architecture

### Description
Everything in boot(). This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 2: Constructor injection in providers

### Category
Design / Architecture

### Description
Constructor injection in providers. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 3: Deferred providers with boot() logic

### Category
Design / Architecture

### Description
Deferred providers with boot() logic. This pattern violates best practices and introduces technical debt that compounds over time.
...
## Anti-Pattern 4: register() as initialization

### Category
Design / Architecture

### Description
register() as initialization. This pattern violates best practices and introduces technical debt that compounds over time.
