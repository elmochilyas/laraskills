# Skill: Configure and Implement Meilisearch Setup

## Purpose

Set up and configure Meilisearch Setup for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Meilisearch Setup in a production Laravel application
- When optimizing or hardening Meilisearch Setup for operational use
...
1. Install the required package or extension for Meilisearch Setup via Composer or system package manager
...
- Monitor and Maintain Meilisearch Setup

## Success Criteria

- Meilisearch Setup configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Meilisearch Setup Production Search

## Purpose

Tune Meilisearch Setup for production workloads including performance optimization, monitoring, and maintenance operations.
