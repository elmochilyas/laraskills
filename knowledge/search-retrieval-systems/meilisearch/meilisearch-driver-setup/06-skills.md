# Skill: Configure and Implement Meilisearch Driver Setup

## Purpose

Set up and configure Meilisearch Driver Setup for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Meilisearch Driver Setup in a production Laravel application
- When optimizing or hardening Meilisearch Driver Setup for operational use
...
1. Install the required package or extension for Meilisearch Driver Setup via Composer or system package manager
...
- Monitor and Maintain Meilisearch Driver Setup

## Success Criteria

- Meilisearch Driver Setup configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Meilisearch Driver Setup Production Search

## Purpose

Tune Meilisearch Driver Setup for production workloads including performance optimization, monitoring, and maintenance operations.
