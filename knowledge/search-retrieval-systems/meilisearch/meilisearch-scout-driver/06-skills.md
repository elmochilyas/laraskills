# Skill: Configure and Implement Meilisearch Scout Driver

## Purpose

Set up and configure Meilisearch Scout Driver for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Meilisearch Scout Driver in a production Laravel application
- When optimizing or hardening Meilisearch Scout Driver for operational use
...
1. Install the required package or extension for Meilisearch Scout Driver via Composer or system package manager
...
- Monitor and Maintain Meilisearch Scout Driver

## Success Criteria

- Meilisearch Scout Driver configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Meilisearch Scout Driver Production Search

## Purpose

Tune Meilisearch Scout Driver for production workloads including performance optimization, monitoring, and maintenance operations.
