# Skill: Configure and Implement Learning To Rank

## Purpose

Set up and configure Learning To Rank for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Learning To Rank in a production Laravel application
- When optimizing or hardening Learning To Rank for operational use
...
1. Install the required package or extension for Learning To Rank via Composer or system package manager
...
- Configure and Implement Learning To Rank
- Monitor and Maintain Learning To Rank

## Success Criteria

- Learning To Rank configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Learning To Rank Production Search

## Purpose

Tune Learning To Rank for production workloads including performance optimization, monitoring, and maintenance operations.
