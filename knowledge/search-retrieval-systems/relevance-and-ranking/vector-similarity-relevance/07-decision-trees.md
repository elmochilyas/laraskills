...
When implementing Vector Similarity Relevance, you must decide which relevance factors to prioritize and how to configure ranking.
...
When implementing Vector Similarity Relevance, you must choose between BM25 keyword relevance and vector similarity for ranking search results.
...
When implementing Vector Similarity Relevance, you must decide whether to use cross-encoder reranking to improve result relevance.
