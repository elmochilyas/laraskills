# Skill: Configure and Implement Vector Similarity Relevance

## Purpose

Set up and configure Vector Similarity Relevance for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Vector Similarity Relevance in a production Laravel application
- When optimizing or hardening Vector Similarity Relevance for operational use
...
1. Install the required package or extension for Vector Similarity Relevance via Composer or system package manager
...
- Configure and Implement Vector Similarity Relevance
- Monitor and Maintain Vector Similarity Relevance

## Success Criteria

- Vector Similarity Relevance configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Vector Similarity Relevance Production Search

## Purpose

Tune Vector Similarity Relevance for production workloads including performance optimization, monitoring, and maintenance operations.
