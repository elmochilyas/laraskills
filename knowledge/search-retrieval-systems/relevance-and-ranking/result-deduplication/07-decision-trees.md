...
When implementing Result Deduplication, you must decide which relevance factors to prioritize and how to configure ranking.
...
When implementing Result Deduplication, you must choose between BM25 keyword relevance and vector similarity for ranking search results.
...
When implementing Result Deduplication, you must decide whether to use cross-encoder reranking to improve result relevance.
