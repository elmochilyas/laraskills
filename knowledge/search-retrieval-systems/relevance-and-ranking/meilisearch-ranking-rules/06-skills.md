# Skill: Configure and Implement Meilisearch Ranking Rules

## Purpose

Set up and configure Meilisearch Ranking Rules for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Meilisearch Ranking Rules in a production Laravel application
- When optimizing or hardening Meilisearch Ranking Rules for operational use
...
1. Install the required package or extension for Meilisearch Ranking Rules via Composer or system package manager
...
- Configure and Implement Meilisearch Ranking Rules
- Monitor and Maintain Meilisearch Ranking Rules

## Success Criteria

- Meilisearch Ranking Rules configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Meilisearch Ranking Rules Production Search

## Purpose

Tune Meilisearch Ranking Rules for production workloads including performance optimization, monitoring, and maintenance operations.
