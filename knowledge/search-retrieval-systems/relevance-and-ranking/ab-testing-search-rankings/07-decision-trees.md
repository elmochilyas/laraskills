...
**Knowledge Unit:** A/B Testing Search Rankings
...
When implementing A/B Testing Search Rankings, you must decide which relevance factors to prioritize and how to configure ranking.
...
- Configure and Implement A/B Testing Search Rankings
...
When implementing A/B Testing Search Rankings, you must choose between BM25 keyword relevance and vector similarity for ranking search results.
...
When implementing A/B Testing Search Rankings, you must decide whether to use cross-encoder reranking to improve result relevance.
