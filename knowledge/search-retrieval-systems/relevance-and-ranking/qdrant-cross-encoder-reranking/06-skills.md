# Skill: Configure and Implement Qdrant Cross Encoder Reranking

## Purpose

Set up and configure Qdrant Cross Encoder Reranking for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Qdrant Cross Encoder Reranking in a production Laravel application
- When optimizing or hardening Qdrant Cross Encoder Reranking for operational use
...
1. Install the required package or extension for Qdrant Cross Encoder Reranking via Composer or system package manager
...
- Configure and Implement Qdrant Cross Encoder Reranking
- Monitor and Maintain Qdrant Cross Encoder Reranking

## Success Criteria

- Qdrant Cross Encoder Reranking configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Qdrant Cross Encoder Reranking Production Search

## Purpose

Tune Qdrant Cross Encoder Reranking for production workloads including performance optimization, monitoring, and maintenance operations.
