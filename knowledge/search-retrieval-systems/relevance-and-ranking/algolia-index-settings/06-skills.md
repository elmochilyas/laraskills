# Skill: Configure and Implement Algolia Index Settings

## Purpose

Set up and configure Algolia Index Settings for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Algolia Index Settings in a production Laravel application
- When optimizing or hardening Algolia Index Settings for operational use
...
1. Install the required package or extension for Algolia Index Settings via Composer or system package manager
...
- Configure and Implement Algolia Index Settings
- Monitor and Maintain Algolia Index Settings

## Success Criteria

- Algolia Index Settings configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Algolia Index Settings Production Search

## Purpose

Tune Algolia Index Settings for production workloads including performance optimization, monitoring, and maintenance operations.
