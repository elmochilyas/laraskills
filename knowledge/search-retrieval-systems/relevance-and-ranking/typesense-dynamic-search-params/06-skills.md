# Skill: Configure and Implement Typesense Dynamic Search Params

## Purpose

Set up and configure Typesense Dynamic Search Params for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Typesense Dynamic Search Params in a production Laravel application
- When optimizing or hardening Typesense Dynamic Search Params for operational use
...
1. Install the required package or extension for Typesense Dynamic Search Params via Composer or system package manager
...
- Configure and Implement Typesense Dynamic Search Params
- Monitor and Maintain Typesense Dynamic Search Params

## Success Criteria

- Typesense Dynamic Search Params configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Typesense Dynamic Search Params Production Search

## Purpose

Tune Typesense Dynamic Search Params for production workloads including performance optimization, monitoring, and maintenance operations.
