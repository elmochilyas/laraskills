# Skill: Configure and Implement Faceted Search

## Purpose

Set up and configure Faceted Search for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Faceted Search in a production Laravel application
- When optimizing or hardening Faceted Search for operational use
...
1. Install the required package or extension for Faceted Search via Composer or system package manager
...
- Configure and Implement Faceted Search
- Monitor and Maintain Faceted Search

## Success Criteria

- Faceted Search configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Faceted Search Production Search

## Purpose

Tune Faceted Search for production workloads including performance optimization, monitoring, and maintenance operations.
