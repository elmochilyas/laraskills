# Skill: Configure and Implement Personalized Ranking

## Purpose

Set up and configure Personalized Ranking for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Personalized Ranking in a production Laravel application
- When optimizing or hardening Personalized Ranking for operational use
...
1. Install the required package or extension for Personalized Ranking via Composer or system package manager
...
- Configure and Implement Personalized Ranking
- Monitor and Maintain Personalized Ranking

## Success Criteria

- Personalized Ranking configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Personalized Ranking Production Search

## Purpose

Tune Personalized Ranking for production workloads including performance optimization, monitoring, and maintenance operations.
