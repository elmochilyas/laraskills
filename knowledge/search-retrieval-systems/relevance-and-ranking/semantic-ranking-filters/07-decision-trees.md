...
When implementing Semantic Ranking Filters, you must decide which relevance factors to prioritize and how to configure ranking.
...
When implementing Semantic Ranking Filters, you must choose between BM25 keyword relevance and vector similarity for ranking search results.
...
When implementing Semantic Ranking Filters, you must decide whether to use cross-encoder reranking to improve result relevance.
