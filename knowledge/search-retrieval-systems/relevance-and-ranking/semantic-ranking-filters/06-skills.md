# Skill: Configure and Implement Semantic Ranking Filters

## Purpose

Set up and configure Semantic Ranking Filters for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Semantic Ranking Filters in a production Laravel application
- When optimizing or hardening Semantic Ranking Filters for operational use
...
1. Install the required package or extension for Semantic Ranking Filters via Composer or system package manager
...
- Configure and Implement Semantic Ranking Filters
- Monitor and Maintain Semantic Ranking Filters

## Success Criteria

- Semantic Ranking Filters configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Semantic Ranking Filters Production Search

## Purpose

Tune Semantic Ranking Filters for production workloads including performance optimization, monitoring, and maintenance operations.
