# Skill: Configure and Implement Algolia Ab Testing

## Purpose

Set up and configure Algolia Ab Testing for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Algolia Ab Testing in a production Laravel application
- When optimizing or hardening Algolia Ab Testing for operational use
...
1. Install the required package or extension for Algolia Ab Testing via Composer or system package manager
...
- Configure and Implement Algolia Ab Testing
- Monitor and Maintain Algolia Ab Testing

## Success Criteria

- Algolia Ab Testing configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Algolia Ab Testing Production Search

## Purpose

Tune Algolia Ab Testing for production workloads including performance optimization, monitoring, and maintenance operations.
