# Skill: Configure and Implement Meilisearch Custom Ranking

## Purpose

Set up and configure Meilisearch Custom Ranking for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Meilisearch Custom Ranking in a production Laravel application
- When optimizing or hardening Meilisearch Custom Ranking for operational use
...
1. Install the required package or extension for Meilisearch Custom Ranking via Composer or system package manager
...
- Configure and Implement Meilisearch Custom Ranking
- Monitor and Maintain Meilisearch Custom Ranking

## Success Criteria

- Meilisearch Custom Ranking configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Meilisearch Custom Ranking Production Search

## Purpose

Tune Meilisearch Custom Ranking for production workloads including performance optimization, monitoring, and maintenance operations.
