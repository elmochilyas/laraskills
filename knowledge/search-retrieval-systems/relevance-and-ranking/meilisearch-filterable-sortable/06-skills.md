# Skill: Configure and Implement Meilisearch Filterable Sortable

## Purpose

Set up and configure Meilisearch Filterable Sortable for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Meilisearch Filterable Sortable in a production Laravel application
- When optimizing or hardening Meilisearch Filterable Sortable for operational use
...
1. Install the required package or extension for Meilisearch Filterable Sortable via Composer or system package manager
...
- Configure and Implement Meilisearch Filterable Sortable
- Monitor and Maintain Meilisearch Filterable Sortable

## Success Criteria

- Meilisearch Filterable Sortable configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Meilisearch Filterable Sortable Production Search

## Purpose

Tune Meilisearch Filterable Sortable for production workloads including performance optimization, monitoring, and maintenance operations.
