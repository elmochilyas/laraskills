# Skill: Configure and Implement Sqlite Fts5

## Purpose

Set up and configure Sqlite Fts5 for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Sqlite Fts5 in a production Laravel application
- When optimizing or hardening Sqlite Fts5 for operational use
...
1. Install the required package or extension for Sqlite Fts5 via Composer or system package manager
...
- Configure and Implement Sqlite Fts5
- Monitor and Maintain Sqlite Fts5

## Success Criteria

- Sqlite Fts5 configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Sqlite Fts5 Production Search

## Purpose

Tune Sqlite Fts5 for production workloads including performance optimization, monitoring, and maintenance operations.
