...
**Knowledge Unit:** Mysql Full-Text Search
...
When implementing Mysql Full-Text Search, you must decide whether to use the built-in database full-text search or migrate to a dedicated search appliance.
...
- Follow Best Practices for Mysql Full-Text Search

### Related Skills

- Configure and Implement Mysql Full-Text Search
...
When implementing Mysql Full-Text Search, you must choose between SQL FULLTEXT indexes and simple LIKE/prefix searches for text matching.
...
When configuring Mysql Full-Text Search with Laravel Scout, you must decide between the database engine and the collection engine.
