# Skill: Configure and Implement Mysql Full Text

## Purpose

Set up and configure Mysql Full Text for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Mysql Full Text in a production Laravel application
- When optimizing or hardening Mysql Full Text for operational use
...
1. Install the required package or extension for Mysql Full Text via Composer or system package manager
...
- Configure and Implement Mysql Full Text
- Monitor and Maintain Mysql Full Text

## Success Criteria

- Mysql Full Text configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Mysql Full Text Production Search

## Purpose

Tune Mysql Full Text for production workloads including performance optimization, monitoring, and maintenance operations.
