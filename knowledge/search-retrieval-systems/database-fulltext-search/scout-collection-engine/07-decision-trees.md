...
When implementing Scout Collection Engine, you must decide whether to use the built-in database full-text search or migrate to a dedicated search appliance.
...
- Follow Best Practices for Scout Collection Engine
...
When implementing Scout Collection Engine, you must choose between SQL FULLTEXT indexes and simple LIKE/prefix searches for text matching.
...
When configuring Scout Collection Engine with Laravel Scout, you must decide between the database engine and the collection engine.
