# Skill: Configure and Implement Scout Collection Engine

## Purpose

Set up and configure Scout Collection Engine for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Scout Collection Engine in a production Laravel application
- When optimizing or hardening Scout Collection Engine for operational use
...
1. Install the required package or extension for Scout Collection Engine via Composer or system package manager
...
- Configure and Implement Scout Collection Engine
- Monitor and Maintain Scout Collection Engine

## Success Criteria

- Scout Collection Engine configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Scout Collection Engine Production Search

## Purpose

Tune Scout Collection Engine for production workloads including performance optimization, monitoring, and maintenance operations.
