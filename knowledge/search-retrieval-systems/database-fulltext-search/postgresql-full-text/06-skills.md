# Skill: Configure and Implement Postgresql Full Text

## Purpose

Set up and configure Postgresql Full Text for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Postgresql Full Text in a production Laravel application
- When optimizing or hardening Postgresql Full Text for operational use
...
1. Install the required package or extension for Postgresql Full Text via Composer or system package manager
...
- Configure and Implement Postgresql Full Text
- Monitor and Maintain Postgresql Full Text

## Success Criteria

- Postgresql Full Text configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Postgresql Full Text Production Search

## Purpose

Tune Postgresql Full Text for production workloads including performance optimization, monitoring, and maintenance operations.
