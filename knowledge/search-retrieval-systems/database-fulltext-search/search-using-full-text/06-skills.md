# Skill: Configure and Implement Search Using Full Text

## Purpose

Set up and configure Search Using Full Text for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Search Using Full Text in a production Laravel application
- When optimizing or hardening Search Using Full Text for operational use
...
1. Install the required package or extension for Search Using Full Text via Composer or system package manager
...
- Configure and Implement Search Using Full Text
- Monitor and Maintain Search Using Full Text

## Success Criteria

- Search Using Full Text configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Search Using Full Text Production Search

## Purpose

Tune Search Using Full Text for production workloads including performance optimization, monitoring, and maintenance operations.
