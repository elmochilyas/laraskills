# Skill: Configure and Implement Database Full Text Vs Dedicated

## Purpose

Set up and configure Database Full Text Vs Dedicated for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Database Full Text Vs Dedicated in a production Laravel application
- When optimizing or hardening Database Full Text Vs Dedicated for operational use
...
1. Install the required package or extension for Database Full Text Vs Dedicated via Composer or system package manager
...
- Follow engine-specific configuration best practices

## Related Skills

- Configure and Implement Database Full Text Vs Dedicated
- Monitor and Maintain Database Full Text Vs Dedicated

## Success Criteria

- Database Full Text Vs Dedicated configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Database Full Text Vs Dedicated Production Search

## Purpose

Tune Database Full Text Vs Dedicated for production workloads including performance optimization, monitoring, and maintenance operations.
...
- Monitor search performance and index health regularly
