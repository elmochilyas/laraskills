# Skill: Configure and Implement Search Using Prefix

## Purpose

Set up and configure Search Using Prefix for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Search Using Prefix in a production Laravel application
- When optimizing or hardening Search Using Prefix for operational use
...
1. Install the required package or extension for Search Using Prefix via Composer or system package manager
...
- Configure and Implement Search Using Prefix
- Monitor and Maintain Search Using Prefix

## Success Criteria

- Search Using Prefix configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Search Using Prefix Production Search

## Purpose

Tune Search Using Prefix for production workloads including performance optimization, monitoring, and maintenance operations.
