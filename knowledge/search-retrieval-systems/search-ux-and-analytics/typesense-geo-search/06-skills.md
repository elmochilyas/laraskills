# Skill: Configure and Implement Typesense Geo Search

## Purpose

Set up and configure Typesense Geo Search for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Typesense Geo Search in a production Laravel application
- When optimizing or hardening Typesense Geo Search for operational use
...
1. Install the required package or extension for Typesense Geo Search via Composer or system package manager
...
- Configure and Implement Typesense Geo Search
- Monitor and Maintain Typesense Geo Search

## Success Criteria

- Typesense Geo Search configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Typesense Geo Search Production Search

## Purpose

Tune Typesense Geo Search for production workloads including performance optimization, monitoring, and maintenance operations.
