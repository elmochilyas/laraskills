# Skill: Configure and Implement Instant Search Alpine

## Purpose

Set up and configure Instant Search Alpine for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Instant Search Alpine in a production Laravel application
- When optimizing or hardening Instant Search Alpine for operational use
...
1. Install the required package or extension for Instant Search Alpine via Composer or system package manager
...
- Configure and Implement Instant Search Alpine
- Monitor and Maintain Instant Search Alpine

## Success Criteria

- Instant Search Alpine configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Instant Search Alpine Production Search

## Purpose

Tune Instant Search Alpine for production workloads including performance optimization, monitoring, and maintenance operations.
