# Skill: Configure and Implement Instant Search Livewire

## Purpose

Set up and configure Instant Search Livewire for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Instant Search Livewire in a production Laravel application
- When optimizing or hardening Instant Search Livewire for operational use
...
1. Install the required package or extension for Instant Search Livewire via Composer or system package manager
...
- Configure and Implement Instant Search Livewire
- Monitor and Maintain Instant Search Livewire

## Success Criteria

- Instant Search Livewire configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Instant Search Livewire Production Search

## Purpose

Tune Instant Search Livewire for production workloads including performance optimization, monitoring, and maintenance operations.
