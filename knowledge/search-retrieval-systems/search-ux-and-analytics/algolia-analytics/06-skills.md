# Skill: Configure and Implement Algolia Analytics

## Purpose

Set up and configure Algolia Analytics for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Algolia Analytics in a production Laravel application
- When optimizing or hardening Algolia Analytics for operational use
...
1. Install the required package or extension for Algolia Analytics via Composer or system package manager
...
- Configure and Implement Algolia Analytics
- Monitor and Maintain Algolia Analytics

## Success Criteria

- Algolia Analytics configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Algolia Analytics Production Search

## Purpose

Tune Algolia Analytics for production workloads including performance optimization, monitoring, and maintenance operations.
