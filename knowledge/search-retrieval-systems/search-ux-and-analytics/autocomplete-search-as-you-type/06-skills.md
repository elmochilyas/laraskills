# Skill: Configure and Implement Autocomplete Search As You Type

## Purpose

Set up and configure Autocomplete Search As You Type for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Autocomplete Search As You Type in a production Laravel application
- When optimizing or hardening Autocomplete Search As You Type for operational use
...
1. Install the required package or extension for Autocomplete Search As You Type via Composer or system package manager
...
- Configure and Implement Autocomplete Search As You Type
- Monitor and Maintain Autocomplete Search As You Type

## Success Criteria

- Autocomplete Search As You Type configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Autocomplete Search As You Type Production Search

## Purpose

Tune Autocomplete Search As You Type for production workloads including performance optimization, monitoring, and maintenance operations.
