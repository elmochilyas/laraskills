# Skill: Configure and Implement Search Query Caching

## Purpose

Set up and configure Search Query Caching for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Search Query Caching in a production Laravel application
- When optimizing or hardening Search Query Caching for operational use
...
1. Install the required package or extension for Search Query Caching via Composer or system package manager
...
- Configure and Implement Search Query Caching
- Monitor and Maintain Search Query Caching

## Success Criteria

- Search Query Caching configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Search Query Caching Production Search

## Purpose

Tune Search Query Caching for production workloads including performance optimization, monitoring, and maintenance operations.
