# Skill: Configure and Implement Search Performance Benchmarking

## Purpose

Set up and configure Search Performance Benchmarking for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Search Performance Benchmarking in a production Laravel application
- When optimizing or hardening Search Performance Benchmarking for operational use
...
1. Install the required package or extension for Search Performance Benchmarking via Composer or system package manager
...
- Configure and Implement Search Performance Benchmarking
- Monitor and Maintain Search Performance Benchmarking

## Success Criteria

- Search Performance Benchmarking configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Search Performance Benchmarking Production Search

## Purpose

Tune Search Performance Benchmarking for production workloads including performance optimization, monitoring, and maintenance operations.
