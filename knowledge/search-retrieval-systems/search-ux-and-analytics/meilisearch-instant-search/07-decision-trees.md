...
**Knowledge Unit:** Meilisearch Search-As-You-Type
...
When implementing Meilisearch Search-As-You-Type, you must decide which search user experience pattern best fits your application needs.
...
- Configure and Implement Meilisearch Search-As-You-Type
...
When implementing Meilisearch Search-As-You-Type, you must decide which attributes to make filterable and how to present facets to users.
...
When implementing Meilisearch Search-As-You-Type, you must decide how to track search performance, user behavior, and system health.
