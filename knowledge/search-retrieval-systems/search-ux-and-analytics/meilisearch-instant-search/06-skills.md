# Skill: Configure and Implement Meilisearch Instant Search

## Purpose

Set up and configure Meilisearch Instant Search for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Meilisearch Instant Search in a production Laravel application
- When optimizing or hardening Meilisearch Instant Search for operational use
...
1. Install the required package or extension for Meilisearch Instant Search via Composer or system package manager
...
- Configure and Implement Meilisearch Instant Search
- Monitor and Maintain Meilisearch Instant Search

## Success Criteria

- Meilisearch Instant Search configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Meilisearch Instant Search Production Search

## Purpose

Tune Meilisearch Instant Search for production workloads including performance optimization, monitoring, and maintenance operations.
