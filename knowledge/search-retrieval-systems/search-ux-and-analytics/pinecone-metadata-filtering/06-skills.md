# Skill: Configure and Implement Pinecone Metadata Filtering

## Purpose

Set up and configure Pinecone Metadata Filtering for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Pinecone Metadata Filtering in a production Laravel application
- When optimizing or hardening Pinecone Metadata Filtering for operational use
...
1. Install the required package or extension for Pinecone Metadata Filtering via Composer or system package manager
...
- Configure and Implement Pinecone Metadata Filtering
- Monitor and Maintain Pinecone Metadata Filtering

## Success Criteria

- Pinecone Metadata Filtering configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Pinecone Metadata Filtering Production Search

## Purpose

Tune Pinecone Metadata Filtering for production workloads including performance optimization, monitoring, and maintenance operations.
