...
**Knowledge Unit:** Search A/B Testing
...
When implementing Search A/B Testing, you must decide which search user experience pattern best fits your application needs.
...
- Configure and Implement Search A/B Testing
...
When implementing Search A/B Testing, you must decide which attributes to make filterable and how to present facets to users.
...
When implementing Search A/B Testing, you must decide how to track search performance, user behavior, and system health.
