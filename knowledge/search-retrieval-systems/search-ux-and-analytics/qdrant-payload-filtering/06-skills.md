# Skill: Configure and Implement Qdrant Payload Filtering

## Purpose

Set up and configure Qdrant Payload Filtering for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Qdrant Payload Filtering in a production Laravel application
- When optimizing or hardening Qdrant Payload Filtering for operational use
...
1. Install the required package or extension for Qdrant Payload Filtering via Composer or system package manager
...
- Monitor and Maintain Qdrant Payload Filtering

## Success Criteria

- Qdrant Payload Filtering configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Qdrant Payload Filtering Production Search

## Purpose

Tune Qdrant Payload Filtering for production workloads including performance optimization, monitoring, and maintenance operations.
