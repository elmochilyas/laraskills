# Skill: Configure and Implement Search Result Highlighting

## Purpose

Set up and configure Search Result Highlighting for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Search Result Highlighting in a production Laravel application
- When optimizing or hardening Search Result Highlighting for operational use
...
1. Install the required package or extension for Search Result Highlighting via Composer or system package manager
...
- Configure and Implement Search Result Highlighting
- Monitor and Maintain Search Result Highlighting

## Success Criteria

- Search Result Highlighting configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Search Result Highlighting Production Search

## Purpose

Tune Search Result Highlighting for production workloads including performance optimization, monitoring, and maintenance operations.
