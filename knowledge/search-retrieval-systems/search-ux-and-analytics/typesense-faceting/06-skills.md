# Skill: Configure and Implement Typesense Faceting

## Purpose

Set up and configure Typesense Faceting for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Typesense Faceting in a production Laravel application
- When optimizing or hardening Typesense Faceting for operational use
...
1. Install the required package or extension for Typesense Faceting via Composer or system package manager
...
- Configure and Implement Typesense Faceting
- Monitor and Maintain Typesense Faceting

## Success Criteria

- Typesense Faceting configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Typesense Faceting Production Search

## Purpose

Tune Typesense Faceting for production workloads including performance optimization, monitoring, and maintenance operations.
