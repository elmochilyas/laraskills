# Skill: Configure and Implement Meilisearch Faceted Search

## Purpose

Set up and configure Meilisearch Faceted Search for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Meilisearch Faceted Search in a production Laravel application
- When optimizing or hardening Meilisearch Faceted Search for operational use
...
1. Install the required package or extension for Meilisearch Faceted Search via Composer or system package manager
...
- Configure and Implement Meilisearch Faceted Search
- Monitor and Maintain Meilisearch Faceted Search

## Success Criteria

- Meilisearch Faceted Search configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Meilisearch Faceted Search Production Search

## Purpose

Tune Meilisearch Faceted Search for production workloads including performance optimization, monitoring, and maintenance operations.
