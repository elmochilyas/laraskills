# Skill: Configure and Implement Algolia Geo Search

## Purpose

Set up and configure Algolia Geo Search for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Algolia Geo Search in a production Laravel application
- When optimizing or hardening Algolia Geo Search for operational use
...
1. Install the required package or extension for Algolia Geo Search via Composer or system package manager
...
- Configure and Implement Algolia Geo Search
- Monitor and Maintain Algolia Geo Search

## Success Criteria

- Algolia Geo Search configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Algolia Geo Search Production Search

## Purpose

Tune Algolia Geo Search for production workloads including performance optimization, monitoring, and maintenance operations.
