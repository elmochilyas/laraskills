# Skill: Configure and Implement Search Performance Monitoring

## Purpose

Set up and configure Search Performance Monitoring for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Search Performance Monitoring in a production Laravel application
- When optimizing or hardening Search Performance Monitoring for operational use
...
1. Install the required package or extension for Search Performance Monitoring via Composer or system package manager
...
- Configure and Implement Search Performance Monitoring
- Monitor and Maintain Search Performance Monitoring

## Success Criteria

- Search Performance Monitoring configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Search Performance Monitoring Production Search

## Purpose

Tune Search Performance Monitoring for production workloads including performance optimization, monitoring, and maintenance operations.
