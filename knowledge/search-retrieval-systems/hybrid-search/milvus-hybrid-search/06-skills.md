# Skill: Configure and Implement Milvus Hybrid Search

## Purpose

Set up and configure Milvus Hybrid Search for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Milvus Hybrid Search in a production Laravel application
- When optimizing or hardening Milvus Hybrid Search for operational use
...
1. Install the required package or extension for Milvus Hybrid Search via Composer or system package manager
...
- Configure and Implement Milvus Hybrid Search
- Monitor and Maintain Milvus Hybrid Search

## Success Criteria

- Milvus Hybrid Search configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Milvus Hybrid Search Production Search

## Purpose

Tune Milvus Hybrid Search for production workloads including performance optimization, monitoring, and maintenance operations.
