# Skill: Configure and Implement Weighted Hybrid Scoring

## Purpose

Set up and configure Weighted Hybrid Scoring for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Weighted Hybrid Scoring in a production Laravel application
- When optimizing or hardening Weighted Hybrid Scoring for operational use
...
1. Install the required package or extension for Weighted Hybrid Scoring via Composer or system package manager
...
- Configure and Implement Weighted Hybrid Scoring
- Monitor and Maintain Weighted Hybrid Scoring

## Success Criteria

- Weighted Hybrid Scoring configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Weighted Hybrid Scoring Production Search

## Purpose

Tune Weighted Hybrid Scoring for production workloads including performance optimization, monitoring, and maintenance operations.
