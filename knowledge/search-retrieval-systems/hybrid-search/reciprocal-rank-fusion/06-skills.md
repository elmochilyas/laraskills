# Skill: Configure and Implement Reciprocal Rank Fusion

## Purpose

Set up and configure Reciprocal Rank Fusion for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Reciprocal Rank Fusion in a production Laravel application
- When optimizing or hardening Reciprocal Rank Fusion for operational use
...
1. Install the required package or extension for Reciprocal Rank Fusion via Composer or system package manager
...
- Configure and Implement Reciprocal Rank Fusion
- Monitor and Maintain Reciprocal Rank Fusion

## Success Criteria

- Reciprocal Rank Fusion configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Reciprocal Rank Fusion Production Search

## Purpose

Tune Reciprocal Rank Fusion for production workloads including performance optimization, monitoring, and maintenance operations.
