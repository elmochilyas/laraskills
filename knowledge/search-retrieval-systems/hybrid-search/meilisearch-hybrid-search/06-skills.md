# Skill: Configure and Implement Meilisearch Hybrid Search

## Purpose

Set up and configure Meilisearch Hybrid Search for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Meilisearch Hybrid Search in a production Laravel application
- When optimizing or hardening Meilisearch Hybrid Search for operational use
...
1. Install the required package or extension for Meilisearch Hybrid Search via Composer or system package manager
...
- Configure and Implement Meilisearch Hybrid Search
- Monitor and Maintain Meilisearch Hybrid Search

## Success Criteria

- Meilisearch Hybrid Search configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Meilisearch Hybrid Search Production Search

## Purpose

Tune Meilisearch Hybrid Search for production workloads including performance optimization, monitoring, and maintenance operations.
