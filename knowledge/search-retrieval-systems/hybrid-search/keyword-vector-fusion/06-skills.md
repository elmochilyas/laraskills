# Skill: Configure and Implement Keyword Vector Fusion

## Purpose

Set up and configure Keyword Vector Fusion for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Keyword Vector Fusion in a production Laravel application
- When optimizing or hardening Keyword Vector Fusion for operational use
...
1. Install the required package or extension for Keyword Vector Fusion via Composer or system package manager
...
- Configure and Implement Keyword Vector Fusion
- Monitor and Maintain Keyword Vector Fusion

## Success Criteria

- Keyword Vector Fusion configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Keyword Vector Fusion Production Search

## Purpose

Tune Keyword Vector Fusion for production workloads including performance optimization, monitoring, and maintenance operations.
