# Skill: Configure and Implement Qdrant Hybrid Queries

## Purpose

Set up and configure Qdrant Hybrid Queries for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Qdrant Hybrid Queries in a production Laravel application
- When optimizing or hardening Qdrant Hybrid Queries for operational use
...
1. Install the required package or extension for Qdrant Hybrid Queries via Composer or system package manager
...
- Configure and Implement Qdrant Hybrid Queries
- Monitor and Maintain Qdrant Hybrid Queries

## Success Criteria

- Qdrant Hybrid Queries configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Qdrant Hybrid Queries Production Search

## Purpose

Tune Qdrant Hybrid Queries for production workloads including performance optimization, monitoring, and maintenance operations.
