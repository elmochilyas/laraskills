# Skill: Configure and Implement Pgvector Fts Hybrid

## Purpose

Set up and configure Pgvector Fts Hybrid for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Pgvector Fts Hybrid in a production Laravel application
- When optimizing or hardening Pgvector Fts Hybrid for operational use
...
1. Install the required package or extension for Pgvector Fts Hybrid via Composer or system package manager
...
- Configure and Implement Pgvector Fts Hybrid
- Monitor and Maintain Pgvector Fts Hybrid

## Success Criteria

- Pgvector Fts Hybrid configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Pgvector Fts Hybrid Production Search

## Purpose

Tune Pgvector Fts Hybrid for production workloads including performance optimization, monitoring, and maintenance operations.
