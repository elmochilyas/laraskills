# Skill: Configure and Implement Model Observer Indexing

## Purpose

Set up and configure Model Observer Indexing for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Model Observer Indexing in a production Laravel application
- When optimizing or hardening Model Observer Indexing for operational use
...
1. Install the required package or extension for Model Observer Indexing via Composer or system package manager
...
- Configure and Implement Model Observer Indexing
- Monitor and Maintain Model Observer Indexing

## Success Criteria

- Model Observer Indexing configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Model Observer Indexing Production Search

## Purpose

Tune Model Observer Indexing for production workloads including performance optimization, monitoring, and maintenance operations.
