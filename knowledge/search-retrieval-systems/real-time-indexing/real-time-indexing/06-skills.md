# Skill: Configure and Implement Real Time Indexing

## Purpose

Set up and configure Real Time Indexing for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Real Time Indexing in a production Laravel application
- When optimizing or hardening Real Time Indexing for operational use
...
1. Install the required package or extension for Real Time Indexing via Composer or system package manager
...
- Configure and Implement Real Time Indexing
- Monitor and Maintain Real Time Indexing

## Success Criteria

- Real Time Indexing configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Real Time Indexing Production Search

## Purpose

Tune Real Time Indexing for production workloads including performance optimization, monitoring, and maintenance operations.
