# Skill: Configure and Implement Algolia Setup

## Purpose

Set up and configure Algolia Setup for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Algolia Setup in a production Laravel application
- When optimizing or hardening Algolia Setup for operational use
...
1. Install the required package or extension for Algolia Setup via Composer or system package manager
...
- Configure and Implement Algolia Setup
- Monitor and Maintain Algolia Setup

## Success Criteria

- Algolia Setup configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Algolia Setup Production Search

## Purpose

Tune Algolia Setup for production workloads including performance optimization, monitoring, and maintenance operations.
