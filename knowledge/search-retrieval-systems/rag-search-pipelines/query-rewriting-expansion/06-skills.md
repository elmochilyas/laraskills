# Skill: Configure and Implement Query Rewriting Expansion

## Purpose

Set up and configure Query Rewriting Expansion for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Query Rewriting Expansion in a production Laravel application
- When optimizing or hardening Query Rewriting Expansion for operational use
...
1. Install the required package or extension for Query Rewriting Expansion via Composer or system package manager
...
- Monitor and Maintain Query Rewriting Expansion

## Success Criteria

- Query Rewriting Expansion configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Query Rewriting Expansion Production Search

## Purpose

Tune Query Rewriting Expansion for production workloads including performance optimization, monitoring, and maintenance operations.
