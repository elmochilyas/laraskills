# Skill: Configure and Implement Rag Evaluation Metrics

## Purpose

Set up and configure Rag Evaluation Metrics for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Rag Evaluation Metrics in a production Laravel application
- When optimizing or hardening Rag Evaluation Metrics for operational use
...
1. Install the required package or extension for Rag Evaluation Metrics via Composer or system package manager
...
- Configure and Implement Rag Evaluation Metrics
- Monitor and Maintain Rag Evaluation Metrics

## Success Criteria

- Rag Evaluation Metrics configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Rag Evaluation Metrics Production Search

## Purpose

Tune Rag Evaluation Metrics for production workloads including performance optimization, monitoring, and maintenance operations.
