# Skill: Configure and Implement Embedding Generation Strategies

## Purpose

Set up and configure Embedding Generation Strategies for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Embedding Generation Strategies in a production Laravel application
- When optimizing or hardening Embedding Generation Strategies for operational use
...
1. Install the required package or extension for Embedding Generation Strategies via Composer or system package manager
...
- Configure and Implement Embedding Generation Strategies
- Monitor and Maintain Embedding Generation Strategies

## Success Criteria

- Embedding Generation Strategies configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Embedding Generation Strategies Production Search

## Purpose

Tune Embedding Generation Strategies for production workloads including performance optimization, monitoring, and maintenance operations.
