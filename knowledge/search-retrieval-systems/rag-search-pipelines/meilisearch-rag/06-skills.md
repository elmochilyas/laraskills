# Skill: Configure and Implement Meilisearch Rag

## Purpose

Set up and configure Meilisearch Rag for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Meilisearch Rag in a production Laravel application
- When optimizing or hardening Meilisearch Rag for operational use
...
1. Install the required package or extension for Meilisearch Rag via Composer or system package manager
...
- Configure and Implement Meilisearch Rag
- Monitor and Maintain Meilisearch Rag

## Success Criteria

- Meilisearch Rag configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Meilisearch Rag Production Search

## Purpose

Tune Meilisearch Rag for production workloads including performance optimization, monitoring, and maintenance operations.
