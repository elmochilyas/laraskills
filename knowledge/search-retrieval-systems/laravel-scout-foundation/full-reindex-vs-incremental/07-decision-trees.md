...
**Knowledge Unit:** Full Re-Index Vs Incremental
...
When implementing Full Re-Index Vs Incremental in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Full Re-Index Vs Incremental

### Related Skills

- Configure and Implement Full Re-Index Vs Incremental
...
When configuring Full Re-Index Vs Incremental, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Full Re-Index Vs Incremental, you must decide between synchronous (immediate) or queue-based (async) index updates.
