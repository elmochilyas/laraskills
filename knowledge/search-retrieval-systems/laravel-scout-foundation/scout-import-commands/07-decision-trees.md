...
When implementing Scout Import Commands in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Scout Import Commands
...
When configuring Scout Import Commands, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Scout Import Commands, you must decide between synchronous (immediate) or queue-based (async) index updates.
