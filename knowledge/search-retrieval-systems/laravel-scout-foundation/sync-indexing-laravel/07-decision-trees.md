...
**Knowledge Unit:** Sync Indexing In Laravel
...
When implementing Sync Indexing In Laravel in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Sync Indexing In Laravel

### Related Skills

- Configure and Implement Sync Indexing In Laravel
...
When configuring Sync Indexing In Laravel, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Sync Indexing In Laravel, you must decide between synchronous (immediate) or queue-based (async) index updates.
