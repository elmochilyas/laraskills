...
When implementing Scout:Import / Scout:Flush in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Scout:Import / Scout:Flush

### Related Skills

- Configure and Implement Scout:Import / Scout:Flush
...
When configuring Scout:Import / Scout:Flush, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Scout:Import / Scout:Flush, you must decide between synchronous (immediate) or queue-based (async) index updates.
