# Skill: Configure and Implement Scout Import Flush

## Purpose

Set up and configure Scout Import Flush for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Scout Import Flush in a production Laravel application
- When optimizing or hardening Scout Import Flush for operational use
...
1. Install the required package or extension for Scout Import Flush via Composer or system package manager
...
- Configure and Implement Scout Import Flush
- Monitor and Maintain Scout Import Flush

## Success Criteria

- Scout Import Flush configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Scout Import Flush Production Search

## Purpose

Tune Scout Import Flush for production workloads including performance optimization, monitoring, and maintenance operations.
