...
When implementing Index Schema Design in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Index Schema Design
...
When configuring Index Schema Design, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Index Schema Design, you must decide between synchronous (immediate) or queue-based (async) index updates.
