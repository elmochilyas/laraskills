# Skill: Configure and Implement Should Be Searchable

## Purpose

Set up and configure Should Be Searchable for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Should Be Searchable in a production Laravel application
- When optimizing or hardening Should Be Searchable for operational use
...
1. Install the required package or extension for Should Be Searchable via Composer or system package manager
...
- Configure and Implement Should Be Searchable
- Monitor and Maintain Should Be Searchable

## Success Criteria

- Should Be Searchable configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Should Be Searchable Production Search

## Purpose

Tune Should Be Searchable for production workloads including performance optimization, monitoring, and maintenance operations.
