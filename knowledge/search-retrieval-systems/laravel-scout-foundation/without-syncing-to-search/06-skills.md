# Skill: Configure and Implement Without Syncing To Search

## Purpose

Set up and configure Without Syncing To Search for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Without Syncing To Search in a production Laravel application
- When optimizing or hardening Without Syncing To Search for operational use
...
1. Install the required package or extension for Without Syncing To Search via Composer or system package manager
...
- Configure and Implement Without Syncing To Search
- Monitor and Maintain Without Syncing To Search

## Success Criteria

- Without Syncing To Search configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Without Syncing To Search Production Search

## Purpose

Tune Without Syncing To Search for production workloads including performance optimization, monitoring, and maintenance operations.
