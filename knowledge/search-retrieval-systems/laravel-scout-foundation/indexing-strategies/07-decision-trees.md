...
When implementing Indexing Strategies in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Indexing Strategies
...
When configuring Indexing Strategies, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Indexing Strategies, you must decide between synchronous (immediate) or queue-based (async) index updates.
