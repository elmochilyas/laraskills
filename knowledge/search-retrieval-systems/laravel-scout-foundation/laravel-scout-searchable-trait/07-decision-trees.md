...
When implementing Laravel Scout Searchable Trait in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Laravel Scout Searchable Trait
...
When configuring Laravel Scout Searchable Trait, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Laravel Scout Searchable Trait, you must decide between synchronous (immediate) or queue-based (async) index updates.
