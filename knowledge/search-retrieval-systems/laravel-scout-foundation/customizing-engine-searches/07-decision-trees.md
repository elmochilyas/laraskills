...
When implementing Customizing Engine Searches in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Customizing Engine Searches
...
When configuring Customizing Engine Searches, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Customizing Engine Searches, you must decide between synchronous (immediate) or queue-based (async) index updates.
