# Skill: Configure and Implement Customizing Engine Searches

## Purpose

Set up and configure Customizing Engine Searches for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Customizing Engine Searches in a production Laravel application
- When optimizing or hardening Customizing Engine Searches for operational use
...
1. Install the required package or extension for Customizing Engine Searches via Composer or system package manager
...
- Configure and Implement Customizing Engine Searches
- Monitor and Maintain Customizing Engine Searches

## Success Criteria

- Customizing Engine Searches configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Customizing Engine Searches Production Search

## Purpose

Tune Customizing Engine Searches for production workloads including performance optimization, monitoring, and maintenance operations.
