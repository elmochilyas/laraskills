...
When implementing Scout Searchable Trait in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Scout Searchable Trait
...
When configuring Scout Searchable Trait, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Scout Searchable Trait, you must decide between synchronous (immediate) or queue-based (async) index updates.
