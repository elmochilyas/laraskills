...
When implementing Soft Delete Handling In Scout in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Soft Delete Handling In Scout

### Related Skills

- Configure and Implement Soft Delete Handling In Scout
...
When configuring Soft Delete Handling In Scout, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Soft Delete Handling In Scout, you must decide between synchronous (immediate) or queue-based (async) index updates.
