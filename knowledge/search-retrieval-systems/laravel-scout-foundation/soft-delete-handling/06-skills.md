# Skill: Configure and Implement Soft Delete Handling

## Purpose

Set up and configure Soft Delete Handling for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Soft Delete Handling in a production Laravel application
- When optimizing or hardening Soft Delete Handling for operational use
...
1. Install the required package or extension for Soft Delete Handling via Composer or system package manager
...
- Configure and Implement Soft Delete Handling
- Monitor and Maintain Soft Delete Handling

## Success Criteria

- Soft Delete Handling configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Soft Delete Handling Production Search

## Purpose

Tune Soft Delete Handling for production workloads including performance optimization, monitoring, and maintenance operations.
