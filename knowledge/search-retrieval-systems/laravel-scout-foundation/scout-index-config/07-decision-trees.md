...
**Knowledge Unit:** Scout Index Configuration
...
When implementing Scout Index Configuration in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Scout Index Configuration

### Related Skills

- Configure and Implement Scout Index Configuration
...
When configuring Scout Index Configuration, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Scout Index Configuration, you must decide between synchronous (immediate) or queue-based (async) index updates.
