# Skill: Configure and Implement Custom Engine Development

## Purpose

Set up and configure Custom Engine Development for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Custom Engine Development in a production Laravel application
- When optimizing or hardening Custom Engine Development for operational use
...
1. Install the required package or extension for Custom Engine Development via Composer or system package manager
...
- Configure and Implement Custom Engine Development
- Monitor and Maintain Custom Engine Development

## Success Criteria

- Custom Engine Development configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Custom Engine Development Production Search

## Purpose

Tune Custom Engine Development for production workloads including performance optimization, monitoring, and maintenance operations.
