...
When implementing Custom Engine Development in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Custom Engine Development
...
When configuring Custom Engine Development, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Custom Engine Development, you must decide between synchronous (immediate) or queue-based (async) index updates.
