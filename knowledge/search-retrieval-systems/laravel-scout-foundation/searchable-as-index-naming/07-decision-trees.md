...
When implementing Searchableas / Index Naming in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Searchableas / Index Naming

### Related Skills

- Configure and Implement Searchableas / Index Naming
...
When configuring Searchableas / Index Naming, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Searchableas / Index Naming, you must decide between synchronous (immediate) or queue-based (async) index updates.
