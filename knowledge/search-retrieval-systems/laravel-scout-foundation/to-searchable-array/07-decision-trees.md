...
When implementing Tosearchablearray Customization in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Tosearchablearray Customization

### Related Skills

- Configure and Implement Tosearchablearray Customization
...
When configuring Tosearchablearray Customization, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Tosearchablearray Customization, you must decide between synchronous (immediate) or queue-based (async) index updates.
