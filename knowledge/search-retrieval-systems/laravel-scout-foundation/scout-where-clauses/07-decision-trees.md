...
When implementing Scout Where / Wherein / Wherenotin in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Scout Where / Wherein / Wherenotin

### Related Skills

- Configure and Implement Scout Where / Wherein / Wherenotin
...
When configuring Scout Where / Wherein / Wherenotin, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Scout Where / Wherein / Wherenotin, you must decide between synchronous (immediate) or queue-based (async) index updates.
