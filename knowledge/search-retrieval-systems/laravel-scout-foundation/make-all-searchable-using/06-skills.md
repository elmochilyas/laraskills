# Skill: Configure and Implement Make All Searchable Using

## Purpose

Set up and configure Make All Searchable Using for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Make All Searchable Using in a production Laravel application
- When optimizing or hardening Make All Searchable Using for operational use
...
1. Install the required package or extension for Make All Searchable Using via Composer or system package manager
...
- Configure and Implement Make All Searchable Using
- Monitor and Maintain Make All Searchable Using

## Success Criteria

- Make All Searchable Using configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Make All Searchable Using Production Search

## Purpose

Tune Make All Searchable Using for production workloads including performance optimization, monitoring, and maintenance operations.
