...
When implementing Makeallsearchableusing / Makesearchableusing in a Laravel Scout context, you must decide how to configure the searchable behavior for your Eloquent models.
...
- Follow Best Practices for Makeallsearchableusing / Makesearchableusing

### Related Skills

- Configure and Implement Makeallsearchableusing / Makesearchableusing
...
When configuring Makeallsearchableusing / Makesearchableusing, you must decide between batch indexing, incremental indexing, or a combination of both strategies.
...
For incremental indexing of Makeallsearchableusing / Makesearchableusing, you must decide between synchronous (immediate) or queue-based (async) index updates.
