# Skill: Configure and Implement Pgvector Laravel

## Purpose

Set up and configure Pgvector Laravel for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Pgvector Laravel in a production Laravel application
- When optimizing or hardening Pgvector Laravel for operational use
...
1. Install the required package or extension for Pgvector Laravel via Composer or system package manager
...
- Configure and Implement Pgvector Laravel
- Monitor and Maintain Pgvector Laravel

## Success Criteria

- Pgvector Laravel configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Pgvector Laravel Production Search

## Purpose

Tune Pgvector Laravel for production workloads including performance optimization, monitoring, and maintenance operations.
