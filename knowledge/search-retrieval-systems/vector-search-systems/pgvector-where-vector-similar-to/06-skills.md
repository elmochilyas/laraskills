# Skill: Configure and Implement Pgvector Where Vector Similar To

## Purpose

Set up and configure Pgvector Where Vector Similar To for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Pgvector Where Vector Similar To in a production Laravel application
- When optimizing or hardening Pgvector Where Vector Similar To for operational use
...
1. Install the required package or extension for Pgvector Where Vector Similar To via Composer or system package manager
...
- Configure and Implement Pgvector Where Vector Similar To
- Monitor and Maintain Pgvector Where Vector Similar To

## Success Criteria

- Pgvector Where Vector Similar To configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Pgvector Where Vector Similar To Production Search

## Purpose

Tune Pgvector Where Vector Similar To for production workloads including performance optimization, monitoring, and maintenance operations.
