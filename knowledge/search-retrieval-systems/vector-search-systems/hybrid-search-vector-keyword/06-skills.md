# Skill: Configure and Implement Hybrid Search Vector Keyword

## Purpose

Set up and configure Hybrid Search Vector Keyword for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Hybrid Search Vector Keyword in a production Laravel application
- When optimizing or hardening Hybrid Search Vector Keyword for operational use
...
1. Install the required package or extension for Hybrid Search Vector Keyword via Composer or system package manager
...
- Configure and Implement Hybrid Search Vector Keyword
- Monitor and Maintain Hybrid Search Vector Keyword

## Success Criteria

- Hybrid Search Vector Keyword configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Hybrid Search Vector Keyword Production Search

## Purpose

Tune Hybrid Search Vector Keyword for production workloads including performance optimization, monitoring, and maintenance operations.
