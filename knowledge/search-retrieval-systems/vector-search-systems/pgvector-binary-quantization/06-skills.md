# Skill: Configure and Implement Pgvector Binary Quantization

## Purpose

Set up and configure Pgvector Binary Quantization for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Pgvector Binary Quantization in a production Laravel application
- When optimizing or hardening Pgvector Binary Quantization for operational use
...
1. Install the required package or extension for Pgvector Binary Quantization via Composer or system package manager
...
- Configure and Implement Pgvector Binary Quantization
- Monitor and Maintain Pgvector Binary Quantization

## Success Criteria

- Pgvector Binary Quantization configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Pgvector Binary Quantization Production Search

## Purpose

Tune Pgvector Binary Quantization for production workloads including performance optimization, monitoring, and maintenance operations.
