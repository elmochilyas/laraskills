# Skill: Configure and Implement Pgvector Half Precision

## Purpose

Set up and configure Pgvector Half Precision for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Pgvector Half Precision in a production Laravel application
- When optimizing or hardening Pgvector Half Precision for operational use
...
1. Install the required package or extension for Pgvector Half Precision via Composer or system package manager
...
- Configure and Implement Pgvector Half Precision
- Monitor and Maintain Pgvector Half Precision

## Success Criteria

- Pgvector Half Precision configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Pgvector Half Precision Production Search

## Purpose

Tune Pgvector Half Precision for production workloads including performance optimization, monitoring, and maintenance operations.
