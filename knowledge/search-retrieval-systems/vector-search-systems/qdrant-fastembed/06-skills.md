# Skill: Configure and Implement Qdrant Fastembed

## Purpose

Set up and configure Qdrant Fastembed for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Qdrant Fastembed in a production Laravel application
- When optimizing or hardening Qdrant Fastembed for operational use
...
1. Install the required package or extension for Qdrant Fastembed via Composer or system package manager
...
- Configure and Implement Qdrant Fastembed
- Monitor and Maintain Qdrant Fastembed

## Success Criteria

- Qdrant Fastembed configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Qdrant Fastembed Production Search

## Purpose

Tune Qdrant Fastembed for production workloads including performance optimization, monitoring, and maintenance operations.
