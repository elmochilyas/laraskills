# Skill: Configure and Implement Laravel Pgvector Eloquent

## Purpose

Set up and configure Laravel Pgvector Eloquent for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Laravel Pgvector Eloquent in a production Laravel application
- When optimizing or hardening Laravel Pgvector Eloquent for operational use
...
1. Install the required package or extension for Laravel Pgvector Eloquent via Composer or system package manager
...
- Configure and Implement Laravel Pgvector Eloquent
- Monitor and Maintain Laravel Pgvector Eloquent

## Success Criteria

- Laravel Pgvector Eloquent configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Laravel Pgvector Eloquent Production Search

## Purpose

Tune Laravel Pgvector Eloquent for production workloads including performance optimization, monitoring, and maintenance operations.
