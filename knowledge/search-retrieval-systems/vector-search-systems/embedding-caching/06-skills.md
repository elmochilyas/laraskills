# Skill: Configure and Implement Embedding Caching

## Purpose

Set up and configure Embedding Caching for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Embedding Caching in a production Laravel application
- When optimizing or hardening Embedding Caching for operational use
...
1. Install the required package or extension for Embedding Caching via Composer or system package manager
...
- Configure and Implement Embedding Caching
- Monitor and Maintain Embedding Caching

## Success Criteria

- Embedding Caching configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Embedding Caching Production Search

## Purpose

Tune Embedding Caching for production workloads including performance optimization, monitoring, and maintenance operations.
