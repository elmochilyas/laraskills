# Skill: Configure and Implement Pgvector Extension

## Purpose

Set up and configure Pgvector Extension for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Pgvector Extension in a production Laravel application
- When optimizing or hardening Pgvector Extension for operational use
...
1. Install the required package or extension for Pgvector Extension via Composer or system package manager
...
- Configure and Implement Pgvector Extension
- Monitor and Maintain Pgvector Extension

## Success Criteria

- Pgvector Extension configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Pgvector Extension Production Search

## Purpose

Tune Pgvector Extension for production workloads including performance optimization, monitoring, and maintenance operations.
