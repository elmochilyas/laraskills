# Skill: Configure and Implement Typesense Vector Search

## Purpose

Set up and configure Typesense Vector Search for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Typesense Vector Search in a production Laravel application
- When optimizing or hardening Typesense Vector Search for operational use
...
1. Install the required package or extension for Typesense Vector Search via Composer or system package manager
...
- Configure and Implement Typesense Vector Search
- Monitor and Maintain Typesense Vector Search

## Success Criteria

- Typesense Vector Search configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Typesense Vector Search Production Search

## Purpose

Tune Typesense Vector Search for production workloads including performance optimization, monitoring, and maintenance operations.
