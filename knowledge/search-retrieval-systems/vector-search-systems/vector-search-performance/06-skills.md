# Skill: Configure and Implement Vector Search Performance

## Purpose

Set up and configure Vector Search Performance for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Vector Search Performance in a production Laravel application
- When optimizing or hardening Vector Search Performance for operational use
...
1. Install the required package or extension for Vector Search Performance via Composer or system package manager
...
- Configure and Implement Vector Search Performance
- Monitor and Maintain Vector Search Performance

## Success Criteria

- Vector Search Performance configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Vector Search Performance Production Search

## Purpose

Tune Vector Search Performance for production workloads including performance optimization, monitoring, and maintenance operations.
