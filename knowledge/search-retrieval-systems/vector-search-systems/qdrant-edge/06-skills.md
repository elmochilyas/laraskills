# Skill: Configure and Implement Qdrant Edge

## Purpose

Set up and configure Qdrant Edge for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Qdrant Edge in a production Laravel application
- When optimizing or hardening Qdrant Edge for operational use
...
1. Install the required package or extension for Qdrant Edge via Composer or system package manager
...
- Configure and Implement Qdrant Edge
- Monitor and Maintain Qdrant Edge

## Success Criteria

- Qdrant Edge configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Qdrant Edge Production Search

## Purpose

Tune Qdrant Edge for production workloads including performance optimization, monitoring, and maintenance operations.
