# Skill: Configure and Implement Pgvector Indexing Hnsw Ivfflat

## Purpose

Set up and configure Pgvector Indexing Hnsw Ivfflat for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Pgvector Indexing Hnsw Ivfflat in a production Laravel application
- When optimizing or hardening Pgvector Indexing Hnsw Ivfflat for operational use
...
1. Install the required package or extension for Pgvector Indexing Hnsw Ivfflat via Composer or system package manager
...
- Configure and Implement Pgvector Indexing Hnsw Ivfflat
- Monitor and Maintain Pgvector Indexing Hnsw Ivfflat

## Success Criteria

- Pgvector Indexing Hnsw Ivfflat configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Pgvector Indexing Hnsw Ivfflat Production Search

## Purpose

Tune Pgvector Indexing Hnsw Ivfflat for production workloads including performance optimization, monitoring, and maintenance operations.
