# Skill: Configure and Implement Embedding Generation Api

## Purpose

Set up and configure Embedding Generation Api for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Embedding Generation Api in a production Laravel application
- When optimizing or hardening Embedding Generation Api for operational use
...
1. Install the required package or extension for Embedding Generation Api via Composer or system package manager
...
- Configure and Implement Embedding Generation Api
- Monitor and Maintain Embedding Generation Api

## Success Criteria

- Embedding Generation Api configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Embedding Generation Api Production Search

## Purpose

Tune Embedding Generation Api for production workloads including performance optimization, monitoring, and maintenance operations.
