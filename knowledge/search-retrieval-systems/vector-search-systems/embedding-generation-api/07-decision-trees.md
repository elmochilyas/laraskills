...
**Knowledge Unit:** Api Embedding Generation
...
When implementing Api Embedding Generation, you must decide which vector database or extension to use for storing and querying embeddings.
...
- Configure and Implement Api Embedding Generation
...
When implementing Api Embedding Generation, you must decide how to generate vector embeddings via API service or local model.
...
When implementing Api Embedding Generation, you must choose between HNSW and IVFFlat approximate nearest neighbor indexes.
