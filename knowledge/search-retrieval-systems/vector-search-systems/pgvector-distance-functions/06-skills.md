# Skill: Configure and Implement Pgvector Distance Functions

## Purpose

Set up and configure Pgvector Distance Functions for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Pgvector Distance Functions in a production Laravel application
- When optimizing or hardening Pgvector Distance Functions for operational use
...
1. Install the required package or extension for Pgvector Distance Functions via Composer or system package manager
...
- Configure and Implement Pgvector Distance Functions
- Monitor and Maintain Pgvector Distance Functions

## Success Criteria

- Pgvector Distance Functions configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Pgvector Distance Functions Production Search

## Purpose

Tune Pgvector Distance Functions for production workloads including performance optimization, monitoring, and maintenance operations.
