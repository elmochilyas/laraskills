# Skill: Configure and Implement Multi Vector Search

## Purpose

Set up and configure Multi Vector Search for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Multi Vector Search in a production Laravel application
- When optimizing or hardening Multi Vector Search for operational use
...
1. Install the required package or extension for Multi Vector Search via Composer or system package manager
...
- Configure and Implement Multi Vector Search
- Monitor and Maintain Multi Vector Search

## Success Criteria

- Multi Vector Search configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Multi Vector Search Production Search

## Purpose

Tune Multi Vector Search for production workloads including performance optimization, monitoring, and maintenance operations.
