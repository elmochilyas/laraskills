# Skill: Configure and Implement Vector Search Production

## Purpose

Set up and configure Vector Search Production for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Vector Search Production in a production Laravel application
- When optimizing or hardening Vector Search Production for operational use
...
1. Install the required package or extension for Vector Search Production via Composer or system package manager
...
- Configure and Implement Vector Search Production
- Monitor and Maintain Vector Search Production

## Success Criteria

- Vector Search Production configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Vector Search Production Production Search

## Purpose

Tune Vector Search Production for production workloads including performance optimization, monitoring, and maintenance operations.
