# Skill: Configure and Implement Vector Search Metadata Filtering

## Purpose

Set up and configure Vector Search Metadata Filtering for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Vector Search Metadata Filtering in a production Laravel application
- When optimizing or hardening Vector Search Metadata Filtering for operational use
...
1. Install the required package or extension for Vector Search Metadata Filtering via Composer or system package manager
...
- Configure and Implement Vector Search Metadata Filtering
- Monitor and Maintain Vector Search Metadata Filtering

## Success Criteria

- Vector Search Metadata Filtering configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Vector Search Metadata Filtering Production Search

## Purpose

Tune Vector Search Metadata Filtering for production workloads including performance optimization, monitoring, and maintenance operations.
