# Skill: Configure and Implement Pgvector Hnsw Ivfflat

## Purpose

Set up and configure Pgvector Hnsw Ivfflat for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Pgvector Hnsw Ivfflat in a production Laravel application
- When optimizing or hardening Pgvector Hnsw Ivfflat for operational use
...
1. Install the required package or extension for Pgvector Hnsw Ivfflat via Composer or system package manager
...
- Configure and Implement Pgvector Hnsw Ivfflat
- Monitor and Maintain Pgvector Hnsw Ivfflat

## Success Criteria

- Pgvector Hnsw Ivfflat configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Pgvector Hnsw Ivfflat Production Search

## Purpose

Tune Pgvector Hnsw Ivfflat for production workloads including performance optimization, monitoring, and maintenance operations.
