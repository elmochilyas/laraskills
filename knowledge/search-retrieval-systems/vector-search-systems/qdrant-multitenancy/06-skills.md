# Skill: Configure and Implement Qdrant Multitenancy

## Purpose

Set up and configure Qdrant Multitenancy for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Qdrant Multitenancy in a production Laravel application
- When optimizing or hardening Qdrant Multitenancy for operational use
...
1. Install the required package or extension for Qdrant Multitenancy via Composer or system package manager
...
- Configure and Implement Qdrant Multitenancy
- Monitor and Maintain Qdrant Multitenancy

## Success Criteria

- Qdrant Multitenancy configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Qdrant Multitenancy Production Search

## Purpose

Tune Qdrant Multitenancy for production workloads including performance optimization, monitoring, and maintenance operations.
