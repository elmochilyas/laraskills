# Skill: Configure and Implement Pgvector Iterative Index Scans

## Purpose

Set up and configure Pgvector Iterative Index Scans for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Pgvector Iterative Index Scans in a production Laravel application
- When optimizing or hardening Pgvector Iterative Index Scans for operational use
...
1. Install the required package or extension for Pgvector Iterative Index Scans via Composer or system package manager
...
- Configure and Implement Pgvector Iterative Index Scans
- Monitor and Maintain Pgvector Iterative Index Scans

## Success Criteria

- Pgvector Iterative Index Scans configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Pgvector Iterative Index Scans Production Search

## Purpose

Tune Pgvector Iterative Index Scans for production workloads including performance optimization, monitoring, and maintenance operations.
