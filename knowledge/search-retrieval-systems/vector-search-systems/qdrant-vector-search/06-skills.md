# Skill: Configure and Implement Qdrant Vector Search

## Purpose

Set up and configure Qdrant Vector Search for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Qdrant Vector Search in a production Laravel application
- When optimizing or hardening Qdrant Vector Search for operational use
...
1. Install the required package or extension for Qdrant Vector Search via Composer or system package manager
...
- Configure and Implement Qdrant Vector Search
- Monitor and Maintain Qdrant Vector Search

## Success Criteria

- Qdrant Vector Search configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Qdrant Vector Search Production Search

## Purpose

Tune Qdrant Vector Search for production workloads including performance optimization, monitoring, and maintenance operations.
