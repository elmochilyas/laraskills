# Skill: Configure and Implement Qdrant Quantization

## Purpose

Set up and configure Qdrant Quantization for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Qdrant Quantization in a production Laravel application
- When optimizing or hardening Qdrant Quantization for operational use
...
1. Install the required package or extension for Qdrant Quantization via Composer or system package manager
...
- Configure and Implement Qdrant Quantization
- Monitor and Maintain Qdrant Quantization

## Success Criteria

- Qdrant Quantization configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Qdrant Quantization Production Search

## Purpose

Tune Qdrant Quantization for production workloads including performance optimization, monitoring, and maintenance operations.
