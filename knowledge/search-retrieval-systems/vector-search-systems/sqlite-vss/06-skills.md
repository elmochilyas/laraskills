# Skill: Configure and Implement Sqlite Vss

## Purpose

Set up and configure Sqlite Vss for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Sqlite Vss in a production Laravel application
- When optimizing or hardening Sqlite Vss for operational use
...
1. Install the required package or extension for Sqlite Vss via Composer or system package manager
...
- Configure and Implement Sqlite Vss
- Monitor and Maintain Sqlite Vss

## Success Criteria

- Sqlite Vss configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Sqlite Vss Production Search

## Purpose

Tune Sqlite Vss for production workloads including performance optimization, monitoring, and maintenance operations.
