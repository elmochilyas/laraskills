# Skill: Configure and Implement Milvus Vector Database

## Purpose

Set up and configure Milvus Vector Database for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Milvus Vector Database in a production Laravel application
- When optimizing or hardening Milvus Vector Database for operational use
...
1. Install the required package or extension for Milvus Vector Database via Composer or system package manager
...
- Configure and Implement Milvus Vector Database
- Monitor and Maintain Milvus Vector Database

## Success Criteria

- Milvus Vector Database configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Milvus Vector Database Production Search

## Purpose

Tune Milvus Vector Database for production workloads including performance optimization, monitoring, and maintenance operations.
