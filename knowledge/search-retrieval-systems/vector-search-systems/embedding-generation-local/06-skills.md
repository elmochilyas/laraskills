# Skill: Configure and Implement Embedding Generation Local

## Purpose

Set up and configure Embedding Generation Local for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Embedding Generation Local in a production Laravel application
- When optimizing or hardening Embedding Generation Local for operational use
...
1. Install the required package or extension for Embedding Generation Local via Composer or system package manager
...
- Configure and Implement Embedding Generation Local
- Monitor and Maintain Embedding Generation Local

## Success Criteria

- Embedding Generation Local configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Embedding Generation Local Production Search

## Purpose

Tune Embedding Generation Local for production workloads including performance optimization, monitoring, and maintenance operations.
