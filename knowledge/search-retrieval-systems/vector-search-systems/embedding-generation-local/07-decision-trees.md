...
**Knowledge Unit:** Local Embedding Generation
...
When implementing Local Embedding Generation, you must decide which vector database or extension to use for storing and querying embeddings.
...
- Configure and Implement Local Embedding Generation
...
When implementing Local Embedding Generation, you must decide how to generate vector embeddings via API service or local model.
...
When implementing Local Embedding Generation, you must choose between HNSW and IVFFlat approximate nearest neighbor indexes.
