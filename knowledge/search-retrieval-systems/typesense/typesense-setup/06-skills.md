# Skill: Configure and Implement Typesense Setup

## Purpose

Set up and configure Typesense Setup for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Typesense Setup in a production Laravel application
- When optimizing or hardening Typesense Setup for operational use
...
1. Install the required package or extension for Typesense Setup via Composer or system package manager
...
- Configure and Implement Typesense Setup
- Monitor and Maintain Typesense Setup

## Success Criteria

- Typesense Setup configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Typesense Setup Production Search

## Purpose

Tune Typesense Setup for production workloads including performance optimization, monitoring, and maintenance operations.
