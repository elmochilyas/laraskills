# Skill: Configure and Implement Typesense Scout Driver

## Purpose

Set up and configure Typesense Scout Driver for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Typesense Scout Driver in a production Laravel application
- When optimizing or hardening Typesense Scout Driver for operational use
...
1. Install the required package or extension for Typesense Scout Driver via Composer or system package manager
...
- Configure and Implement Typesense Scout Driver
- Monitor and Maintain Typesense Scout Driver

## Success Criteria

- Typesense Scout Driver configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Typesense Scout Driver Production Search

## Purpose

Tune Typesense Scout Driver for production workloads including performance optimization, monitoring, and maintenance operations.
