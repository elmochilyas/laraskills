# Skill: Configure and Implement Typesense Driver Setup

## Purpose

Set up and configure Typesense Driver Setup for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Typesense Driver Setup in a production Laravel application
- When optimizing or hardening Typesense Driver Setup for operational use
...
1. Install the required package or extension for Typesense Driver Setup via Composer or system package manager
...
- Configure and Implement Typesense Driver Setup
- Monitor and Maintain Typesense Driver Setup

## Success Criteria

- Typesense Driver Setup configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Typesense Driver Setup Production Search

## Purpose

Tune Typesense Driver Setup for production workloads including performance optimization, monitoring, and maintenance operations.
