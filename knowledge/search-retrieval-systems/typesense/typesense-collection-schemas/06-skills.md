# Skill: Configure and Implement Typesense Collection Schemas

## Purpose

Set up and configure Typesense Collection Schemas for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Typesense Collection Schemas in a production Laravel application
- When optimizing or hardening Typesense Collection Schemas for operational use
...
1. Install the required package or extension for Typesense Collection Schemas via Composer or system package manager
...
- Monitor and Maintain Typesense Collection Schemas

## Success Criteria

- Typesense Collection Schemas configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Typesense Collection Schemas Production Search

## Purpose

Tune Typesense Collection Schemas for production workloads including performance optimization, monitoring, and maintenance operations.
