# Skill: Configure and Implement Meilisearch Synonym Management

## Purpose

Set up and configure Meilisearch Synonym Management for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Meilisearch Synonym Management in a production Laravel application
- When optimizing or hardening Meilisearch Synonym Management for operational use
...
1. Install the required package or extension for Meilisearch Synonym Management via Composer or system package manager
...
- Configure and Implement Meilisearch Synonym Management
- Monitor and Maintain Meilisearch Synonym Management

## Success Criteria

- Meilisearch Synonym Management configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Meilisearch Synonym Management Production Search

## Purpose

Tune Meilisearch Synonym Management for production workloads including performance optimization, monitoring, and maintenance operations.
