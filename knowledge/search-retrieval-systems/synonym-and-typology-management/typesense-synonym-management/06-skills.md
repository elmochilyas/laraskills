# Skill: Configure and Implement Typesense Synonym Management

## Purpose

Set up and configure Typesense Synonym Management for search functionality in a Laravel application using Scout integration. This skill covers installation, configuration, indexing, and basic search operations.

## When To Use

- When implementing Typesense Synonym Management in a production Laravel application
- When optimizing or hardening Typesense Synonym Management for operational use
...
1. Install the required package or extension for Typesense Synonym Management via Composer or system package manager
...
- Monitor and Maintain Typesense Synonym Management

## Success Criteria

- Typesense Synonym Management configured and functioning correctly
- Operational runbooks documented
- Monitoring dashboards and alerts active

---

# Skill: Optimize and Monitor Typesense Synonym Management Production Search

## Purpose

Tune Typesense Synonym Management for production workloads including performance optimization, monitoring, and maintenance operations.
