...
## Boundary Analysis
**In scope:**
- Deployer uses a recipe-based approach. Recipes are PHP files defining hosts, tas
- 1. `deploy:info` — display deployment info
- 2. `deploy:setup` — create directory structure
- 3. `deploy:lock` — prevent concurrent deployments
**Out of scope:**
