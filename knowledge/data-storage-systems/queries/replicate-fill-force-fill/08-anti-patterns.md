# ECC Anti-Patterns â€” Replicate Fill Force Fill
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Using forceFill with user input
...
### Related Skills
Use `replicate` to clone model instances (without PK), `fill` for mass-assignment respecting `$fillable`, and `forceFill`/`forceCreate` with caution when bypassing mass-assignment protection â€” controlling how model attributes are populated and persisted.
...
---## Anti-Pattern 3: ### Using forceFill with user input
### Category
...
### Related Decision Trees
2-24-replicate-fill-force-fill decision trees in 07-decision-trees.md
