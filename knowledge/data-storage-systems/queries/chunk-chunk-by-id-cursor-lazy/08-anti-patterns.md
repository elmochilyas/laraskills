# ECC Anti-Patterns â€” Chunk Chunk By Id Cursor Lazy
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Iterate large Eloquent result sets without exhausting memory â€” using `chunkById` for stable production batch processing, `cursor` for memory-efficient single-pass exports, and `lazy` for complex collection pipelines â€” selecting the appropriate strategy based on dataset size and processing requirements.
...
---## Anti-Pattern 3: ### Using chunk on tables being modified
### Category
...
### Related Decision Trees
2-23-chunk-chunk-by-id-cursor-lazy decision trees in 07-decision-trees.md
