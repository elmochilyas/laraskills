# ECC Anti-Patterns â€” Update Or Create First Or Create
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use `firstOrCreate` (find or create and persist), `firstOrNew` (find or create unsaved instance), and `updateOrCreate` (find or update or create) for convenient find-or-create semantics â€” understanding they perform two operations (SELECT + INSERT) and are not atomic without a transaction.
...
---## Anti-Pattern 3: ### Race condition with firstOrCreate
### Category
...
### Related Decision Trees
2-26-update-or-create-first-or-create decision trees in 07-decision-trees.md
