# ECC Anti-Patterns â€” Subquery Selects
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Queries |
| **Knowledge Unit** | 2-8-subquery-selects |
...
### Related Skills
Use `addSelect()` with subqueries to include derived columns in query results â€” `User::addSelect(['last_post_id' => Post::select('id')->whereColumn('user_id', 'users.id')->latest()])` â€” for complex computations that don't have dedicated relationship methods.
...
---## Anti-Pattern 3: ### Subquery returns multiple rows
### Category
...
### Related Decision Trees
2-8-subquery-selects decision trees in 07-decision-trees.md
