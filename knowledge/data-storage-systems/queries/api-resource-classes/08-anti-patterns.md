# ECC Anti-Patterns â€” Api Resource Classes
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Create API Resource classes (extending `JsonResource`) for per-endpoint data shaping â€” using conditional attributes (`whenLoaded`, `whenHas`), narrow field selection, and resource collections for paginated responses â€” preventing the one-serialization-fits-all anti-pattern.
...
---## Anti-Pattern 3: ### Accessor causing N+1
### Category
...
### Related Decision Trees
2-27-api-resource-classes decision trees in 07-decision-trees.md
