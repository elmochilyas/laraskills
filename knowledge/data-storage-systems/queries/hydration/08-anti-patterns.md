...
### Related Skills
Use `hydrate` and `hydrateRaw` to create Eloquent model instances from cached data, query builder results, or external API responses â€” enabling Eloquent features (accessors, casts, relationships) on data that didn't originate from a model query.
...
---## Anti-Pattern 3: ### Forgetting retrieved event fires
### Category
...
### Related Decision Trees
2-20-hydration decision trees in 07-decision-trees.md
