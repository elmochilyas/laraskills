# ECC Anti-Patterns â€” Accessors Mutators
---
## Metadata
| Field | Value |
|-------|-------|
...
---## Anti-Pattern 3: ### Accessors that query the database
### Category
...
### Related Decision Trees
2-16-accessors-mutators decision trees in 07-decision-trees.md
