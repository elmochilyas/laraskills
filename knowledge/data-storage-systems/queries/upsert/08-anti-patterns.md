...
### Related Skills
Use `upsert` to insert rows that don't exist and update rows that do, in a single atomic operation â€” using unique indexes or primary keys for conflict detection â€” for idempotent imports, sync operations, and batch data ingestion.
...
---## Anti-Pattern 3: ### Missing unique index
### Category
...
### Related Decision Trees
2-21-upsert decision trees in 07-decision-trees.md
