# ECC Anti-Patterns â€” Eager Loading
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Queries |
| **Knowledge Unit** | 2-3-eager-loading |
...
---## Anti-Pattern 3: ### Partial eager loading
### Category
...
### Related Decision Trees
2-3-eager-loading decision trees in 07-decision-trees.md
