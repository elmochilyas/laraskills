# ECC Anti-Patterns â€” Strict Mode
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Enable `preventSilentlyDiscardingAttributes` (throws on unfillable mass-assignment) and `preventAccessingMissingAttributes` (throws on accessing non-existent attributes) in non-production environments to catch bugs early â€” using logging handlers in production instead of throwing.
...
---## Anti-Pattern 3: ### Not enabling in development
### Category
...
### Related Decision Trees
2-30-strict-mode decision trees in 07-decision-trees.md
