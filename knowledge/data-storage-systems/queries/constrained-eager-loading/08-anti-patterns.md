# ECC Anti-Patterns â€” Constrained Eager Loading
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Apply constraints to eager loaded relationships using closure-based `with()` syntax to filter, order, or limit related records â€” `User::with(['posts' => fn($q) => $q->where('published', true)->orderBy('created_at')])` â€” while keeping the main query separate.
...
---## Anti-Pattern 3: ### Assuming constraints apply globally
### Category
...
### Related Decision Trees
2-5-constrained-eager-loading decision trees in 07-decision-trees.md
