# ECC Anti-Patterns â€” Relationship Counting
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use `withCount()` to retrieve counts of related records in a single query â€” `Post::withCount('comments')->get()` â€” avoiding N+1 count queries by calculating counts as subquery selects.
...
---## Anti-Pattern 3: ### Loading full relationship just for the count
### Category
...
### Related Decision Trees
2-7-relationship-counting decision trees in 07-decision-trees.md
