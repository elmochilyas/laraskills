# ECC Anti-Patterns â€” Model Serialization
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Control how Eloquent models and collections convert to arrays and JSON â€” using `$hidden` to exclude sensitive attributes, `$visible` to whitelist permitted fields, `$appends` to include computed accessors, and API Resources for endpoint-specific shaping.
...
---## Anti-Pattern 3: ### $appends triggering N+1
### Category
...
### Related Decision Trees
2-18-model-serialization decision trees in 07-decision-trees.md
