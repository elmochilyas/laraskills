# ECC Anti-Patterns â€” Model Events
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Attach side-effect logic (logging, cache invalidation, notifications, slug generation, audit trails) to model lifecycle events â€” retrieved, creating/created, updating/updated, saving/saved, deleting/deleted, trashed, forceDeleted â€” using model event closures or Observer classes.
...
---## Anti-Pattern 3: ### Performing heavy operations in events
### Category
...
### Related Decision Trees
2-19-model-events decision trees in 07-decision-trees.md
