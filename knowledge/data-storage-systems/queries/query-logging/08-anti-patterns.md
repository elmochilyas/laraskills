# ECC Anti-Patterns â€” Query Logging
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Leaving query logging enabled in production
...
### Related Skills
Use `DB::listen` to capture every executed query (SQL, bindings, time, connection), `enableQueryLog`/`getQueryLog` for in-memory query storage, and slow query alerting â€” for debugging, performance analysis, and test assertions.
...
---## Anti-Pattern 3: ### Leaving query logging enabled in production
### Category
...
### Related Decision Trees
2-29-query-logging decision trees in 07-decision-trees.md
