# ECC Anti-Patterns â€” Model Definition Conventions
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Define Eloquent model properties ($table, $primaryKey, $incrementing, $keyType, $timestamps, $connection) to override default conventions when needed â€” for legacy tables, UUID/ULID primary keys, multi-tenant databases, or non-standard table naming â€” while relying on conventions for standard cases.
...
---## Anti-Pattern 3: ### Forgetting to disable incrementing for UUIDs
### Category
...
### Related Decision Trees
2-1-model-definition-conventions decision trees in 07-decision-trees.md
