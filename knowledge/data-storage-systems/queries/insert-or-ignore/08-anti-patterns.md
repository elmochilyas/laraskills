# ECC Anti-Patterns â€” Insert Or Ignore
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Assuming insertOrIgnore succeeds for all rows
...
### Related Skills
Use `insertOrIgnore` to insert rows while silently skipping any that would cause duplicate key violations â€” for idempotent seed data, log deduplication, and batch inserts where existing rows should be left unchanged.
...
---## Anti-Pattern 3: ### Assuming insertOrIgnore succeeds for all rows
### Category
...
### Related Decision Trees
2-22-insert-or-ignore decision trees in 07-decision-trees.md
