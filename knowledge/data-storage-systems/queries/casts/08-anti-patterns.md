...
### Related Skills
Define attribute casting via `$casts` to convert between database representations and PHP types â€” including native casts (boolean, integer, datetime), enum casts, JSON casts, encrypted casts, and custom casts â€” for type safety and clean attribute access.
...
---## Anti-Pattern 3: ### Casting to integer for large numbers
### Category
...
### Related Decision Trees
2-17-casts decision trees in 07-decision-trees.md
