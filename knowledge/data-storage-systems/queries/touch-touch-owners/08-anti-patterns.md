# ECC Anti-Patterns â€” Touch Touch Owners
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use `touch()` to update a model's `updated_at` timestamp, and `touchOwners()` or `$touches` to cascade timestamp updates up the relationship chain â€” for cache invalidation, change tracking, and parent awareness of child activity.
...
---## Anti-Pattern 3: ### touch causing unnecessary saves
### Category
...
### Related Decision Trees
2-25-touch-touch-owners decision trees in 07-decision-trees.md
