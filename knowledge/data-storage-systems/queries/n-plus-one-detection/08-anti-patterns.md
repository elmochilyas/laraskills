# ECC Anti-Patterns â€” N Plus One Detection
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Detect N+1 query problems using Telescope (per-request query grouping), Debugbar (in-browser query count), DB::listen (custom alerting), and query log analysis â€” identifying repeated queries with identical structure but different parameter values that indicate lazy loading in loops.
...
---## Anti-Pattern 3: ### Relying only on one tool
### Category
...
### Related Decision Trees
2-28-n-plus-one-detection decision trees in 07-decision-trees.md
