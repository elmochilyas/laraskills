# ECC Anti-Patterns â€” Acid Properties
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-1-acid-properties |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. API calls inside transaction â€” holds locks during network latency
...
---## Anti-Pattern 3: API calls inside transaction â€” holds locks during network latency
### Category
...
### Related Decision Trees
9-1-acid-properties decision trees in 07-decision-trees.md
