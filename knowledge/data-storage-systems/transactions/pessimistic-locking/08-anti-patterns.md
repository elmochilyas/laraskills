# ECC Anti-Patterns â€” Pessimistic Locking
---
## Metadata
| Field | Value |
|-------|-------|
...
3. `lockForUpdate()` outside transaction â€” lock released immediately (autocommit)
...
---## Anti-Pattern 3: `lockForUpdate()` outside transaction â€” lock released immediately (autocommit)
### Category
...
### Related Decision Trees
9-15-pessimistic-locking decision trees in 07-decision-trees.md
