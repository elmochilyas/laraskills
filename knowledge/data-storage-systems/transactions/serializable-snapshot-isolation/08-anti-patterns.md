# ECC Anti-Patterns â€” Serializable Snapshot Isolation
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-17-serializable-snapshot-isolation |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. SSI without retry â€” transaction silently fails, data not persisted
...
---## Anti-Pattern 3: SSI without retry â€” transaction silently fails, data not persisted
### Category
...
### Related Decision Trees
9-17-serializable-snapshot-isolation decision trees in 07-decision-trees.md
