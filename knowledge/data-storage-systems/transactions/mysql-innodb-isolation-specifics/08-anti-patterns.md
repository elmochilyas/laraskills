# ECC Anti-Patterns â€” Mysql Innodb Isolation Specifics
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-4-mysql-innodb-isolation-specifics |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. binlog_format=STATEMENT with READ COMMITTED â€” MySQL prevents this (replication unsafe)
...
---## Anti-Pattern 3: binlog_format=STATEMENT with READ COMMITTED â€” MySQL prevents this (replication unsafe)
### Category
...
### Related Decision Trees
9-4-mysql-innodb-isolation-specifics decision trees in 07-decision-trees.md
