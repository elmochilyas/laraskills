# ECC Anti-Patterns â€” Deadlock Detection Resolution
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-8-deadlock-detection-resolution |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. No deadlock retry â€” transaction fails silently
...
---## Anti-Pattern 3: No deadlock retry â€” transaction fails silently
### Category
...
### Related Decision Trees
9-8-deadlock-detection-resolution decision trees in 07-decision-trees.md
