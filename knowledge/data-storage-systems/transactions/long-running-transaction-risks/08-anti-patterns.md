# ECC Anti-Patterns â€” Long Running Transaction Risks
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-19-long-running-transaction-risks |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Single transaction for million-row UPDATE â€” hours of locks, massive bloat
...
---## Anti-Pattern 3: Single transaction for million-row UPDATE â€” hours of locks, massive bloat
### Category
...
### Related Decision Trees
9-19-long-running-transaction-risks decision trees in 07-decision-trees.md
