# ECC Anti-Patterns â€” Lock Wait Timeout
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-10-lock-wait-timeout |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Default 50s timeout for web requests â€” user waits 50s before error
...
---## Anti-Pattern 3: Default 50s timeout for web requests â€” user waits 50s before error
### Category
...
### Related Decision Trees
9-10-lock-wait-timeout decision trees in 07-decision-trees.md
