# ECC Anti-Patterns â€” Implicit Transactions Laravel
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-21-implicit-transactions-laravel |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Email sending in `saved` event â€” 2 second lock hold
...
---## Anti-Pattern 3: Email sending in `saved` event â€” 2 second lock hold
### Category
...
### Related Decision Trees
9-21-implicit-transactions-laravel decision trees in 07-decision-trees.md
