# ECC Anti-Patterns â€” Optimistic Locking
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-14-optimistic-locking |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Version check on UPDATE but version not incremented â€” never detects conflicts
...
---## Anti-Pattern 3: Version check on UPDATE but version not incremented â€” never detects conflicts
### Category
...
### Related Decision Trees
9-14-optimistic-locking decision trees in 07-decision-trees.md
