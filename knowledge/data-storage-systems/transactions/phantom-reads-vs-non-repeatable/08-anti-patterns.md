# ECC Anti-Patterns â€” Phantom Reads Vs Non Repeatable
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-16-phantom-reads-vs-non-repeatable |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Expecting REPEATABLE READ to prevent write skew (it doesn't â€” use SERIALIZABLE)
...
---## Anti-Pattern 3: Expecting REPEATABLE READ to prevent write skew (it doesn't â€” use SERIALIZABLE)
### Category
...
### Related Decision Trees
9-16-phantom-reads-vs-non-repeatable decision trees in 07-decision-trees.md
