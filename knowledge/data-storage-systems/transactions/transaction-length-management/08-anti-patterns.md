# ECC Anti-Patterns â€” Transaction Length Management
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-13-transaction-length-management |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. API call inside transaction â€” lock held for 200-5000ms
...
---## Anti-Pattern 3: API call inside transaction â€” lock held for 200-5000ms
### Category
...
### Related Decision Trees
9-13-transaction-length-management decision trees in 07-decision-trees.md
