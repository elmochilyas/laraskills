# ECC Anti-Patterns â€” Row Level Locks
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-5-row-level-locks |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Missing FOR UPDATE in read-then-write â€” race condition
...
---## Anti-Pattern 3: Missing FOR UPDATE in read-then-write â€” race condition
### Category
...
### Related Decision Trees
9-5-row-level-locks decision trees in 07-decision-trees.md
