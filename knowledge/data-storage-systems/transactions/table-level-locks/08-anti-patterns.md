# ECC Anti-Patterns â€” Table Level Locks
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-6-table-level-locks |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. `LOCK TABLES` inside a transaction â€” implicit commit before LOCK
...
---## Anti-Pattern 3: `LOCK TABLES` inside a transaction â€” implicit commit before LOCK
### Category
...
### Related Decision Trees
9-6-table-level-locks decision trees in 07-decision-trees.md
