# ECC Anti-Patterns â€” Isolation Levels
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-2-isolation-levels |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Using SERIALIZABLE for all transactions "for safety" â€” kills throughput
...
---## Anti-Pattern 3: Using SERIALIZABLE for all transactions "for safety" â€” kills throughput
### Category
...
### Related Decision Trees
9-2-isolation-levels decision trees in 07-decision-trees.md
