# ECC Anti-Patterns â€” Postgresql Isolation Specifics
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-3-postgresql-isolation-specifics |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. SSI without retry â€” transaction aborts silently, data not persisted
...
---## Anti-Pattern 3: SSI without retry â€” transaction aborts silently, data not persisted
### Category
...
### Related Decision Trees
9-3-postgresql-isolation-specifics decision trees in 07-decision-trees.md
