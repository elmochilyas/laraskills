# ECC Anti-Patterns â€” Nested Transactions Savepoints
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-12-nested-transactions-savepoints |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Assuming inner transaction is independent â€” it's a savepoint
...
---## Anti-Pattern 3: Assuming inner transaction is independent â€” it's a savepoint
### Category
...
### Related Decision Trees
9-12-nested-transactions-savepoints decision trees in 07-decision-trees.md
