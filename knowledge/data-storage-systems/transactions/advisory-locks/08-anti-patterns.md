# ECC Anti-Patterns â€” Advisory Locks
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-7-advisory-locks |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Session-level lock not released â€” other sessions blocked until disconnect
...
---## Anti-Pattern 3: Session-level lock not released â€” other sessions blocked until disconnect
### Category
...
### Related Decision Trees
9-7-advisory-locks decision trees in 07-decision-trees.md
