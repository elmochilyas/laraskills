# ECC Anti-Patterns â€” Transaction Retry Logic
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-20-transaction-retry-logic |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Infinite retry loop â€” always set max retry count
...
### Warning Signs
- Infinite retry**: Retrying forever on a deadlock caused by a bug. Always limit retries to 3-5. After max retries, fail and alert.
- ---
### Why It Is Harmful
...
---## Anti-Pattern 3: Infinite retry loop â€” always set max retry count
### Category
...
### Related Decision Trees
9-20-transaction-retry-logic decision trees in 07-decision-trees.md
