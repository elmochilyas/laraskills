# ECC Anti-Patterns â€” Transaction Scoping Laravel
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-11-transaction-scoping-laravel |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Manual `DB::beginTransaction()` without matching `commit()`/`rollBack()` â€” orphaned transaction
...
---## Anti-Pattern 3: Manual `DB::beginTransaction()` without matching `commit()`/`rollBack()` â€” orphaned transaction
### Category
...
### Related Decision Trees
9-11-transaction-scoping-laravel decision trees in 07-decision-trees.md
