# ECC Anti-Patterns â€” Write Skew Prevention
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-18-write-skew-prevention |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Assuming REPEATABLE READ prevents write skew (it does NOT)
...
---
## Anti-Pattern 1: Ignoring: Keep Transactions Short
### Category
...
### Related Skills
Detect and prevent write skew â€” a serialization anomaly where two concurrent transactions read overlapping data, both verify a condition that passes individually, and both write, violating a global invariant.
...
---## Anti-Pattern 3: Assuming REPEATABLE READ prevents write skew (it does NOT)
### Category
...
### Related Decision Trees
9-18-write-skew-prevention decision trees in 07-decision-trees.md
