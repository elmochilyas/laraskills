# ECC Anti-Patterns â€” Deadlock Prevention Patterns
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 9-9-deadlock-prevention-patterns |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Keep Transactions Short
2. Unvalidated Assumptions About Behavior
3. Inconsistent lock order: T1 locks Aâ†’B, T2 locks Bâ†’A â†’ deadlock
...
---## Anti-Pattern 3: Inconsistent lock order: T1 locks Aâ†’B, T2 locks Bâ†’A â†’ deadlock
### Category
...
### Related Decision Trees
9-9-deadlock-prevention-patterns decision trees in 07-decision-trees.md
