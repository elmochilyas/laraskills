# ECC Anti-Patterns â€” Functional Expression Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Indexes |
| **Knowledge Unit** | 3-12-functional-expression-indexes |
...
### Related Skills
Create indexes on the result of an expression (not a raw column value) â€” `LOWER(email)`, `EXTRACT(YEAR FROM date)`, JSON path extraction â€” to make sargable queries that use functions in WHERE clauses, available in PostgreSQL and MySQL 8.0+.
...
---## Anti-Pattern 3: ### Expression mismatch
### Category
...
### Related Decision Trees
3-12-functional-expression-indexes decision trees in 07-decision-trees.md
