# ECC Anti-Patterns â€” Nulls Not Distinct
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use PostgreSQL 15+ `NULLS NOT DISTINCT` to enforce that `NULL` values are treated as equal in unique indexes â€” allowing only one row with `NULL` in a unique column â€” for single-active-record patterns and unique nullable foreign keys.
...
---## Anti-Pattern 3: ### Not checking for existing duplicate NULLs
### Category
...
### Related Decision Trees
3-17-nulls-not-distinct decision trees in 07-decision-trees.md
