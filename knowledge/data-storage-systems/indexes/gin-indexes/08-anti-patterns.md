# ECC Anti-Patterns â€” Gin Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use PostgreSQL GIN indexes for multi-valued data â€” JSONB containment (`@>`), array overlap (`&&`), full-text search (`@@` on tsvector), and trigram-based LIKE searches (`pg_trgm`) â€” selecting appropriate operator classes for query patterns.
...
---## Anti-Pattern 3: ### Not specifying jsonb_path_ops
### Category
...
### Related Decision Trees
3-4-gin-indexes decision trees in 07-decision-trees.md
