# ECC Anti-Patterns â€” Index Alignment With Query Patterns
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Indexes |
| **Knowledge Unit** | 3-26-index-alignment-with-query-patterns |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Avoid Over-Indexing Write-Heavy Tables
2. Unvalidated Assumptions About Behavior
3. ### Indexing WHERE without ORDER BY
...
---
## Anti-Pattern 1: Ignoring: Avoid Over-Indexing Write-Heavy Tables
### Category
...
### Related Skills
Design indexes that align with the full query access pattern â€” WHERE conditions, JOIN conditions, and ORDER BY direction â€” using composite indexes that cover filter columns, include payload columns, and match sort order to eliminate both full table scans and explicit sort operations.
...
---## Anti-Pattern 3: ### Indexing WHERE without ORDER BY
### Category
...
### Related Decision Trees
3-26-index-alignment-with-query-patterns decision trees in 07-decision-trees.md
