# ECC Anti-Patterns â€” Include Columns
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Indexes |
| **Knowledge Unit** | 3-16-include-columns |
...
### Related Skills
Use PostgreSQL `INCLUDE` to add non-key payload columns to an index â€” stored in leaf pages but not participating in the B-Tree structure, uniqueness enforcement, or leftmost prefix rules â€” enabling covering indexes without expanding tree depth.
...
### Related Decision Trees
3-16-include-columns decision trees in 07-decision-trees.md
