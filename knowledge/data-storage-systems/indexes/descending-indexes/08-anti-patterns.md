# ECC Anti-Patterns â€” Descending Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use descending indexes (`ORDER BY col DESC`) in PostgreSQL and MySQL 8.0+ to align index sort order with query sort direction â€” avoiding reverse scans for composite indexes where one column sorts ascending and another descending.
...
---## Anti-Pattern 3: ### Not needed for single-column DESC
### Category
...
### Related Decision Trees
3-15-descending-indexes decision trees in 07-decision-trees.md
