# ECC Anti-Patterns â€” Implicit Type Conversion
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Prevent implicit type conversion in WHERE conditions that bypasses indexes â€” by comparing values with the correct type matching the column definition, casting PHP values to match database column types, and ensuring FK/PK column types are consistent.
...
---## Anti-Pattern 3: ### Eloquent's automatic type binding
### Category
...
### Related Decision Trees
3-29-implicit-type-conversion decision trees in 07-decision-trees.md
