# ECC Anti-Patterns â€” Index Size Estimation
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Estimate index storage requirements and monitor index-to-table size ratios â€” using `pg_indexes_size()` (PostgreSQL) and `INFORMATION_SCHEMA.INNODB_INDEXES` (MySQL) â€” to ensure indexes fit in buffer pool, identify over-indexing, and plan storage capacity.
...
---## Anti-Pattern 3: ### Ignoring index size on memory-constrained systems
### Category
...
### Related Decision Trees
3-22-index-size-estimation decision trees in 07-decision-trees.md
