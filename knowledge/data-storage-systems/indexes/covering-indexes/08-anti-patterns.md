# ECC Anti-Patterns â€” Covering Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Design covering indexes that contain all columns needed by a query, enabling index-only scans that eliminate heap fetches â€” using PostgreSQL's `INCLUDE` for non-key payload columns without affecting B-Tree structure or uniqueness constraints.
...
### Related Decision Trees
3-10-covering-indexes decision trees in 07-decision-trees.md
