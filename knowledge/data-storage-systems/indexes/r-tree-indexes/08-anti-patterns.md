# ECC Anti-Patterns â€” R Tree Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Indexes |
| **Knowledge Unit** | 3-7-r-tree-indexes |
...
### Related Skills
Use MySQL R-Tree indexes (`SPATIAL INDEX`) on GEOMETRY columns for efficient spatial queries â€” proximity, containment, and intersection â€” enabling location-based search and geofencing on MyISAM and InnoDB tables.
...
---## Anti-Pattern 3: ### No spatial index
### Category
...
### Related Decision Trees
3-7-r-tree-indexes decision trees in 07-decision-trees.md
