# ECC Anti-Patterns â€” Composite Index Selectivity
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Design composite indexes based on column cardinality (number of distinct values) â€” placing high-selectivity columns (ID, email) before low-selectivity columns (status, boolean) to maximize early pruning and minimize the number of index entries scanned.
...
---## Anti-Pattern 3: ### Misunderstanding cardinality distribution
### Category
...
### Related Decision Trees
3-18-composite-index-selectivity decision trees in 07-decision-trees.md
