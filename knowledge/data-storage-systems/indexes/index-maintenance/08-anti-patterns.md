# ECC Anti-Patterns â€” Index Maintenance
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Monitor and manage index bloat over time â€” using VACUUM and REINDEX (PostgreSQL), OPTIMIZE TABLE and ALGORITHM=INPLACE (MySQL) â€” scheduling regular maintenance during low-traffic windows to prevent performance degradation from dead index entries and fragmentation.
...
---## Anti-Pattern 3: ### Not monitoring bloat
### Category
...
### Related Decision Trees
3-19-index-maintenance decision trees in 07-decision-trees.md
