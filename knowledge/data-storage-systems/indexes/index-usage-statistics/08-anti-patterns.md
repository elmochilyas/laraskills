# ECC Anti-Patterns â€” Index Usage Statistics
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Query index usage statistics â€” PostgreSQL `pg_stat_user_indexes` (idx_scan, idx_tup_read, idx_tup_fetch) and MySQL `sys.schema_unused_indexes` â€” to identify unused indexes for removal and covering index opportunities by analyzing the ratio of heap fetches to index reads.
...
---## Anti-Pattern 3: ### Resetting stats without analysis
### Category
...
### Related Decision Trees
3-25-index-usage-statistics decision trees in 07-decision-trees.md
