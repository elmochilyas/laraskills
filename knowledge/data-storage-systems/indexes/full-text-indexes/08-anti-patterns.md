# ECC Anti-Patterns â€” Full Text Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Indexes |
| **Knowledge Unit** | 3-13-full-text-indexes |
...
### Related Skills
Implement full-text search indexes â€” MySQL `FULLTEXT` with `MATCH...AGAINST`, and PostgreSQL GIN on `tsvector` with `@@` operator â€” enabling natural language search with word stemming, stop words, and relevance ranking.
...
### Related Decision Trees
3-13-full-text-indexes decision trees in 07-decision-trees.md
