# ECC Anti-Patterns â€” Sargability Rule
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Write WHERE conditions that can use indexes (sargable) by keeping the indexed column alone on one side of the comparison â€” avoiding function wraps (`DATE(col)`, `LOWER(col)`, `YEAR(col)`) and rewriting them as range queries or using expression indexes.
...
---## Anti-Pattern 3: ### whereDate in Laravel
### Category
...
### Related Decision Trees
3-28-sargability-rule decision trees in 07-decision-trees.md
