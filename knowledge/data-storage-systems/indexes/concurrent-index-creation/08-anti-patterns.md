# ECC Anti-Patterns â€” Concurrent Index Creation
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use PostgreSQL `CREATE INDEX CONCURRENTLY` and MySQL `ALGORITHM=INPLACE LOCK=NONE` to add indexes to large tables under live traffic without blocking writes â€” essential for production index additions on tables with > 1M rows.
...
---## Anti-Pattern 3: ### CONCURRENTLY inside transaction
### Category
...
### Related Decision Trees
3-20-concurrent-index-creation decision trees in 07-decision-trees.md
