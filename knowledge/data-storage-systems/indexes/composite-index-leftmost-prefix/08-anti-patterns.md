# ECC Anti-Patterns â€” Composite Index Leftmost Prefix
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Indexes |
| **Knowledge Unit** | 3-8-composite-index-leftmost-prefix |
...
### Related Skills
Design composite (multicolumn) B-Tree indexes respecting the leftmost prefix rule â€” queries must reference a leftmost subset of the indexed columns â€” placing equality columns first, range columns second, and sort columns last for optimal index utilization.
...
### Related Decision Trees
3-8-composite-index-leftmost-prefix decision trees in 07-decision-trees.md
