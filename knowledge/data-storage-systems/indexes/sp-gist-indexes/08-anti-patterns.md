# ECC Anti-Patterns â€” Sp Gist Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use PostgreSQL SP-GiST indexes for data that can be naturally partitioned into non-overlapping regions â€” quadtrees for 2D points, radix trees for string prefixes, and k-d trees for multi-dimensional data â€” when data distribution is highly skewed and B-Tree or GiST struggle.
...
---## Anti-Pattern 3: ### Using SP-GiST when GiST suffices
### Category
...
### Related Decision Trees
3-6-sp-gist-indexes decision trees in 07-decision-trees.md
