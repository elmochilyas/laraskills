# ECC Anti-Patterns â€” Rls Compatible Partial Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Create PostgreSQL partial indexes matching Row-Level Security (RLS) policy `USING` expressions â€” enabling the query planner to use the index during policy evaluation, preventing expensive post-scan filters and full table scans on RLS-protected tables.
...
---## Anti-Pattern 3: ### Index doesn't match policy expression
### Category
...
### Related Decision Trees
3-30-rls-compatible-partial-indexes decision trees in 07-decision-trees.md
