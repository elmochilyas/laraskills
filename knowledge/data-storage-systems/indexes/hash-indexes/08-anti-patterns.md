# ECC Anti-Patterns â€” Hash Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use PostgreSQL hash indexes for fast equality lookups on large tables where only `WHERE col = ?` queries are needed â€” hash indexes are smaller than B-Tree for the same column but do not support range queries, sorting, or prefix matching.
...
---## Anti-Pattern 3: ### Using hash when B-Tree is needed
### Category
...
### Related Decision Trees
3-2-hash-indexes decision trees in 07-decision-trees.md
