...
--------|-----|------------
Efficient spatial queries | Requires spatial type columns | Migrating existing lat/lng columns to spatial types
Built-in MySQL / PostGIS support | Spatial index rebuild on write | Overhead acceptable for moderate write volume

---

# Related Knowledge Units

3.3 GiST indexes | 3.7 R-Tree indexes | 13.11 Spatial data types | 13.12 Spatial indexes
## Ecosystem Usage
