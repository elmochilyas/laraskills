# ECC Anti-Patterns â€” Spatial Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Indexes |
| **Knowledge Unit** | 3-14-spatial-indexes |
...
### Related Skills
Create spatial indexes for geospatial queries â€” MySQL R-Tree on GEOMETRY columns and PostgreSQL GiST on geometry/geography via PostGIS â€” enabling efficient nearest-neighbor, containment, and distance-based queries.
...
---## Anti-Pattern 3: ### Missing spatial index
### Category
...
### Related Decision Trees
3-14-spatial-indexes decision trees in 07-decision-trees.md
