# ECC Anti-Patterns â€” B Tree Index Structure
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Indexes |
| **Knowledge Unit** | 3-1-b-tree-index-structure |
...
### Related Skills
Design B-Tree indexes (the default) for O(log n) lookup performance on equality (`WHERE id = 5`), range (`WHERE id > 100`), prefix (`WHERE name LIKE 'Jon%'`), and sort (`ORDER BY name`) queries â€” understanding clustered vs non-clustered structures and leftmost prefix matching for composite indexes.
...
### Related Decision Trees
3-1-b-tree-index-structure decision trees in 07-decision-trees.md
