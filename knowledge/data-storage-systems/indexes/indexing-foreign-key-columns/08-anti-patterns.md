# ECC Anti-Patterns â€” Indexing Foreign Key Columns
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Ensure all foreign key columns are indexed â€” using Laravel's `constrained()` which auto-indexes, or adding explicit `index()` when using manual FK definitions â€” to prevent full table scans on JOIN queries between related tables.
...
---## Anti-Pattern 3: ### Manual FK without index
### Category
...
### Related Decision Trees
3-24-indexing-foreign-key-columns decision trees in 07-decision-trees.md
