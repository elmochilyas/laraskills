# ECC Anti-Patterns â€” Over Indexing Risks
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Indexes |
| **Knowledge Unit** | 3-23-over-indexing-risks |
...
### Related Skills
Evaluate and mitigate the risks of over-indexing â€” write amplification, storage bloat, vacuum/maintenance overhead â€” by consolidating redundant indexes, maintaining minimum viable indexes based on measured query patterns, and regularly auditing index usage.
...
---## Anti-Pattern 3: ### Index every column
### Category
...
### Related Decision Trees
3-23-over-indexing-risks decision trees in 07-decision-trees.md
