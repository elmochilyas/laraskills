# ECC Anti-Patterns â€” Partial Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use PostgreSQL partial indexes (index on a subset of rows matching a `WHERE` condition) to reduce index size, write maintenance overhead, and query time â€” for active records, unprocessed queue items, and non-deleted rows.
...
---## Anti-Pattern 3: ### Query predicate doesn't match index predicate
### Category
...
### Related Decision Trees
3-11-partial-indexes decision trees in 07-decision-trees.md
