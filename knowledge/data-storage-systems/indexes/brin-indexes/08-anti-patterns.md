# ECC Anti-Patterns â€” Brin Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use PostgreSQL BRIN indexes for large append-only tables with correlated data order (time-series, event logs, audit trails) â€” achieving 100-1000x size reduction over B-Tree while enabling efficient range queries on the correlated column.
...
---## Anti-Pattern 3: ### BRIN on randomly distributed data
### Category
...
### Related Decision Trees
3-5-brin-indexes decision trees in 07-decision-trees.md
