# ECC Anti-Patterns â€” Composite Index Column Ordering
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Apply the cardinality-based column ordering rule: place columns used in equality conditions (`=`, `IN`) before columns used in range conditions (`>`, `<`, `BETWEEN`, `ORDER BY`) â€” maximizing the portion of the composite B-Tree index that can be efficiently searched.
...
---## Anti-Pattern 3: ### Range column in leading position
### Category
...
### Related Decision Trees
3-9-composite-index-column-ordering decision trees in 07-decision-trees.md
