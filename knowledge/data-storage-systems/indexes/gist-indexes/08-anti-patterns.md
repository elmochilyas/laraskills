# ECC Anti-Patterns â€” Gist Indexes
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use PostgreSQL GiST indexes for geometric data (points, polygons), range type overlaps (`&&`), full-text search, and nearest-neighbor (`ORDER BY col <-> point LIMIT 10`) queries â€” leveraging the generalized search tree framework for custom data types.
...
---## Anti-Pattern 3: ### Using GiST for simple equality
### Category
...
### Related Decision Trees
3-3-gist-indexes decision trees in 07-decision-trees.md
