# ECC Anti-Patterns â€” Schema Version Ledger
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-19-schema-version-ledger |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Ledger records migration but schema change fails (inconsistent state)
...
---## Anti-Pattern 3: Ledger records migration but schema change fails (inconsistent state)
### Category
...
### Related Decision Trees
5-19-schema-version-ledger decision trees in 07-decision-trees.md
