# ECC Anti-Patterns â€” Without Global Scope Guardrails
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-12-without-global-scope-guardrails |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Developer adds scope bypass for convenience without realizing the risk
...
---## Anti-Pattern 3: Developer adds scope bypass for convenience without realizing the risk
### Category
...
### Related Decision Trees
5-12-without-global-scope-guardrails decision trees in 07-decision-trees.md
