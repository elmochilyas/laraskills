# ECC Anti-Patterns â€” Eloquent Global Scopes
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-5-eloquent-global-scopes |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. New model created without the trait â€” invisible isolation gap
...
---## Anti-Pattern 3: New model created without the trait â€” invisible isolation gap
### Category
...
### Related Decision Trees
5-5-eloquent-global-scopes decision trees in 07-decision-trees.md
