# ECC Anti-Patterns â€” Per Tenant Scaling
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-16-per-tenant-scaling |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Whale detection too aggressive â€” tenant migrated unnecessarily
...
---## Anti-Pattern 3: Whale detection too aggressive â€” tenant migrated unnecessarily
### Category
...
### Related Decision Trees
5-16-per-tenant-scaling decision trees in 07-decision-trees.md
