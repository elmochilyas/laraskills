# ECC Anti-Patterns â€” Shared Table Single Db
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-1-shared-table-single-db |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Missing global scope on a new model exposes all tenants' data
...
---## Anti-Pattern 3: Missing global scope on a new model exposes all tenants' data
### Category
...
### Related Decision Trees
5-1-shared-table-single-db decision trees in 07-decision-trees.md
