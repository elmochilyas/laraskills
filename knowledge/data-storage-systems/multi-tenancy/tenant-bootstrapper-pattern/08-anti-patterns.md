# ECC Anti-Patterns â€” Tenant Bootstrapper Pattern
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-25-tenant-bootstrapper-pattern |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Eloquent models default to wrong connection (not using 'tenant')
...
---## Anti-Pattern 3: Eloquent models default to wrong connection (not using 'tenant')
### Category
...
### Related Decision Trees
5-25-tenant-bootstrapper-pattern decision trees in 07-decision-trees.md
