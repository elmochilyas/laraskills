# ECC Anti-Patterns â€” Per Tenant Backups Restore
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-27-per-tenant-backups-restore |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Shared-table backup includes all tenants' data (not per-tenant)
...
---## Anti-Pattern 3: Shared-table backup includes all tenants' data (not per-tenant)
### Category
...
### Related Decision Trees
5-27-per-tenant-backups-restore decision trees in 07-decision-trees.md
