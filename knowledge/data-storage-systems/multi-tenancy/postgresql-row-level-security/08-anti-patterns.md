# ECC Anti-Patterns â€” Postgresql Row Level Security
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-14-postgresql-row-level-security |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. RLS policy not created â€” table has RLS enabled but no policy (all rows blocked)
...
---## Anti-Pattern 3: RLS policy not created â€” table has RLS enabled but no policy (all rows blocked)
### Category
...
### Related Decision Trees
5-14-postgresql-row-level-security decision trees in 07-decision-trees.md
