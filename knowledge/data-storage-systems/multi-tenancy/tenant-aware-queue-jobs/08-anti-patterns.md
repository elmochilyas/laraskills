# ECC Anti-Patterns â€” Tenant Aware Queue Jobs
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-7-tenant-aware-queue-jobs |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Tenant ID not serialized â€” job runs in wrong or no tenant context
...
---## Anti-Pattern 3: Tenant ID not serialized â€” job runs in wrong or no tenant context
### Category
...
### Related Decision Trees
5-7-tenant-aware-queue-jobs decision trees in 07-decision-trees.md
