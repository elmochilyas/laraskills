# ECC Anti-Patterns â€” Tenant Aware Caching
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-30-tenant-aware-caching |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Cache prefix not set before cache is accessed in request lifecycle
...
---## Anti-Pattern 3: Cache prefix not set before cache is accessed in request lifecycle
### Category
...
### Related Decision Trees
5-30-tenant-aware-caching decision trees in 07-decision-trees.md
