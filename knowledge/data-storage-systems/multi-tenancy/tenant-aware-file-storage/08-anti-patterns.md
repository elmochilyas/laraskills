# ECC Anti-Patterns â€” Tenant Aware File Storage
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-20-tenant-aware-file-storage |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. File path doesn't include tenant ID â€” cross-tenant file access
...
---## Anti-Pattern 3: File path doesn't include tenant ID â€” cross-tenant file access
### Category
...
### Related Decision Trees
5-20-tenant-aware-file-storage decision trees in 07-decision-trees.md
