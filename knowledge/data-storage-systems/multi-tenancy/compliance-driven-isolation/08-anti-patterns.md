# ECC Anti-Patterns â€” Compliance Driven Isolation
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-22-compliance-driven-isolation |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Assuming shared-table isolation satisfies HIPAA (it does not â€” PHI requires stricter controls)
...
---## Anti-Pattern 3: Assuming shared-table isolation satisfies HIPAA (it does not â€” PHI requires stricter controls)
### Category
...
### Related Decision Trees
5-22-compliance-driven-isolation decision trees in 07-decision-trees.md
