# ECC Anti-Patterns â€” Schema Per Tenant
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-2-schema-per-tenant |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Search path not reset between requests in persistent worker (Octane)
...
---## Anti-Pattern 3: Search path not reset between requests in persistent worker (Octane)
### Category
...
### Related Decision Trees
5-2-schema-per-tenant decision trees in 07-decision-trees.md
