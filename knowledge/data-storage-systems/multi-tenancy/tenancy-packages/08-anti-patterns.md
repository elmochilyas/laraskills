# ECC Anti-Patterns â€” Tenancy Packages
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-24-tenancy-packages |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Choosing package that doesn't support required isolation model
...
---## Anti-Pattern 3: Choosing package that doesn't support required isolation model
### Category
...
### Related Decision Trees
5-24-tenancy-packages decision trees in 07-decision-trees.md
