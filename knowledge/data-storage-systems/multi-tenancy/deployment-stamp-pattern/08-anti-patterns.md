# ECC Anti-Patterns â€” Deployment Stamp Pattern
---
## Metadata
| Field | Value |
|-------|-------|
...
3. Stamp template missing component (no cache, no queue worker)
...
---## Anti-Pattern 3: Stamp template missing component (no cache, no queue worker)
### Category
...
### Related Decision Trees
5-28-deployment-stamp-pattern decision trees in 07-decision-trees.md
