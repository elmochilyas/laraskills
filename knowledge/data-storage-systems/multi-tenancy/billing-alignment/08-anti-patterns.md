# ECC Anti-Patterns â€” Billing Alignment
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-21-billing-alignment |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Shared-table attribution is inaccurate (all tenants share same pool)
...
---## Anti-Pattern 3: Shared-table attribution is inaccurate (all tenants share same pool)
### Category
...
### Related Decision Trees
5-21-billing-alignment decision trees in 07-decision-trees.md
