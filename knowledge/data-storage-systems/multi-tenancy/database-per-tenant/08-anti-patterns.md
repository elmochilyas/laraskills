# ECC Anti-Patterns â€” Database Per Tenant
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-3-database-per-tenant |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Missing `DB::purge()` after config change â€” stale connection to wrong database
...
---## Anti-Pattern 3: Missing `DB::purge()` after config change â€” stale connection to wrong database
### Category
...
### Related Decision Trees
5-3-database-per-tenant decision trees in 07-decision-trees.md
