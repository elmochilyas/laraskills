# ECC Anti-Patterns â€” Tenant Aware Middleware
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-6-tenant-aware-middleware |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Middleware runs after Session/StartSession â€” session depends on tenant DB
...
---## Anti-Pattern 3: Middleware runs after Session/StartSession â€” session depends on tenant DB
### Category
...
### Related Decision Trees
5-6-tenant-aware-middleware decision trees in 07-decision-trees.md
