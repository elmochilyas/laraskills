# ECC Anti-Patterns â€” Tenant Migration Canary
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-29-tenant-migration-canary |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Canary group doesn't include diverse schemas â€” misses edge cases
...
### Related Skills
Roll out database migrations to tenants in phases (canary â†’ rings), detecting issues early before affecting all tenants.
...
---## Anti-Pattern 3: Canary group doesn't include diverse schemas â€” misses edge cases
### Category
...
### Related Decision Trees
5-29-tenant-migration-canary decision trees in 07-decision-trees.md
