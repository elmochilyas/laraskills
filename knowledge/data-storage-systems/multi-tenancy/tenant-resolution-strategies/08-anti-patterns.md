# ECC Anti-Patterns â€” Tenant Resolution Strategies
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-4-tenant-resolution-strategies |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Tenant resolution runs after middleware that queries tenant data
...
---## Anti-Pattern 3: Tenant resolution runs after middleware that queries tenant data
### Category
...
### Related Decision Trees
5-4-tenant-resolution-strategies decision trees in 07-decision-trees.md
