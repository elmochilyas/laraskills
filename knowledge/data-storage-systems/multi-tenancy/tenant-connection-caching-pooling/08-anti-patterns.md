# ECC Anti-Patterns â€” Tenant Connection Caching Pooling
---
## Metadata
| Field | Value |
|-------|-------|
...
3. Pooler not configured for PHP-FPM â€” each worker opens a new connection
...
---## Anti-Pattern 3: Pooler not configured for PHP-FPM â€” each worker opens a new connection
### Category
...
### Related Decision Trees
5-13-tenant-connection-caching-pooling decision trees in 07-decision-trees.md
