# ECC Anti-Patterns â€” Migration Orchestration Across Tenants
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-9-migration-orchestration-across-tenants |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Migration fails on one tenant but ledger marks it as complete
...
---## Anti-Pattern 3: Migration fails on one tenant but ledger marks it as complete
### Category
...
### Related Decision Trees
5-9-migration-orchestration-across-tenants decision trees in 07-decision-trees.md
