# ECC Anti-Patterns â€” Tenant Provisioning Lifecycle
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-10-tenant-provisioning-lifecycle |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Provisioning times out â€” tenant stuck in `provisioning` state
...
---## Anti-Pattern 3: Provisioning times out â€” tenant stuck in `provisioning` state
### Category
...
### Related Decision Trees
5-10-tenant-provisioning-lifecycle decision trees in 07-decision-trees.md
