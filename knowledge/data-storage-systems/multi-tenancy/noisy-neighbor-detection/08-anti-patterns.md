# ECC Anti-Patterns â€” Noisy Neighbor Detection
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-15-noisy-neighbor-detection |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Metrics not tagged per tenant â€” cannot identify noisy neighbor
...
---## Anti-Pattern 3: Metrics not tagged per tenant â€” cannot identify noisy neighbor
### Category
...
### Related Decision Trees
5-15-noisy-neighbor-detection decision trees in 07-decision-trees.md
