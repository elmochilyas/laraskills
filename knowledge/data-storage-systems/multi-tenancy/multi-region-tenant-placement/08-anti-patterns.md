# ECC Anti-Patterns â€” Multi Region Tenant Placement
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-23-multi-region-tenant-placement |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Tenant provisioned in wrong region (IP geolocation inaccurate)
...
---## Anti-Pattern 3: Tenant provisioned in wrong region (IP geolocation inaccurate)
### Category
...
### Related Decision Trees
5-23-multi-region-tenant-placement decision trees in 07-decision-trees.md
