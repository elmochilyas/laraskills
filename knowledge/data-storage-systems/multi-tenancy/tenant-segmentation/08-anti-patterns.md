# ECC Anti-Patterns â€” Tenant Segmentation
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-17-tenant-segmentation |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Free tier tenant accidentally gets Pro isolation (cost leak)
...
---## Anti-Pattern 3: Free tier tenant accidentally gets Pro isolation (cost leak)
### Category
...
### Related Decision Trees
5-17-tenant-segmentation decision trees in 07-decision-trees.md
