# ECC Anti-Patterns â€” Tenant Aware Commands
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-8-tenant-aware-commands |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Shared state between tenant iterations (static variables, cached data)
...
---## Anti-Pattern 3: Shared state between tenant iterations (static variables, cached data)
### Category
...
### Related Decision Trees
5-8-tenant-aware-commands decision trees in 07-decision-trees.md
