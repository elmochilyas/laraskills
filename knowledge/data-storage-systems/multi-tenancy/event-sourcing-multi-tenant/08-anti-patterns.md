# ECC Anti-Patterns â€” Event Sourcing Multi Tenant
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 5-26-event-sourcing-multi-tenant |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Never Trust Tenant ID From Request
2. Unvalidated Assumptions About Behavior
3. Projection rebuild replays all tenants' events (slow and data leak)
...
---## Anti-Pattern 3: Projection rebuild replays all tenants' events (slow and data leak)
### Category
...
### Related Decision Trees
5-26-event-sourcing-multi-tenant decision trees in 07-decision-trees.md
