# ECC Anti-Patterns â€” Replica Lag Monitoring
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-6-replica-lag-monitoring |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. `Seconds_Behind_Master` shows 0 but replica hasn't processed events (relay log gap)
...
---## Anti-Pattern 3: `Seconds_Behind_Master` shows 0 but replica hasn't processed events (relay log gap)
### Category
...
### Related Decision Trees
7-6-replica-lag-monitoring decision trees in 07-decision-trees.md
