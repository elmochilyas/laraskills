# ECC Anti-Patterns â€” Master Replica Topology
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-1-master-replica-topology |
...
---## Anti-Pattern 3: Replication lag causes stale reads
### Category
...
### Related Decision Trees
7-1-master-replica-topology decision trees in 07-decision-trees.md
