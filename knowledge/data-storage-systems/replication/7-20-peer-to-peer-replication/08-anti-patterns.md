# ECC Anti-Patterns â€” 7-20-peer-to-peer-replication
---
## Metadata
| Field | Value |
|-------|-------|
...
3. Split-brain: network partition splits cluster, both sides accept writes
...
---## Anti-Pattern 3: Split-brain: network partition splits cluster, both sides accept writes
### Category
...
### Related Decision Trees
7-20-peer-to-peer-replication decision trees in 07-decision-trees.md
