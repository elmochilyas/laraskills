# ECC Anti-Patterns â€” Read Replica Sizing
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-16-read-replica-sizing |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Under-provisioned replica: lag grows during peak and never catches up
...
---## Anti-Pattern 3: Under-provisioned replica: lag grows during peak and never catches up
### Category
...
### Related Decision Trees
7-16-read-replica-sizing decision trees in 07-decision-trees.md
