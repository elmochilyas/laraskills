# ECC Anti-Patterns â€” Lag Aware Read Splitting
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-7-lag-aware-read-splitting |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Checking lag on every query adds overhead â€” always cache
...
---## Anti-Pattern 3: Checking lag on every query adds overhead â€” always cache
### Category
...
### Related Decision Trees
7-7-lag-aware-read-splitting decision trees in 07-decision-trees.md
