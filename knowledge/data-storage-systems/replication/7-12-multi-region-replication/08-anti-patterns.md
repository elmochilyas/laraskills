# ECC Anti-Patterns â€” 7-12-multi-region-replication
---
## Metadata
| Field | Value |
|-------|-------|
...
3. Cross-region latency causes write timeouts (async replication)
...
---## Anti-Pattern 3: Cross-region latency causes write timeouts (async replication)
### Category
...
### Related Decision Trees
7-12-multi-region-replication decision trees in 07-decision-trees.md
