# ECC Anti-Patterns â€” Proxysql Query Routing
---
## Metadata
| Field | Value |
|-------|-------|
...
3. `SELECT ... FOR UPDATE` routed to replica â€” stale locks and data
...
---## Anti-Pattern 3: `SELECT ... FOR UPDATE` routed to replica â€” stale locks and data
### Category
...
### Related Decision Trees
7-17-proxysql-query-routing decision trees in 07-decision-trees.md
