# ECC Anti-Patterns â€” 7-15-mariadb-mysql-differences
---
## Metadata
| Field | Value |
|-------|-------|
...
3. MySQL-to-MariaDB replication: GTID format mismatch
...
---## Anti-Pattern 3: MySQL-to-MariaDB replication: GTID format mismatch
### Category
...
### Related Decision Trees
7-15-mariadb-mysql-differences decision trees in 07-decision-trees.md
