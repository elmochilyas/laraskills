# ECC Anti-Patterns â€” 7-13-plan-replication-topology
---
## Metadata
| Field | Value |
|-------|-------|
...
1. Ignoring Core Concept Implementation
2. Configuration Without Understanding
3. Too few replicas for read traffic (replicas overloaded)
...
---
## Anti-Pattern 1: Ignoring Core Concept Implementation
### Category
...
### Related Rules
Refer to 05-rules.md in this KU
### Related Skills
Design the overall replication architecture â€” determining the number of replicas, their hierarchy, and placement â€” to meet availability, scalability, and durability requirements.
### Related Decision Trees
## Decision Inventory
---## Anti-Pattern 2: Configuration Without Understanding
### Category
...
---## Anti-Pattern 3: Too few replicas for read traffic (replicas overloaded)
### Category
...
### Warning Signs
- Decision tree ## Decision Inventory was available but not consulted
### Why It Is Harmful
...
### Related Decision Trees
7-13-plan-replication-topology decision trees in 07-decision-trees.md
