# ECC Anti-Patterns â€” Replica Lag Causes
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-5-replica-lag-causes |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Assuming lag is always network-related (usually compute or IO)
...
---## Anti-Pattern 3: Assuming lag is always network-related (usually compute or IO)
### Category
...
### Related Decision Trees
7-5-replica-lag-causes decision trees in 07-decision-trees.md
