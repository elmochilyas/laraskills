# ECC Anti-Patterns â€” Cascading Replication
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-12-cascading-replication |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Deep chains (>3 levels): lag grows too large, failure diagnosis complex
...
---## Anti-Pattern 3: Deep chains (>3 levels): lag grows too large, failure diagnosis complex
### Category
...
### Related Decision Trees
7-12-cascading-replication decision trees in 07-decision-trees.md
