# ECC Anti-Patterns â€” Load Balancing Replicas
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-9-load-balancing-replicas |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Uneven load with Laravel random default: smaller replica becomes bottleneck
...
---## Anti-Pattern 3: Uneven load with Laravel random default: smaller replica becomes bottleneck
### Category
...
### Related Decision Trees
7-9-load-balancing-replicas decision trees in 07-decision-trees.md
