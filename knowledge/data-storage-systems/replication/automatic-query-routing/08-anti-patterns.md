# ECC Anti-Patterns â€” Automatic Query Routing
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-3-automatic-query-routing |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. `DB::statement('SELECT ...')` routes to write connection (use DB::select)
...
---## Anti-Pattern 3: `DB::statement('SELECT ...')` routes to write connection (use DB::select)
### Category
...
### Related Decision Trees
7-3-automatic-query-routing decision trees in 07-decision-trees.md
