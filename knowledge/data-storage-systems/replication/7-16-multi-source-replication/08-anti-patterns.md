# ECC Anti-Patterns â€” 7-16-multi-source-replication
---
## Metadata
| Field | Value |
|-------|-------|
...
3. Table name collisions â€” data from different sources overwrites each other
...
---## Anti-Pattern 3: Table name collisions â€” data from different sources overwrites each other
### Category
...
### Related Decision Trees
7-16-multi-source-replication decision trees in 07-decision-trees.md
