# ECC Anti-Patterns â€” 7-14-gtid-based-replication
---
## Metadata
| Field | Value |
|-------|-------|
...
3. `enforce_gtid_consistency = OFF` â€” non-transactional statements break GTID
...
---## Anti-Pattern 3: `enforce_gtid_consistency = OFF` â€” non-transactional statements break GTID
### Category
...
### Related Decision Trees
7-14-gtid-based-replication decision trees in 07-decision-trees.md
