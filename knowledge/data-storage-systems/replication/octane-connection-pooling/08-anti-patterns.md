# ECC Anti-Patterns â€” Octane Connection Pooling
---
## Metadata
| Field | Value |
|-------|-------|
...
3. No pool config: Octane creates new connection per request, same overhead as PHP-FPM
...
---## Anti-Pattern 3: No pool config: Octane creates new connection per request, same overhead as PHP-FPM
### Category
...
### Related Decision Trees
7-14-octane-connection-pooling decision trees in 07-decision-trees.md
