# ECC Anti-Patterns â€” Rds Proxy Aurora
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-19-rds-proxy-aurora |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. RDS Proxy cost ($15-20/month) exceeds benefit for small deployments
...
---## Anti-Pattern 3: RDS Proxy cost ($15-20/month) exceeds benefit for small deployments
### Category
...
### Related Decision Trees
7-19-rds-proxy-aurora decision trees in 07-decision-trees.md
