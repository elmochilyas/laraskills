# ECC Anti-Patterns â€” Connection Pooling Replicas
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-8-connection-pooling-replicas |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Queue wait grows unbounded: pool size too small for peak concurrency
...
---## Anti-Pattern 3: Queue wait grows unbounded: pool size too small for peak concurrency
### Category
...
### Related Decision Trees
7-8-connection-pooling-replicas decision trees in 07-decision-trees.md
