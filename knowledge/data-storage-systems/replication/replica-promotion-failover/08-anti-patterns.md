# ECC Anti-Patterns â€” Replica Promotion Failover
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-11-replica-promotion-failover |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Split-brain: old primary comes back and accepts writes â€” use VIP/storage fencing
...
---## Anti-Pattern 3: Split-brain: old primary comes back and accepts writes â€” use VIP/storage fencing
### Category
...
### Related Decision Trees
7-11-replica-promotion-failover decision trees in 07-decision-trees.md
