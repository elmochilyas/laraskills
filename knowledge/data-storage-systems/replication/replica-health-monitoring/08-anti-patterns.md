# ECC Anti-Patterns â€” Replica Health Monitoring
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-21-replica-health-monitoring |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Replica running but not applying (IO thread OK, SQL thread stopped â€” stale data)
...
---## Anti-Pattern 3: Replica running but not applying (IO thread OK, SQL thread stopped â€” stale data)
### Category
...
### Related Decision Trees
7-21-replica-health-monitoring decision trees in 07-decision-trees.md
