# ECC Anti-Patterns â€” Laravel Read Write Config
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-2-laravel-read-write-config |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Sticky writes disabled â€” stale read after write
...
---## Anti-Pattern 3: Sticky writes disabled â€” stale read after write
### Category
...
### Related Decision Trees
7-2-laravel-read-write-config decision trees in 07-decision-trees.md
