# ECC Anti-Patterns â€” Synchronous Replication
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-13-synchronous-replication |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Write latency penalty: all writes wait for slowest node â€” avoid cross-region sync clusters
...
---## Anti-Pattern 3: Write latency penalty: all writes wait for slowest node â€” avoid cross-region sync clusters
### Category
...
### Related Decision Trees
7-13-synchronous-replication decision trees in 07-decision-trees.md
