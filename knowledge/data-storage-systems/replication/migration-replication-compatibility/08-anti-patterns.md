# ECC Anti-Patterns â€” Migration Replication Compatibility
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-20-migration-replication-compatibility |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. `ALGORITHM=COPY` locks tables on primary, blocks writes, and delays replication
...
---
## Anti-Pattern 1: Ignoring: Always Monitor Replica Lag
### Category
...
---## Anti-Pattern 3: `ALGORITHM=COPY` locks tables on primary, blocks writes, and delays replication
### Category
...
### Related Decision Trees
7-20-migration-replication-compatibility decision trees in 07-decision-trees.md
