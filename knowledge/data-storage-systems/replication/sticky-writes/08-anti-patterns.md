# ECC Anti-Patterns â€” Sticky Writes
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-4-sticky-writes |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Sticky writes disabled â€” user doesn't see their own write on next page load
...
---## Anti-Pattern 3: Sticky writes disabled â€” user doesn't see their own write on next page load
### Category
...
### Related Decision Trees
7-4-sticky-writes decision trees in 07-decision-trees.md
