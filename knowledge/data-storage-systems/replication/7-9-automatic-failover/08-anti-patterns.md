# ECC Anti-Patterns â€” 7-9-automatic-failover
---
## Metadata
| Field | Value |
|-------|-------|
...
3. False positive failover (network blip kills primary, replicas fine)
...
---## Anti-Pattern 3: False positive failover (network blip kills primary, replicas fine)
### Category
...
### Related Decision Trees
7-9-automatic-failover decision trees in 07-decision-trees.md
