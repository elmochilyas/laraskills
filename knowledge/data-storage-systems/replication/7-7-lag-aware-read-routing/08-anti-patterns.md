# ECC Anti-Patterns â€” 7-7-lag-aware-read-routing
---
## Metadata
| Field | Value |
|-------|-------|
...
3. Lag threshold too low â€” every read goes to primary
...
---## Anti-Pattern 3: Lag threshold too low â€” every read goes to primary
### Category
...
### Related Decision Trees
7-7-lag-aware-read-routing decision trees in 07-decision-trees.md
