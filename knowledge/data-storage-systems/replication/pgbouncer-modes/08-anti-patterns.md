# ECC Anti-Patterns â€” Pgbouncer Modes
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-18-pgbouncer-modes |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Prepared statements in transaction pooling: create on every connection â€” fails. Use `ATTR_EMULATE_PREPARES`
...
---## Anti-Pattern 3: Prepared statements in transaction pooling: create on every connection â€” fails. Use `ATTR_EMULATE_PREPARES`
### Category
...
### Related Decision Trees
7-18-pgbouncer-modes decision trees in 07-decision-trees.md
