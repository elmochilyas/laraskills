# ECC Anti-Patterns â€” Read Replica Specific Workloads
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-15-read-replica-specific-workloads |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Heavy queries accidentally run on user-facing replica (code review miss)
...
---## Anti-Pattern 3: Heavy queries accidentally run on user-facing replica (code review miss)
### Category
...
### Related Decision Trees
7-15-read-replica-specific-workloads decision trees in 07-decision-trees.md
