# ECC Anti-Patterns â€” 7-10-multi-master-replication
---
## Metadata
| Field | Value |
|-------|-------|
...
3. Dead tuples/bloat accumulate faster (no single cleanup coordinator)
...
---## Anti-Pattern 3: Dead tuples/bloat accumulate faster (no single cleanup coordinator)
### Category
...
### Related Decision Trees
7-10-multi-master-replication decision trees in 07-decision-trees.md
