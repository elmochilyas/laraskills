# ECC Anti-Patterns â€” Multi Region Replication
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 7-10-multi-region-replication |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Monitor Replica Lag
2. Unvalidated Assumptions About Behavior
3. Expecting sub-second lag across intercontinental links (physical limits apply)
...
---## Anti-Pattern 3: Expecting sub-second lag across intercontinental links (physical limits apply)
### Category
...
### Related Decision Trees
7-10-multi-region-replication decision trees in 07-decision-trees.md
