# ECC Anti-Patterns â€” Cross Shard Join Limitations
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-8-cross-shard-join-limitations |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Eloquent relations load data across shards without awareness
...
---## Anti-Pattern 3: Eloquent relations load data across shards without awareness
### Category
...
### Related Decision Trees
6-8-cross-shard-join-limitations decision trees in 07-decision-trees.md
