# ECC Anti-Patterns â€” Shard Aware Model Traits
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-14-shard-aware-model-traits |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Model saved to wrong shard (connection not set before write)
...
---## Anti-Pattern 3: Model saved to wrong shard (connection not set before write)
### Category
...
### Related Decision Trees
6-14-shard-aware-model-traits decision trees in 07-decision-trees.md
