# ECC Anti-Patterns â€” Shard Key Selection Principles
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-1-shard-key-selection-principles |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Date-only shard key: all writes go to current month's shard
...
---## Anti-Pattern 3: Date-only shard key: all writes go to current month's shard
### Category
...
### Related Decision Trees
6-1-shard-key-selection-principles decision trees in 07-decision-trees.md
