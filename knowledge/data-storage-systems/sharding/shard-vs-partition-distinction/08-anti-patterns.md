# ECC Anti-Patterns â€” Shard Vs Partition Distinction
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-22-shard-vs-partition-distinction |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Choosing sharding when partitioning would suffice (unnecessary complexity)
...
---## Anti-Pattern 3: Choosing sharding when partitioning would suffice (unnecessary complexity)
### Category
...
### Related Decision Trees
6-22-shard-vs-partition-distinction decision trees in 07-decision-trees.md
