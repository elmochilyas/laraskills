# ECC Anti-Patterns â€” Read Replica Per Shard
---
## Metadata
| Field | Value |
|-------|-------|
...
3. Replica lag causes stale reads on one shard but not others
...
---## Anti-Pattern 3: Replica lag causes stale reads on one shard but not others
### Category
...
### Related Decision Trees
6-17-read-replica-per-shard decision trees in 07-decision-trees.md
