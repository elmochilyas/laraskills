# ECC Anti-Patterns â€” Hot Shard Mitigation
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-24-hot-shard-mitigation |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Treating symptom (high CPU) without fixing root cause (bad shard key)
...
---## Anti-Pattern 3: Treating symptom (high CPU) without fixing root cause (bad shard key)
### Category
...
### Related Decision Trees
6-24-hot-shard-mitigation decision trees in 07-decision-trees.md
