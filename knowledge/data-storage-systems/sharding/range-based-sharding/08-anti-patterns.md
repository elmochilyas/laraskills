# ECC Anti-Patterns â€” Range Based Sharding
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-3-range-based-sharding |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Monotonically increasing key: last range is hot (all new writes)
...
---## Anti-Pattern 3: Monotonically increasing key: last range is hot (all new writes)
### Category
...
### Related Decision Trees
6-3-range-based-sharding decision trees in 07-decision-trees.md
