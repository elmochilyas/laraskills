# ECC Anti-Patterns â€” Shard Level Backups Monitoring
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-18-shard-level-backups-monitoring |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Backup of one shard fails â€” not detected until restore needed
...
---## Anti-Pattern 3: Backup of one shard fails â€” not detected until restore needed
### Category
...
### Related Decision Trees
6-18-shard-level-backups-monitoring decision trees in 07-decision-trees.md
