# ECC Anti-Patterns â€” Adding New Shards
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-12-adding-new-shards |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. New shard not added to routing â€” never receives traffic
...
---## Anti-Pattern 3: New shard not added to routing â€” never receives traffic
### Category
...
### Related Decision Trees
6-12-adding-new-shards decision trees in 07-decision-trees.md
