# ECC Anti-Patterns â€” Shard Proxy Considerations
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-19-shard-proxy-considerations |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Proxy not designed for shard routing (routes to wrong shard)
...
---## Anti-Pattern 3: Proxy not designed for shard routing (routes to wrong shard)
### Category
...
### Related Decision Trees
6-19-shard-proxy-considerations decision trees in 07-decision-trees.md
