# ECC Anti-Patterns â€” Shard Mapping Routing
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-5-shard-mapping-routing |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. ShardRouter not deterministic â€” same key routes to different shards
...
---## Anti-Pattern 3: ShardRouter not deterministic â€” same key routes to different shards
### Category
...
### Related Decision Trees
6-5-shard-mapping-routing decision trees in 07-decision-trees.md
