# ECC Anti-Patterns â€” Time Based Sharding
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-21-time-based-sharding |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Hot latest shard: all writes go to current time shard
...
---## Anti-Pattern 3: Hot latest shard: all writes go to current time shard
### Category
...
### Related Decision Trees
6-21-time-based-sharding decision trees in 07-decision-trees.md
