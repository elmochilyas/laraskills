# ECC Anti-Patterns â€” Shard Groups
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-13-shard-groups |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Entities in same group but on different physical shards â€” group concept broken
...
---## Anti-Pattern 3: Entities in same group but on different physical shards â€” group concept broken
### Category
...
### Related Decision Trees
6-13-shard-groups decision trees in 07-decision-trees.md
