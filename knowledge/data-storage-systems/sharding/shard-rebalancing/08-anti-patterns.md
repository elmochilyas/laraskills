# ECC Anti-Patterns â€” Shard Rebalancing
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-10-shard-rebalancing |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Migration causes high load on source shard (throttle migration rate)
...
---## Anti-Pattern 3: Migration causes high load on source shard (throttle migration rate)
### Category
...
### Related Decision Trees
6-10-shard-rebalancing decision trees in 07-decision-trees.md
