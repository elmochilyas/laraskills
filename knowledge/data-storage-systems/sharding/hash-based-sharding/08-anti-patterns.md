# ECC Anti-Patterns â€” Hash Based Sharding
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-2-hash-based-sharding |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Hash function produces collisions (different keys â†’ same shard) â€” OK
...
---## Anti-Pattern 3: Hash function produces collisions (different keys â†’ same shard) â€” OK
### Category
...
### Related Decision Trees
6-2-hash-based-sharding decision trees in 07-decision-trees.md
