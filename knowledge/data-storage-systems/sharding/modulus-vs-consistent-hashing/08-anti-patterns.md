# ECC Anti-Patterns â€” Modulus Vs Consistent Hashing
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-20-modulus-vs-consistent-hashing |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Using modulo when shard count changes â€” massive data movement
...
---## Anti-Pattern 3: Using modulo when shard count changes â€” massive data movement
### Category
...
### Related Decision Trees
6-20-modulus-vs-consistent-hashing decision trees in 07-decision-trees.md
