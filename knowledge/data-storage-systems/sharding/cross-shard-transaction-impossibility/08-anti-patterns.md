# ECC Anti-Patterns â€” Cross Shard Transaction Impossibility
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-9-cross-shard-transaction-impossibility |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Assuming 2PC solves all cross-shard transaction problems (coordinator failure, lock holding)
...
---
## Anti-Pattern 1: Ignoring: Choose High-Cardinality Shard Key
### Category
...
---## Anti-Pattern 3: Assuming 2PC solves all cross-shard transaction problems (coordinator failure, lock holding)
### Category
...
### Related Decision Trees
6-9-cross-shard-transaction-impossibility decision trees in 07-decision-trees.md
