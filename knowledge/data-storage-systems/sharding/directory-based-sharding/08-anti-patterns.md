# ECC Anti-Patterns â€” Directory Based Sharding
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-4-directory-based-sharding |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Shard map is single point of failure (use HA cluster)
...
---## Anti-Pattern 3: Shard map is single point of failure (use HA cluster)
### Category
...
### Related Decision Trees
6-4-directory-based-sharding decision trees in 07-decision-trees.md
