# ECC Anti-Patterns â€” Swoole Octane Coroutine Dispatch
---
## Metadata
| Field | Value |
|-------|-------|
...
3. Coroutine deadlock (all coroutines waiting for same connection)
...
---## Anti-Pattern 3: Coroutine deadlock (all coroutines waiting for same connection)
### Category
...
### Related Decision Trees
6-16-swoole-octane-coroutine-dispatch decision trees in 07-decision-trees.md
