# ECC Anti-Patterns â€” Fan Out Queries
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-7-fan-out-queries |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Sequential fan-out (query shards one by one) â€” slowest shard Ã— N
...
---## Anti-Pattern 3: Sequential fan-out (query shards one by one) â€” slowest shard Ã— N
### Category
...
### Related Decision Trees
6-7-fan-out-queries decision trees in 07-decision-trees.md
