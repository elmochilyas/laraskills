# ECC Anti-Patterns â€” Shard Aware Id Generation
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Subdomain** | Sharding |
| **Knowledge Unit** | 6-6-shard-aware-id-generation |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Choose High-Cardinality Shard Key
2. Unvalidated Assumptions About Behavior
3. Clock skew: Snowflake IDs go backward (use clock drift tolerance)
...
---## Anti-Pattern 3: Clock skew: Snowflake IDs go backward (use clock drift tolerance)
### Category
...
### Related Decision Trees
6-6-shard-aware-id-generation decision trees in 07-decision-trees.md
