# ECC Anti-Patterns â€” Connection health checks (heartbeat queries, idle connection timeout)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-14-connection-health-checks |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. SELECT 1 on every database query
3. No health check on Octane pool â€” stale connection may be returned
4. Wrong Decision Without Context Evaluation
5. Health checks that modify data
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: SELECT 1 on every database query
### Category
...
### Warning Signs
- No health check on Octane pool
- Manual SELECT 1 on every query in PHP-FPM
- Health check timeout too high
- Not handling health check exception
...
---## Anti-Pattern 3: No health check on Octane pool â€” stale connection may be returned
### Category
...
### Related Decision Trees
10-14-connection-health-checks decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Health checks that modify data
### Category
