# ECC Anti-Patterns â€” Transaction pooling limitations (prepared statements, session state, SET commands)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-10-transaction-pooling-limitations |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. Blindly enabling transaction pooling without application audit
3. Transaction pooling without emulate prepares â€” "prepared statement already exists" errors
4. Wrong Decision Without Context Evaluation
5. "It works in dev" syndrome
---
...
---
## Anti-Pattern 1: Ignoring: Deploy Server-Side Pooler For PHP-FPM
### Category
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: Blindly enabling transaction pooling without application audit
### Category
...
### Warning Signs
- Transaction pooling without emulate prepares
- SET SESSION commands in middleware
- LISTEN/NOTIFY with transaction pooling
- No server_reset_query
- Temporary tables in transaction pooling
### Why It Is Harmful
...
---## Anti-Pattern 3: Transaction pooling without emulate prepares â€” "prepared statement already exists" errors
### Category
...
### Related Decision Trees
10-10-transaction-pooling-limitations decision trees in 07-decision-trees.md
---## Anti-Pattern 5: "It works in dev" syndrome
### Category
