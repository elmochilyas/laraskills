# ECC Anti-Patterns â€” Connection purging and reconnection (DB::purge, DB::reconnect)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-6-connection-purging-reconnection |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. Purge-reconnect in every model accessor
3. Config change without purge â€” stale PDO reused silently
4. Wrong Decision Without Context Evaluation
5. Purge without config change
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: Purge-reconnect in every model accessor
### Category
...
- Purging but not reconnecting
- Purging wrong connection name
- Purging inside transaction
- Not re-hydrating models after purge
### Why It Is Harmful
...
---## Anti-Pattern 3: Config change without purge â€” stale PDO reused silently
### Category
...
### Related Decision Trees
10-6-connection-purging-reconnection decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Purge without config change
### Category
