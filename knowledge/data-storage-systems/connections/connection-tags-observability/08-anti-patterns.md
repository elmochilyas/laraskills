# ECC Anti-Patterns â€” Connection tags and observability (application_name, per-connection metadata)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-8-connection-tags-observability |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. No tagging on migration connections
3. No connection tags at all â€” all connections appear as "PHP" or "PostgreSQL"
4. Wrong Decision Without Context Evaluation
5. Static tags in dynamic environments
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: No tagging on migration connections
### Category
...
### Warning Signs
- No connection tags at all
- Tags in transaction pooling without per-transaction SET
- Sensitive data in tags
- Tags too vague
- No tag in Horizon workers
### Why It Is Harmful
...
---## Anti-Pattern 3: No connection tags at all â€” all connections appear as "PHP" or "PostgreSQL"
### Category
...
### Related Decision Trees
10-8-connection-tags-observability decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Static tags in dynamic environments
### Category
