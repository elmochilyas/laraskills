# ECC Anti-Patterns â€” Connection string management (environment variables, dynamic password rotation)
---
## Metadata
| Field | Value |
|-------|-------|
...
2. Single `.env` for multi-environment
3. Hardcoded credentials in config/database.php â€” security breach
4. Wrong Decision Without Context Evaluation
5. Config files with hardcoded fallbacks
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: Single `.env` for multi-environment
### Category
...
### Warning Signs
- Hardcoded credentials in config/database.php
- Logging connection strings
- Not purging after runtime credential change
- Storing tenant credentials unencrypted
...
---## Anti-Pattern 3: Hardcoded credentials in config/database.php â€” security breach
### Category
...
### Related Decision Trees
10-11-connection-string-management decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Config files with hardcoded fallbacks
### Category
