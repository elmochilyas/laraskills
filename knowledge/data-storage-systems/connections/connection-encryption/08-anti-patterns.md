# ECC Anti-Patterns â€” Connection encryption (TLS/SSL between app and database)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-13-connection-encryption |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. TLS but no hostname verification
3. SSL mode = prefer â€” silent downgrade to plaintext if TLS fails
4. Wrong Decision Without Context Evaluation
5. Self-signed certificates without proper CA management
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: TLS but no hostname verification
### Category
...
- SSL mode = prefer
- Expired CA bundle
- Client cert committed to git
- No TLS between app and pooler
- TLS timeout on slow connections
### Why It Is Harmful
...
---## Anti-Pattern 3: SSL mode = prefer â€” silent downgrade to plaintext if TLS fails
### Category
...
### Related Decision Trees
10-13-connection-encryption decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Self-signed certificates without proper CA management
### Category
