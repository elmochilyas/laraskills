# ECC Anti-Patterns â€” Read/write connection separation (dedicated read connections vs. merged)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-9-read-write-connection-separation |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. Single connection pool for read/write merged traffic
3. Same pool config for read and write â€” copy-paste between arrays
4. Wrong Decision Without Context Evaluation
5. Write pool used for reporting queries
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: Single connection pool for read/write merged traffic
### Category
...
### Warning Signs
- Same pool config for read and write
- Sticky writes disabled
- No read fallback on replica failure
- Identical health checks for read/write
- Read replicas in different regions with high latency
### Why It Is Harmful
...
---## Anti-Pattern 3: Same pool config for read and write â€” copy-paste between arrays
### Category
...
### Related Decision Trees
10-9-read-write-connection-separation decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Write pool used for reporting queries
### Category
