# ECC Anti-Patterns â€” Connection behavior in PHP-FPM vs. Octane vs. Swoole
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-12-php-fpm-vs-octane-vs-swoole |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. Migrating from PHP-FPM to Octane without pool review
3. PHP-FPM without pooler â€” 200 workers = 200 connections, exhaustion
4. Wrong Decision Without Context Evaluation
5. Swoole coroutines sharing a single PDO instance
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: Migrating from PHP-FPM to Octane without pool review
### Category
...
- Octane without pool config
- Same pool config for PHP-FPM and Octane
- Swoole coroutine pool without Channel
- PgBouncer deployed when only Octane is used
### Why It Is Harmful
...
---## Anti-Pattern 3: PHP-FPM without pooler â€” 200 workers = 200 connections, exhaustion
### Category
...
### Related Decision Trees
10-12-php-fpm-vs-octane-vs-swoole decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Swoole coroutines sharing a single PDO instance
### Category
