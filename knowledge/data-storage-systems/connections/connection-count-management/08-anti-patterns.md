# ECC Anti-Patterns â€” Connection count management (max_connections, pool sizing, avoiding connection storms)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-7-connection-count-management |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. Connection counting without monitoring
3. max_connections set too high â€” OOM crash on DB server
4. Wrong Decision Without Context Evaluation
5. `max_connections` as a scaling strategy
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: Connection counting without monitoring
### Category
...
### Warning Signs
- max_connections set too high
- No reserved admin connections
- Simultaneous worker startup
- No pooler for PHP-FPM
- Octane pool.max too high
### Why It Is Harmful
...
---## Anti-Pattern 3: max_connections set too high â€” OOM crash on DB server
### Category
...
### Related Decision Trees
10-7-connection-count-management decision trees in 07-decision-trees.md
---## Anti-Pattern 5: `max_connections` as a scaling strategy
### Category
