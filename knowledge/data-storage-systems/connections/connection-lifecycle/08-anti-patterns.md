# ECC Anti-Patterns â€” Connection lifecycle (connect, query, disconnect, reconnect)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-1-connection-lifecycle |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. Connection-per-request without pool
3. PHP-FPM without pooler â€” 200 workers = 200 connections
4. Wrong Decision Without Context Evaluation
5. Using Eloquent models inside migrations
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: Connection-per-request without pool
### Category
...
### Warning Signs
- No pool configured for PHP-FPM
- Not purging after config change
- Persistent connections with PDO::ATTR_PERSISTENT
- No health check on reused connections
### Why It Is Harmful
...
---## Anti-Pattern 3: PHP-FPM without pooler â€” 200 workers = 200 connections
### Category
...
### Related Decision Trees
10-1-connection-lifecycle decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Using Eloquent models inside migrations
### Category
