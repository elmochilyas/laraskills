# ECC Anti-Patterns â€” PgBouncer pooling modes (session, transaction, statement)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-3-pgbouncer-pooling-modes |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. Ignoring transaction pooling limitations
...
5. Single pool mode for all use cases
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: Ignoring transaction pooling limitations
### Category
...
- Session pooling for web app
- SET commands in middleware with transaction pooling
- No `DISCARD ALL` on connection return
### Why It Is Harmful
...
### Related Decision Trees
10-3-pgbouncer-pooling-modes decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Single pool mode for all use cases
### Category
