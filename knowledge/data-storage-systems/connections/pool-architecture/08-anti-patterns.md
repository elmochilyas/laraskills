# ECC Anti-Patterns â€” Pool architecture (client-side vs server-side, ProxySQL, PgBouncer, RDS Proxy)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-2-pool-architecture |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. Single huge pool for all environments
3. PHP-FPM without pooler â€” connection exhaustion
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: Single huge pool for all environments
### Category
...
---## Anti-Pattern 3: PHP-FPM without pooler â€” connection exhaustion
### Category
...
### Related Decision Trees
10-2-pool-architecture decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Nested poolers
### Category
