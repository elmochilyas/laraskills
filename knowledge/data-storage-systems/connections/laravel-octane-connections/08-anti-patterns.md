# ECC Anti-Patterns â€” Laravel Octane connection pool configuration (min/max connections)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-4-laravel-octane-connections |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. pool.max = 1 for all workers
3. No pool config â€” every request creates a new connection (no pooling benefit)
4. Wrong Decision Without Context Evaluation
5. No pool config at all
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: pool.max = 1 for all workers
### Category
...
- pool.max too high
- pool.min = pool.max
- Same pool config for all connections
...
---## Anti-Pattern 3: No pool config â€” every request creates a new connection (no pooling benefit)
### Category
...
### Related Decision Trees
10-4-laravel-octane-connections decision trees in 07-decision-trees.md
---## Anti-Pattern 5: No pool config at all
### Category
