# ECC Anti-Patterns â€” Dynamic connection configuration (config in middleware, runtime connection switching)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-5-dynamic-connection-config |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. Reconfiguring the `default` connection at runtime
3. Config change without purge â€” old PDO reused, wrong database accessed
4. Wrong Decision Without Context Evaluation
5. Hardcoding credentials in config()-set()
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: Reconfiguring the `default` connection at runtime
### Category
...
### Warning Signs
- Config change without purge
- Per-request purge in shared-table tenant
- Purging wrong connection name
- Not reconnecting after failover config change
### Why It Is Harmful
...
---## Anti-Pattern 3: Config change without purge â€” old PDO reused, wrong database accessed
### Category
...
### Related Decision Trees
10-5-dynamic-connection-config decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Hardcoding credentials in config()-set()
### Category
