# ECC Anti-Patterns â€” Connection failover behavior (transparent reconnect, connection string rotation)
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-16-failover-connection-behavior |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. Single failover strategy
3. No failover handling â€” complete downtime when primary fails
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: Single failover strategy
### Category
...
- DNS failover with long TTL
- No retry after connection failure
- Not purging after failover in app-level
- Assuming proxy handles all failover
### Why It Is Harmful
...
---## Anti-Pattern 3: No failover handling â€” complete downtime when primary fails
### Category
...
### Related Decision Trees
10-16-failover-connection-behavior decision trees in 07-decision-trees.md
---## Anti-Pattern 5: No failover testing
### Category
