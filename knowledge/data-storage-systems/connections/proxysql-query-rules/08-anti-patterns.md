# ECC Anti-Patterns â€” ProxySQL query rules and connection handling
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 10-15-proxysql-query-rules |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Deploy Server-Side Pooler For PHP-FPM
2. All queries routed to one hostgroup
3. Multiplexing enabled with session-state app â€” session leaks between clients
4. Wrong Decision Without Context Evaluation
5. Overly broad query rules
---
...
## Decision Criteria
## Decision Tree
---## Anti-Pattern 2: All queries routed to one hostgroup
### Category
...
### Warning Signs
- Multiplexing enabled with session-state app
- No query rule for FOR UPDATE
...
---## Anti-Pattern 3: Multiplexing enabled with session-state app â€” session leaks between clients
### Category
...
### Related Decision Trees
10-15-proxysql-query-rules decision trees in 07-decision-trees.md
---## Anti-Pattern 5: Overly broad query rules
### Category
