# ECC Anti-Patterns â€” Row Count Vs Response Time
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 4-26-row-count-vs-response-time |
...
### Related Decision Trees
4-26-row-count-vs-response-time decision trees in 07-decision-trees.md
