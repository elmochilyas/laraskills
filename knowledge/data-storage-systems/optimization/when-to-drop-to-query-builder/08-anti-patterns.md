# ECC Anti-Patterns â€” When To Drop To Query Builder
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 4-23-when-to-drop-to-query-builder |
...
### Related Decision Trees
4-23-when-to-drop-to-query-builder decision trees in 07-decision-trees.md
