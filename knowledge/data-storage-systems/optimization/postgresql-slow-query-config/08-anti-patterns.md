# ECC Anti-Patterns â€” Postgresql Slow Query Config
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 4-6-postgresql-slow-query-config |
...
### Related Decision Trees
4-6-postgresql-slow-query-config decision trees in 07-decision-trees.md
