# ECC Anti-Patterns â€” Mysql Algorithm Options
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Choose and specify explicit ALGORITHM (INSTANT, INPLACE, COPY) and LOCK (NONE, SHARED, EXCLUSIVE) options for MySQL ALTER TABLE operations based on the operation type, table size, and concurrency requirements â€” preventing silent fallback to blocking COPY operations in production.
...
### Related Decision Trees
11-8-mysql-algorithm-options decision trees in 07-decision-trees.md
