# ECC Anti-Patterns â€” Data Backfill Best Practices
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Run production data backfills using chunked ID-based batch processing with progress tracking, rate limiting, and verification â€” populating new columns or tables from existing data without degrading application performance or losing progress on failure.
...
### Related Decision Trees
11-9-data-backfill-best-practices decision trees in 07-decision-trees.md
