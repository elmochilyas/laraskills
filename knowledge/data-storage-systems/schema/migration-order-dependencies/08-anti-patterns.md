# ECC Anti-Patterns â€” Migration Order Dependencies
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Creating FK in the same migration as the table
...
---## Anti-Pattern 3: ### Creating FK in the same migration as the table
### Category
...
### Related Decision Trees
11-17-migration-order-dependencies decision trees in 07-decision-trees.md
