# ECC Anti-Patterns â€” Spirit Tool
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Use Spirit (by CashApp/Block) to run MySQL 8.0+ online schema changes via physical replication â€” creating a new table copy with the desired schema, using physical file copy for fast data transfer, and performing atomic cut-over without triggers or binlog dependencies.
...
---## Anti-Pattern 3: ### performance_schema disabled
### Category
...
### Related Decision Trees
11-4-spirit-tool decision trees in 07-decision-trees.md
