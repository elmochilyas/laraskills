...
3. ### Application incompatible with both schemas
...
---## Anti-Pattern 3: ### Application incompatible with both schemas
### Category
...
### Related Decision Trees
11-5-pgroll-tool decision trees in 07-decision-trees.md
