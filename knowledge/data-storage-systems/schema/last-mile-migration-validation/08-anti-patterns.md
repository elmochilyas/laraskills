# ECC Anti-Patterns â€” Last Mile Migration Validation
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Skipping validation before production migration
...
### Related Skills
Execute a final validation checklist before deploying a production migration â€” checking disk space, long-running queries, backup recency, rollback plan, and staging test results â€” using an Artisan command that blocks deployment if any check fails.
...
---## Anti-Pattern 3: ### Skipping validation before production migration
### Category
...
### Related Decision Trees
11-18-last-mile-migration-validation decision trees in 07-decision-trees.md
