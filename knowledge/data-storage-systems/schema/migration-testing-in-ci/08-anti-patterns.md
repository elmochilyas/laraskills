# ECC Anti-Patterns â€” Migration Testing In Ci
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Using SQLite for migration tests
...
### Related Skills
Run migration tests in CI using the same database engine and version as production â€” not SQLite â€” with a container-based database service, testing both forward migration and rollback to catch engine-specific syntax issues, version-specific DDL failures, and schema drift before deployment.
...
---## Anti-Pattern 3: ### Using SQLite for migration tests
### Category
...
### Related Decision Trees
1-28-migration-testing-in-ci decision trees in 07-decision-trees.md
