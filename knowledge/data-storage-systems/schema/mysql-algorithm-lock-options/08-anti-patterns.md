# ECC Anti-Patterns â€” Mysql Algorithm Lock Options
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Specify explicit ALGORITHM (INSTANT, INPLACE, COPY) and LOCK (NONE, SHARED, EXCLUSIVE) options in MySQL ALTER TABLE statements to prevent silent fallback to blocking table copy operations â€” ensuring each DDL operation runs with the correct concurrency characteristics for zero-downtime deployment.
...
---## Anti-Pattern 3: ### Silent fallback to COPY
### Category
...
### Related Decision Trees
1-26-mysql-algorithm-lock-options decision trees in 07-decision-trees.md
