# ECC Anti-Patterns â€” Model Inside Migrations Antipattern
---
## Metadata
| Field | Value |
|-------|-------|
...
---## Anti-Pattern 3: ### Model with global scopes
### Category
...
### Related Decision Trees
1-23-model-inside-migrations-antipattern decision trees in 07-decision-trees.md
