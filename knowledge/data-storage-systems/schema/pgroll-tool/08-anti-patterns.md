# ECC Anti-Patterns â€” Pgroll Tool
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Application not compatible with both schemas
...
---## Anti-Pattern 3: ### Application not compatible with both schemas
### Category
...
### Related Decision Trees
1-14-pgroll-tool decision trees in 07-decision-trees.md
