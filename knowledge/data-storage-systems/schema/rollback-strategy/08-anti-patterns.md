# ECC Anti-Patterns â€” Rollback Strategy
---
## Metadata
| Field | Value |
|-------|-------|
...
1. Ignoring: Always Test Migrations Before Production
2. Unvalidated Assumptions About Behavior
3. ### Rolling back a destructive migration immediately
...
---
## Anti-Pattern 1: Ignoring: Always Test Migrations Before Production
### Category
...
### Related Skills
Categorize migrations by rollback safety (additive vs destructive) and apply appropriate rollback timings â€” immediate for additive changes, delayed with compatibility windows for destructive changes â€” ensuring rollback never loses data and accounts for all running code paths including delayed queue jobs.
...
---## Anti-Pattern 3: ### Rolling back a destructive migration immediately
### Category
...
### Related Decision Trees
1-25-rollback-strategy decision trees in 07-decision-trees.md
