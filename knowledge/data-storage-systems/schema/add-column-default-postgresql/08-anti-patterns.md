# ECC Anti-Patterns â€” Add Column Default Postgresql
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Volatile default triggers rewrite
...
### Related Skills
Use PostgreSQL 11+ metadata-only `ALTER TABLE ADD COLUMN ... DEFAULT` for non-volatile defaults to add columns instantly without table rewrites, then use `NOT VALID` + `VALIDATE` for zero-lock NOT NULL constraint enforcement â€” enabling zero-downtime column additions on any size table.
...
---## Anti-Pattern 3: ### Volatile default triggers rewrite
### Category
...
### Related Decision Trees
11-7-add-column-default-postgresql decision trees in 07-decision-trees.md
