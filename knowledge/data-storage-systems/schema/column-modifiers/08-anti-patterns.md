# ECC Anti-Patterns â€” Column Modifiers
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Modifiers dropped during change()
...
### Related Skills
Use Blueprint column modifiers (`nullable()`, `default()`, `unsigned()`, `virtualAs()`, `storedAs()`) to enforce schema-level data integrity, support zero-downtime column additions, and enable indexed JSON path expressions â€” while avoiding common modifier pitfalls during `change()` operations.
...
---## Anti-Pattern 3: ### Modifiers dropped during change()
### Category
...
### Related Decision Trees
1-3-column-modifiers decision trees in 07-decision-trees.md
