# ECC Anti-Patterns â€” Schema Version Tracking
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Running migration once assuming all connections sync
...
---## Anti-Pattern 3: ### Running migration once assuming all connections sync
### Category
...
### Related Decision Trees
11-14-schema-version-tracking decision trees in 07-decision-trees.md
