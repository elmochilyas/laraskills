# ECC Anti-Patterns â€” Zero Downtime Migration Taxonomy
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Blocking ALTER TABLE on large tables
...
### Related Skills
Choose the correct zero-downtime migration strategy (expand-contract, online DDL, or shadow-table) based on the migration type, database engine, table size, and risk tolerance â€” matching the approach to the operational context for safe production schema evolution.
...
---## Anti-Pattern 3: ### Blocking ALTER TABLE on large tables
### Category
...
### Related Decision Trees
11-1-zero-downtime-migration-taxonomy decision trees in 07-decision-trees.md
