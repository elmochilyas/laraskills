# ECC Anti-Patterns â€” Destructive Operations
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### DROP COLUMN as part of standard workflow
...
### Related Skills
Apply safe practices for destructive DDL (DROP COLUMN, DROP TABLE, TRUNCATE) by using a phased approach with deprecated suffixes, waiting periods, and pre-operation backups â€” never performing destructive operations as the first step in a migration.
...
---## Anti-Pattern 3: ### DROP COLUMN as part of standard workflow
### Category
...
### Related Decision Trees
11-13-destructive-operations decision trees in 07-decision-trees.md
