# ECC Anti-Patterns â€” Verification During Migrations
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### No verification before cut-over
...
### Related Skills
Run automated verification checks after migration and backfill â€” comparing row counts, checksums, and sample data between old and new structures, and validating constraints (NOT NULL, FK, UNIQUE) â€” to catch data corruption, truncation, and mapping errors before switching production traffic.
...
---## Anti-Pattern 3: ### No verification before cut-over
### Category
...
### Related Decision Trees
11-10-verification-during-migrations decision trees in 07-decision-trees.md
