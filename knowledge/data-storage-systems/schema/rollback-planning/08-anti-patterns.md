# ECC Anti-Patterns â€” Rollback Planning
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Design tested rollback plans for every migration â€” immediate rollback for additive changes, phased rollback with compatibility windows for destructive changes, and pre-destructive-operation snapshots for DROP operations â€” ensuring rollback never loses data and is tested before production deployment.
...
### Related Decision Trees
11-11-rollback-planning decision trees in 07-decision-trees.md
