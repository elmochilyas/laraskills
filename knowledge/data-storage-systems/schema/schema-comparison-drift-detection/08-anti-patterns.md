# ECC Anti-Patterns â€” Schema Comparison Drift Detection
---
## Metadata
| Field | Value |
|-------|-------|
...
---## Anti-Pattern 3: ### Correcting drift manually
### Category
...
### Related Decision Trees
1-30-schema-comparison-drift-detection decision trees in 07-decision-trees.md
