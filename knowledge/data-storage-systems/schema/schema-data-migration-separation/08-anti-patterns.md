# ECC Anti-Patterns â€” Schema Data Migration Separation
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Heavy UPDATE in schema migration
...
---## Anti-Pattern 3: ### Heavy UPDATE in schema migration
### Category
...
### Related Decision Trees
1-24-schema-data-migration-separation decision trees in 07-decision-trees.md
