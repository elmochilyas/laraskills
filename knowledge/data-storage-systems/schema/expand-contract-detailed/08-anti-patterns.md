# ECC Anti-Patterns â€” Expand Contract Detailed
---
## Metadata
| Field | Value |
|-------|-------|
...
### Related Skills
Implement the four-phase expand-contract pattern â€” expand, backfill, switch, contract â€” for complex schema changes (column renames, table migrations, type changes) that require multiple deploy cycles, ensuring backward compatibility at each phase and enabling rollback without data loss.
...
---## Anti-Pattern 3: ### Skipping dual-write phase
### Category
...
### Related Decision Trees
11-6-expand-contract-detailed decision trees in 07-decision-trees.md
