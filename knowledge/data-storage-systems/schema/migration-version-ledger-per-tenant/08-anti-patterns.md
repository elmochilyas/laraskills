# ECC Anti-Patterns â€” Migration Version Ledger Per Tenant
---
## Metadata
| Field | Value |
|-------|-------|
...
3. ### Updating ledger before migration succeeds
...
---## Anti-Pattern 3: ### Updating ledger before migration succeeds
### Category
...
### Related Decision Trees
1-22-migration-version-ledger-per-tenant decision trees in 07-decision-trees.md
