# ECC Anti-Patterns â€” Partition Management
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-6-partition-management |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. ADD PARTITION on hash-partitioned table â€” requires REORGANIZE
...
---
## Anti-Pattern 1: Ignoring: Always Include Partition Key In WHERE
### Category
...
### Related Skills
Perform partition lifecycle operations â€” adding new partitions for incoming data, dropping old partitions for instant archival, truncating partitions for data removal, and reorganizing for structural changes.
...
---## Anti-Pattern 3: ADD PARTITION on hash-partitioned table â€” requires REORGANIZE
### Category
...
### Related Decision Trees
8-6-partition-management decision trees in 07-decision-trees.md
