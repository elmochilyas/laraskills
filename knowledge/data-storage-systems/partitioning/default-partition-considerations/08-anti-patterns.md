# ECC Anti-Patterns â€” Default Partition Considerations
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-13-default-partition-considerations |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. MAXVALUE partition collects years of data â€” becomes largest partition
...
---## Anti-Pattern 3: MAXVALUE partition collects years of data â€” becomes largest partition
### Category
...
### Related Decision Trees
8-13-default-partition-considerations decision trees in 07-decision-trees.md
