# ECC Anti-Patterns â€” Data Retention Partitioning
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-16-data-retention-partitioning |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. Using DELETE instead of DROP PARTITION â€” table bloat and slow cleanup
...
---## Anti-Pattern 3: Using DELETE instead of DROP PARTITION â€” table bloat and slow cleanup
### Category
...
### Related Decision Trees
8-16-data-retention-partitioning decision trees in 07-decision-trees.md
