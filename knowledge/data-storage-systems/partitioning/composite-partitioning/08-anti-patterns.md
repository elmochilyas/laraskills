# ECC Anti-Patterns â€” Composite Partitioning
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-4-composite-partitioning |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. Excessive total partitions (12 primary Ã— 100 sub = 1200 â€” too many)
...
### Related Skills
Use two-level partitioning â€” range by date for lifecycle management, hash by key for even write distribution â€” to combine the benefits of both strategies.
...
---## Anti-Pattern 3: Excessive total partitions (12 primary Ã— 100 sub = 1200 â€” too many)
### Category
...
### Related Decision Trees
8-4-composite-partitioning decision trees in 07-decision-trees.md
