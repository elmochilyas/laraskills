# ECC Anti-Patterns â€” Postgresql Partitioning Features
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-11-postgresql-partitioning-features |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. Using old table inheritance instead of declarative partitioning
...
---## Anti-Pattern 3: Using old table inheritance instead of declarative partitioning
### Category
...
### Related Decision Trees
8-11-postgresql-partitioning-features decision trees in 07-decision-trees.md
