# ECC Anti-Patterns â€” Partition Level Backup Restore
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-14-partition-level-backup-restore |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. Backing up entire table weekly (static partitions backed up unnecessarily)
...
---## Anti-Pattern 3: Backing up entire table weekly (static partitions backed up unnecessarily)
### Category
...
### Related Decision Trees
8-14-partition-level-backup-restore decision trees in 07-decision-trees.md
