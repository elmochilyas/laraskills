# ECC Anti-Patterns â€” Time Based Partitioning
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-7-time-based-partitioning |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. Too many partitions (daily for low-volume table) â€” metadata overhead
...
---## Anti-Pattern 3: Too many partitions (daily for low-volume table) â€” metadata overhead
### Category
...
### Related Decision Trees
8-7-time-based-partitioning decision trees in 07-decision-trees.md
