# ECC Anti-Patterns â€” Partition Aware Rls
---
## Metadata
| Field | Value |
|-------|-------|
...
3. RLS enabled only on parent but not checked on child partitions (PostgreSQL handles this correctly)
...
---## Anti-Pattern 3: RLS enabled only on parent but not checked on child partitions (PostgreSQL handles this correctly)
### Category
...
### Related Decision Trees
8-17-partition-aware-rls decision trees in 07-decision-trees.md
