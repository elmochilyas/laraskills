# ECC Anti-Patterns â€” Mysql Partition Limitations
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-10-mysql-partition-limitations |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. FK on partitioned table silently ignored by MySQL (no error)
...
### Related Skills
Design database schemas around MySQL's partition restrictions â€” no foreign keys on partitioned tables, unique indexes must include the partition key, and the 8192 partition limit.
...
---## Anti-Pattern 3: FK on partitioned table silently ignored by MySQL (no error)
### Category
...
### Related Decision Trees
8-10-mysql-partition-limitations decision trees in 07-decision-trees.md
