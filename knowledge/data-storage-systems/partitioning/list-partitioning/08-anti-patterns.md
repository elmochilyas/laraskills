# ECC Anti-Patterns â€” List Partitioning
---
## Metadata
| Field | Value |
|-------|-------|
...
---## Anti-Pattern 3: Default partition grows large with unexpected values
### Category
...
### Related Decision Trees
8-2-list-partitioning decision trees in 07-decision-trees.md
