# ECC Anti-Patterns â€” Hash Partition Incremental Scaling
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-12-hash-partition-incremental-scaling |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. Too few partitions (2-4) â€” each partition grows too large
...
### Related Skills
Choose the right number of hash partitions at table creation time â€” using power-of-2 counts and pre-partitioning for growth â€” to avoid costly rebuilds when data grows.
...
---## Anti-Pattern 3: Too few partitions (2-4) â€” each partition grows too large
### Category
...
### Related Decision Trees
8-12-hash-partition-incremental-scaling decision trees in 07-decision-trees.md
