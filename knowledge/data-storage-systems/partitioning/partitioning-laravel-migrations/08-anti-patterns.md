# ECC Anti-Patterns â€” Partitioning Laravel Migrations
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-9-partitioning-laravel-migrations |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. Cannot partition existing table with data â€” use pt-online-schema-change
...
---## Anti-Pattern 3: Cannot partition existing table with data â€” use pt-online-schema-change
### Category
...
### Related Decision Trees
8-9-partitioning-laravel-migrations decision trees in 07-decision-trees.md
