# ECC Anti-Patterns â€” Partition Switching Archiving
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-15-partition-switching-archiving |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. Staging table structure doesn't match â€” EXCHANGE fails
...
---## Anti-Pattern 3: Staging table structure doesn't match â€” EXCHANGE fails
### Category
...
### Related Decision Trees
8-15-partition-switching-archiving decision trees in 07-decision-trees.md
