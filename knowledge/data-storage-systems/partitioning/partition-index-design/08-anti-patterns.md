# ECC Anti-Patterns â€” Partition Index Design
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-8-partition-index-design |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. MySQL: unique index without partition key â†’ error or silent failure
...
---## Anti-Pattern 3: MySQL: unique index without partition key â†’ error or silent failure
### Category
...
### Related Decision Trees
8-8-partition-index-design decision trees in 07-decision-trees.md
