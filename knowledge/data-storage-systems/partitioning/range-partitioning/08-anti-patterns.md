# ECC Anti-Patterns â€” Range Partitioning
---
## Metadata
| Field | Value |
|-------|-------|
...
| **Knowledge Unit** | 8-1-range-partitioning |
| **Generated** | 2026-06-03 |
---
## Anti-Pattern Inventory
1. Ignoring: Always Include Partition Key In WHERE
2. Unvalidated Assumptions About Behavior
3. Data written to future partition (VALUES LESS THAN MAXVALUE) unexpectedly
...
---## Anti-Pattern 3: Data written to future partition (VALUES LESS THAN MAXVALUE) unexpectedly
### Category
...
### Related Decision Trees
8-1-range-partitioning decision trees in 07-decision-trees.md
