...
- [ ] No premature optimization â€” Eloquent is the default for new queries
...
- [ ] Architecture guideline: - Establish a team convention: "Use Eloquent for all operations unless profiling proves it's a bo...
- [ ] Architecture guideline: - Keep decision reversible â€” abstract data access behind interfaces for critical paths
- [ ] Architecture guideline: - Audit N+1 with `Model::preventLazyLoading()` in development; log violations in production
- [ ] Architecture guideline: - Document when and why Query Builder is chosen over Eloquent in code comments
- [ ] Architecture guideline: - Use `toBase()` as the intermediate step: it preserves Eloquent builder features without hydration
- [ ] Decision: Eloquent vs Query Builder Selection - ensure correct choice is made
- [ ] Decision: toBase() Optimization Timing - ensure correct choice is made
- [ ] Decision: Hybrid Strategy Adoption - ensure correct choice is made

# Implementation Checklist (from 04/05/06 + standard items)
- [ ] Implementation follows project coding standards
- [ ] All type hints and return types are declared
- [ ] No hardcoded values - configuration is externalized
- [ ] Skill applied: Choose Between Eloquent and Query Builder Using a Decision Framework
...
### Skills (from 06)
- Choose Between Eloquent and Query Builder Using a Decision Framework
### Decision Trees (from 07)
- Eloquent vs Query Builder Selection
- toBase() Optimization Timing
