...
- [ ] Architecture guideline: - `DatabaseSeeder` checks `app()->environment()` before calling demo seeders
- [ ] Architecture guideline: - Reference seeders always run; demo seeders are gated
- [ ] Architecture guideline: - Production guard is Laravel's built-in `db:seed` confirmation

# Implementation Checklist (from 04/05/06 + standard items)
- [ ] Implementation follows project coding standards
- [ ] All type hints and return types are declared
- [ ] No hardcoded values - configuration is externalized
- [ ] Skill applied: Set Up Environment-Gated Demo Seeders
