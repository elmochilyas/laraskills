...
**Knowledge Unit:** Event Control â€” Quiet Operations
...
- [ ] Architecture guideline: - Use quiet operations for data migrations and seeding
- [ ] Architecture guideline: - Use quiet operations to break infinite event loops
- [ ] Architecture guideline: - `withoutEvents()` is nestable â€” inner calls restore outer suppression state

# Implementation Checklist (from 04/05/06 + standard items)
- [ ] Implementation follows project coding standards
- [ ] All type hints and return types are declared
- [ ] No hardcoded values - configuration is externalized
- [ ] Skill applied: Suppress Events for Bulk Operations with withoutEvents()
...
### Skills (from 06)
- Suppress Events for Bulk Operations with withoutEvents()
